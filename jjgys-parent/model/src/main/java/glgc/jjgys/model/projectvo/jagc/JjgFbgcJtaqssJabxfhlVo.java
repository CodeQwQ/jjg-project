...
public class JjgFbgcJtaqssJabxfhlVo extends BaseRowModel {
    ...
    @ColumnWidth(23)
    @ExcelProperty(value = "基底厚度实测值4(mm)" ,index = 6)
    private String jdhdscz4;

    @ColumnWidth(23)
    @ExcelProperty(value = "基底厚度实测值5(mm)" ,index = 7)
    private String jdhdscz5;

    @ColumnWidth(23)
    @ExcelProperty(value = "立柱壁厚规定值(mm)" ,index = 8)
    private String lzbhgdz;

    @ColumnWidth(23)
    @ExcelProperty(value = "立柱壁厚实测值1(mm)" ,index = 9)
    private String lzbhscz1;

    @ColumnWidth(23)
    @ExcelProperty(value = "立柱壁厚实测值2(mm)" ,index = 10)
    private String lzbhscz2;

    @ColumnWidth(23)
    @ExcelProperty(value = "立柱壁厚实测值3(mm)" ,index = 11)
    private String lzbhscz3;

    @ColumnWidth(23)
    @ExcelProperty(value = "立柱壁厚实测值4(mm)" ,index = 12)
    private String lzbhscz4;

    @ColumnWidth(23)
    @ExcelProperty(value = "立柱壁厚实测值5(mm)" ,index = 13)
    private String lzbhscz5;

    @ColumnWidth(23)
    @ExcelProperty(value = "中心高度规定值(mm)" ,index = 14)
    private String zxgdgdz;

    @ColumnWidth(23)
    @ExcelProperty(value = "中心高度允许偏差+(mm)" ,index = 15)
    ...
    @ColumnWidth(23)
    @ExcelProperty(value = "中心高度实测值1(mm)" ,index = 17)
    private String zxgdscz1;

    @ColumnWidth(23)
    @ExcelProperty(value = "中心高度实测值2(mm)" ,index = 18)
    private String zxgdscz2;

    @ColumnWidth(23)
    @ExcelProperty(value = "中心高度实测值3(mm)" ,index = 19)
    private String zxgdscz3;

    @ColumnWidth(23)
    @ExcelProperty(value = "中心高度实测值4(mm)" ,index = 20)
    private String zxgdscz4;

    @ColumnWidth(23)
    @ExcelProperty(value = "中心高度实测值5(mm)" ,index = 21)
    private String zxgdscz5;

    @ColumnWidth(23)
    @ExcelProperty(value = "埋入深度规定值(mm)" ,index = 22)
    private String mrsdgdz;

    @ColumnWidth(23)
    @ExcelProperty(value = "埋入深度实测值(mm)" ,index = 23)
