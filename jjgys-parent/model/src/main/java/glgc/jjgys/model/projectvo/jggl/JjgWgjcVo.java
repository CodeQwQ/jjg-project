...
public class JjgWgjcVo extends BaseRowModel {
     ...
     */
    @ColumnWidth(23)
    @ExcelProperty(value = "构件名称1" ,index = 4)
    private String gjmc;

    @ColumnWidth(23)
    @ExcelProperty(value = "构件名称2" ,index = 5)
     ...
     */
    @ColumnWidth(23)
    @ExcelProperty(value = "构件编号" ,index = 6)
    private String gjbh;
     ...
     */
    @ColumnWidth(23)
    @ExcelProperty(value = "病害类型" ,index = 7)
    private String bhlx;
     ...
     */
    @ColumnWidth(23)
    @ExcelProperty(value = "病害数量" ,index = 8)
    private String bhsl;
     ...
     */
    @ColumnWidth(23)
    @ExcelProperty(value = "病害定量" ,index = 9)
    private String bhdl;
