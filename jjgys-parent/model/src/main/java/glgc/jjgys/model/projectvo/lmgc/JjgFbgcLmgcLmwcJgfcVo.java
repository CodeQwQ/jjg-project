...
@HeadRowHeight(30)
public class JjgFbgcLmgcLmwcJgfcVo extends BaseRowModel {
     ...
     */
    @ColumnWidth(23)
    @ExcelProperty(value = "平衡湿度路基顶面回弹模量E0" ,index = 10)
     ...
     */
    @ColumnWidth(23)
    @ExcelProperty(value = "后轴重(T)" ,index = 11)
    private String hzz;
     ...
     */
    @ColumnWidth(23)
    @ExcelProperty(value = "轮胎气压(MPa)" ,index = 12)
    private String ltqy;
     ...
     */
    @ColumnWidth(23)
    @ExcelProperty(value = "桩号" ,index = 13)
    private String zh;
     ...
     */
    @ColumnWidth(23)
    @ExcelProperty(value = "车道" ,index = 14)
    private String cd;
     ...
     */
    @ColumnWidth(23)
    @ExcelProperty(value = "左值(0.01mm)" ,index = 15)
    private String zz;
     ...
     */
    @ColumnWidth(23)
    @ExcelProperty(value = "右值(0.01mm)" ,index = 16)
    private String yz;
     ...
     */
    @ColumnWidth(23)
    @ExcelProperty(value = "路表温度" ,index = 17)
    private String lbwd;
