...
public class JjgFbgcLjgcLjtsfysdSlController {
    ...
    public Result findQueryPageSL(@PathVariable long current,
                                ...
                                @RequestBody JjgFbgcLjgcLjtsfysdSl jjgFbgcLjgcLjtsfysdSl) throws ParseException {
        //创建page对象
        ...
        if (jjgFbgcLjgcLjtsfysdSl != null){
            ...
            String userid = jjgFbgcLjgcLjtsfysdSl.getUserid();
            if ("1".equals(userid)){
    ...
    @PostMapping("sl/createManyRecords")
    public Result createManyRecords(@RequestBody List<JjgFbgcLjgcLjtsfysdSl> rawData, HttpServletRequest request) {
        String userID = ReceiveUtils.getUserIDFromRequest(request);
        if (userID == null) {
            return Result.fail("用户未登录");
        }
        int res = jjgFbgcLjgcLjtsfysdSlService.createMoreRecords(rawData, userID);
