...
public class JjgFbgcLjgcLjwcLcfController {
    ...
    public Result generateJdb(@RequestBody CommonInfoVo commonInfoVo) throws Exception {
        boolean is_Success = jjgFbgcLjgcLjwcLcfService.generateJdb(commonInfoVo);
    ...
    public Result findQueryPage(@PathVariable long current,
                                ...
                                @RequestBody JjgFbgcLjgcLjwcLcf jjgFbgcLjgcLjwcLcf) throws ParseException {
        //创建page对象
        ...
        if (jjgFbgcLjgcLjwcLcf != null){
            ...
            String userid = jjgFbgcLjgcLjwcLcf.getUserid();
            if ("1".equals(userid)){
            ...
            if(pageModel.getTotal() == 0){
                File f = new File(filespath+File.separator+jjgFbgcLjgcLjwcLcf.getProname()+File.separator+jjgFbgcLjgcLjwcLcf.getHtd()+File.separator+"02路基弯沉(落锤法).xlsx");
                if (f.exists()){
    ...
    public Result removeAll(@RequestBody CommonInfoVo commonInfoVo){
        ...
        if ("1".equals(userid)){
            ...
            File f = new File(filespath+File.separator+proname+File.separator+htd+File.separator+"02路基弯沉(落锤法).xlsx");
            if (f.exists()){
                f.delete();
            }
