...
public class JjgFbgcLmgcLmwcLcfController {
    ...
    public Result generateJdb(@RequestBody CommonInfoVo commonInfoVo) throws Exception {
        boolean is_Success = jjgFbgcLmgcLmwcLcfService.generateJdb(commonInfoVo);
    ...
    public Result findQueryPage(@PathVariable long current,
                                ...
                                @RequestBody JjgFbgcLmgcLmwcLcf jjgFbgcLmgcLmwcLcf) throws ParseException {
        //创建page对象
        ...
        if (jjgFbgcLmgcLmwcLcf != null){
            ...
            String userid = jjgFbgcLmgcLmwcLcf.getUserid();
            if ("1".equals(userid)){
    ...
    public Result removeAll(@RequestBody CommonInfoVo commonInfoVo){
        ...
        if ("1".equals(userid)){
            ...
            if (remove){
                File f = new File(filespath+File.separator+proname+File.separator+htd+File.separator+"13路面弯沉(落锤法).xlsx");
                if (f.exists()){
                    f.delete();
                }
            }
