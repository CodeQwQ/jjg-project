...
public class JjgFbgcQlgcQmhpController {
    ...
    public void downloadExport(HttpServletRequest request, HttpServletResponse response, String proname, String htd, String fbgc,String userid) throws IOException {
        List<Map<String,Object>> qlmclist = jjgFbgcQlgcQmhpService.selectqlmc(proname,htd,fbgc,userid);
    ...
    public Result generateJdb(@RequestBody CommonInfoVo commonInfoVo) throws Exception {
        boolean is_Success = jjgFbgcQlgcQmhpService.generateJdb(commonInfoVo);
    ...
    public Result findQueryPage(@PathVariable long current,
                                ...
                                @RequestBody JjgFbgcQlgcQmhp jjgFbgcQlgcQmhp) throws ParseException {
        //创建page对象
        ...
        if (jjgFbgcQlgcQmhp != null){
            ...
            String userid = jjgFbgcQlgcQmhp.getUserid();
            if ("1".equals(userid)){
    ...
    public Result removeAll(@RequestBody CommonInfoVo commonInfoVo){
        ...
        if ("1".equals(userid)){
            ...
            List<Map<String,Object>> qlmclist = jjgFbgcQlgcQmhpService.selectqlmc(proname,htd,"桥面系",userid);
            List<String> list = new ArrayList<>();

            for (int i=0;i<qlmclist.size();i++){
                list.add("35桥面横坡-"+qlmclist.get(i).get("qlmc")+".xlsx");
            }
    ...
    public Result createManyRecords(@RequestBody List<JjgFbgcQlgcQmhp> rawData, HttpServletRequest request) {
        String userID = ReceiveUtils.getUserIDFromRequest(request);
        if (userID == null) {
            return Result.fail("用户未登录");
        }
        int res = jjgFbgcQlgcQmhpService.createMoreRecords(rawData, userID);
