...
public class JjgFbgcQlgcZdhpzdController {
    ...
    public void downloadExport(HttpServletResponse response, String proname, String htd,String userid) throws IOException {
        List<Map<String,Object>> lxlist = jjgFbgcQlgcZdhpzdService.selectlx(proname,htd,userid);
    ...
    public Result generateJdb(@RequestBody CommonInfoVo commonInfoVo) throws Exception {
        boolean is_Success = jjgFbgcQlgcZdhpzdService.generateJdb(commonInfoVo);
    ...
    public Result lookJdbjg(@RequestBody CommonInfoVo commonInfoVo) throws IOException {
        List<Map<String,Object>> jdjg = jjgFbgcQlgcZdhpzdService.lookJdbjgPage(commonInfoVo);
    ...
    public Result findQueryPage(@PathVariable long current,
        ...
        if (zdhpzd != null) {
            ...
            String userid = zdhpzd.getUserid();
            if ("1".equals(userid)){
