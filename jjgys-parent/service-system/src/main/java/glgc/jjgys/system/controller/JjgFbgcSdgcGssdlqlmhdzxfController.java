...
public class JjgFbgcSdgcGssdlqlmhdzxfController {
    ...
    public void downloadExport(HttpServletRequest request,HttpServletResponse response, String proname, String htd,String fbgc,String userid) throws IOException {
        List<Map<String,Object>> sdmclist = jjgFbgcSdgcGssdlqlmhdzxfService.selectsdmc(proname,htd,fbgc,userid);
    ...
    public Result generateJdb(@RequestBody CommonInfoVo commonInfoVo) throws Exception {
        boolean is_Success = jjgFbgcSdgcGssdlqlmhdzxfService.generateJdb(commonInfoVo);
    ...
    public Result lookJdbjg(@RequestBody CommonInfoVo commonInfoVo) throws IOException {
        List<Map<String,Object>> jdjg = jjgFbgcSdgcGssdlqlmhdzxfService.lookJdbjgPage(commonInfoVo);
    ...
    public Result findQueryPageHt(@PathVariable long current,
                                  ...
                                  @RequestBody JjgFbgcSdgcGssdlqlmhdzxf jjgFbgcSdgcGssdlqlmhdzxf) throws ParseException {
        //创建page对象
        ...
        if (jjgFbgcSdgcGssdlqlmhdzxf != null){
            ...
            String userid = jjgFbgcSdgcGssdlqlmhdzxf.getUserid();
            if ("1".equals(userid)){
    ...
    public Result removeAll(@RequestBody CommonInfoVo commonInfoVo){
        ...
        if ("1".equals(userid)){
            ...
            List<Map<String,Object>> sdmclist = jjgFbgcSdgcGssdlqlmhdzxfService.selectsdmc(proname,htd,"隧道工程",userid);
            List<String> list = new ArrayList<>();
            for (int i=0;i<sdmclist.size();i++){
                list.add("53隧道沥青路面厚度-钻芯法-"+sdmclist.get(i).get("sdmc")+".xlsx");
            }
    ...
    public Result createManyRecords(@RequestBody List<JjgFbgcSdgcGssdlqlmhdzxf> rawData, HttpServletRequest request) {
        String userID = ReceiveUtils.getUserIDFromRequest(request);
        if (userID == null) {
            return Result.fail("用户未登录");
        }
        int res = jjgFbgcSdgcGssdlqlmhdzxfService.createMoreRecords(rawData, userID);
