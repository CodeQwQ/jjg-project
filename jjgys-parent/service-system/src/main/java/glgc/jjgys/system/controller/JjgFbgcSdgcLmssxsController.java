...
public class JjgFbgcSdgcLmssxsController {
    ...
    public void downloadExport(HttpServletRequest request,HttpServletResponse response, String proname, String htd,String fbgc,String userid) throws IOException {
        List<Map<String,Object>> sdmclist = jjgFbgcSdgcLmssxsService.selectsdmc(proname,htd,fbgc,userid);
    ...
    public Result generateJdb(@RequestBody CommonInfoVo commonInfoVo) throws Exception {
        boolean is_Success = jjgFbgcSdgcLmssxsService.generateJdb(commonInfoVo);
    ...
    public Result lookJdbjg(@RequestBody CommonInfoVo commonInfoVo) throws IOException {
        List<Map<String,Object>> jdjg = jjgFbgcSdgcLmssxsService.lookJdbjgPage(commonInfoVo);
    ...
    public Result findQueryPage(@PathVariable long current,
                                ...
                                @RequestBody JjgFbgcSdgcLmssxs jjgFbgcSdgcLmssxs) throws ParseException {
        //创建page对象
        ...
        if (jjgFbgcSdgcLmssxs != null){
            ...
            String userid = jjgFbgcSdgcLmssxs.getUserid();
            if ("1".equals(userid)){
    ...
    public Result removeAll(@RequestBody CommonInfoVo commonInfoVo){
        ...
        if ("1".equals(userid)){
            ...
            List<Map<String,Object>> sdmclist = jjgFbgcSdgcLmssxsService.selectsdmc(proname,htd,"隧道工程",userid);
            List<String> list = new ArrayList<>();
            for (int i=0;i<sdmclist.size();i++){
                list.add("46隧道沥青路面渗水系数-"+sdmclist.get(i).get("sdmc")+".xlsx");
            }
    ...
    public Result createManyRecords(@RequestBody List<JjgFbgcSdgcLmssxs> rawData, HttpServletRequest request) {
        String userID = ReceiveUtils.getUserIDFromRequest(request);
        if (userID == null) {
            return Result.fail("用户未登录");
        }
        int res = jjgFbgcSdgcLmssxsService.createMoreRecords(rawData, userID);
