...
public class JjgFbgcSdgcSdlqlmysdController {
    ...
    public void downloadExport(HttpServletRequest request,HttpServletResponse response, String proname, String htd,String fbgc,String userid) throws IOException {
        List<Map<String,Object>> sdmclist = jjgFbgcSdgcSdlqlmysdService.selectsdmc(proname,htd,fbgc,userid);
    ...
    public Result generateJdb(@RequestBody CommonInfoVo commonInfoVo) throws Exception {
        boolean is_Success = jjgFbgcSdgcSdlqlmysdService.generateJdb(commonInfoVo);
    ...
    public Result lookJdbjg(@RequestBody CommonInfoVo commonInfoVo) throws IOException {
        List<Map<String,Object>> jdjg = jjgFbgcSdgcSdlqlmysdService.lookJdbjgPage(commonInfoVo);
    ...
    public Result removeAll(@RequestBody CommonInfoVo commonInfoVo){
        ...
        if ("1".equals(userid)){
            ...
            List<Map<String,Object>> sdmclist = jjgFbgcSdgcSdlqlmysdService.selectsdmc(proname,htd,"隧道工程",userid);
            List<String> list = new ArrayList<>();
            for (int i=0;i<sdmclist.size();i++){
                list.add("43隧道沥青路面压实度-"+sdmclist.get(i).get("sdmc")+".xlsx");
            }
    ...
    public Result findQueryPageHt(@PathVariable long current,
                                  ...
                                  @RequestBody JjgFbgcSdgcSdlqlmysd jjgFbgcSdgcSdlqlmysd) throws ParseException {
        //创建page对象
        ...
        if (jjgFbgcSdgcSdlqlmysd != null){
            ...
            String userid = jjgFbgcSdgcSdlqlmysd.getUserid();
            if ("1".equals(userid)){
    ...
    public Result createManyRecords(@RequestBody List<JjgFbgcSdgcSdlqlmysd> rawData, HttpServletRequest request) {
        String userID = ReceiveUtils.getUserIDFromRequest(request);
        if (userID == null) {
            return Result.fail("用户未登录");
        }
        int res = jjgFbgcSdgcSdlqlmysdService.createMoreRecords(rawData, userID);
