...
public class JjgZdhCzController {
    ...
    public void downloadExport(HttpServletResponse response, String proname, String htd,String userid) throws IOException {
        List<Map<String,Object>> lxlist = jjgZdhCzService.selectlx(proname,htd,userid);
    ...
    public Result removeAll(@RequestBody CommonInfoVo commonInfoVo){
        ...
        if ("1".equals(userid)){
            ...
            for (Map<String, Object> map : lxlist) {
                String lxbs = map.get("lxbs").toString();
                if (lxbs.equals("主线")){
                    fileName.add("14路面车辙.xlsx");
                }else {
                    fileName.add("69互通车辙-"+lxbs+".xlsx");
                }
            }
    ...
    public Result generateJdb(@RequestBody CommonInfoVo commonInfoVo) throws Exception {
        boolean is_Success = jjgZdhCzService.generateJdb(commonInfoVo);
    ...
    public Result lookJdbjg(@RequestBody CommonInfoVo commonInfoVo) throws IOException {
        List<Map<String,Object>> jdjg = jjgZdhCzService.lookJdbjgPage(commonInfoVo);
    ...
    public Result findQueryPage(@PathVariable long current,
        ...
        if (jjgZdhCz != null) {
            ...
            String userid = jjgZdhCz.getUserid();
            if ("1".equals(userid)){
