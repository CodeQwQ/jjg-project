...
public class JjgZdhGzsdController {
    ...
    public void downloadExport(HttpServletResponse response, String proname, String htd,String userid) throws IOException {
        List<Map<String,Object>> lxlist = jjgZdhGzsdService.selectlx(proname,htd,userid);
    ...
    public Result removeAll(@RequestBody CommonInfoVo commonInfoVo){
        ...
        if ("1".equals(userid)){
            ...
            for (Map<String, Object> map : lxlist) {
                String lxbs = map.get("lxbs").toString();
                if (lxbs.equals("主线")){
                    fileName.add("20路面构造深度.xlsx");
                }else {
                    fileName.add("63互通构造深度-"+lxbs+".xlsx");
                }
            }
    ...
    public Result generateJdb(@RequestBody CommonInfoVo commonInfoVo) throws Exception {
        boolean is_Success = jjgZdhGzsdService.generateJdb(commonInfoVo);
    ...
    public Result lookJdbjg(@RequestBody CommonInfoVo commonInfoVo) throws IOException {
        List<Map<String,Object>> jdjg = jjgZdhGzsdService.lookJdbjgPage(commonInfoVo);
