...
public class JjgZdhMcxsController {
    ...
    public void downloadExport(HttpServletRequest request,HttpServletResponse response, String proname, String htd,String userid) throws IOException {
        List<Map<String,Object>> lxlist = jjgZdhMcxsService.selectlx(proname,htd,userid);
    ...
    public Result generateJdb(@RequestBody CommonInfoVo commonInfoVo) throws Exception {
        boolean is_Success = jjgZdhMcxsService.generateJdb(commonInfoVo);
    ...
    public Result lookJdbjg(@RequestBody CommonInfoVo commonInfoVo) throws IOException {
        List<Map<String,Object>> jdjg = jjgZdhMcxsService.lookJdbjgPage(commonInfoVo);
    ...
    public Result removeAll(@RequestBody CommonInfoVo commonInfoVo){
        ...
        if ("1".equals(userid)){
            ...
            for (Map<String, Object> map : lxlist) {
                String lxbs = map.get("lxbs").toString();
                if (lxbs.equals("主线")){
                    fileName.add("19路面摩擦系数.xlsx");;
                }else {
                    fileName.add("62互通摩擦系数-"+lxbs+".xlsx");
                }
            }
