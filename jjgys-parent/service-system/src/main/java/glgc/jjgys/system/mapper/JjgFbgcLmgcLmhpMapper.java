...
public interface JjgFbgcLmgcLmhpMapper extends BaseMapper<JjgFbgcLmgcLmhp> {
    ...
    List<Map<String, String>> selectlx(String proname, String htd, List<Long> idlist);
    ...
    List<Map<String,String>> selectSdZfDatayh(String proname, String htd, String fbgc, String zhq, String zhz, List<Long> idlist);

    List<Map<String,String>> selectSdYfData(String proname, String htd, String fbgc, String zhq, String zhz);

    List<Map<String,String>> selectSdYfDatayh(String proname, String htd, String fbgc, String zhq, String zhz, List<Long> idlist);

    List<Map<String,String>> selectQlZfData(String proname, String htd, String fbgc, String zhq, String zhz);

    List<Map<String,String>> selectQlZfDatayh(String proname, String htd, String fbgc, String zhq, String zhz, List<Long> idlist);

    List<Map<String,String>> selectQlYfData(String proname, String htd, String fbgc, String zhq, String zhz);

    List<Map<String,String>> selectQlYfDatayh(String proname, String htd, String fbgc, String zhq, String zhz, List<Long> idlist);

    List<Map<String, String>> selectAllList(String proname, String htd, String fbgc);

    List<Map<String, String>> selectAllListyh(String proname, String htd, String fbgc, List<Long> idlist);

    List<JjgFbgcLmgcLmhp> selecthpzd(Map<String, String> map, List<Long> idlist);
    ...
    List<Map<String, String>> selectlxno(String proname, String htd);
}
