...
public interface JjgFbgcQlgcQmhpMapper extends BaseMapper<JjgFbgcQlgcQmhp> {
    ...
    List<Map<String,Object>> selectqlmcnoid(String proname, String htd, String fbgc);

    List<Map<String,Object>> selectzh(String proname, String htd, String fbgc, String qlmc, List<Long> idlist);

    List<Map<String, Object>> selectqlmc2(String proname, String htd);

    List<Map<String, Object>> selectzh2(String proname, String htd, String qlmc, List<Long> idlist);

    List<Map<String, Object>> selectzh2noid(String proname, String htd, String qlmc);
