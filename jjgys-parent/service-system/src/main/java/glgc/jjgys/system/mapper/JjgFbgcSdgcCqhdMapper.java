...
public interface JjgFbgcSdgcCqhdMapper extends BaseMapper<JjgFbgcSdgcCqhd> {
    ...
    List<Map<String, Object>> selectwz2id(String proname, String htd, String sdmc, List<Long> idlist);
    ...
    List<Map<String, Object>> selectcdid(String proname, String htd, String fbgc, String sdmc, List<Long> idlist);
