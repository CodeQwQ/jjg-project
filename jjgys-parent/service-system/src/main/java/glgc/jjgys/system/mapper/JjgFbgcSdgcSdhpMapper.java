...
public interface JjgFbgcSdgcSdhpMapper extends BaseMapper<JjgFbgcSdgcSdhp> {
    ...
    List<Map<String,Object>> selectzh(String proname, String htd, String fbgc,String sdmc,List<Long> idlist);
    ...
    List<Map<String, Object>> selectzh1id(String proname, String htd, String sdmc, List<Long> idlist);
