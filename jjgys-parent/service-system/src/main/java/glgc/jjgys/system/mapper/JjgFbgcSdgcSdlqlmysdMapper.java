...
public interface JjgFbgcSdgcSdlqlmysdMapper extends BaseMapper<JjgFbgcSdgcSdlqlmysd> {
    ...
    List<JjgFbgcSdgcSdlqlmysd> selectsdzf(String proname, String htd, String fbgc, String sdmc, List<Long> idlist);

    List<JjgFbgcSdgcSdlqlmysd> selectsdyf(String proname, String htd, String fbgc, String sdmc, List<Long> idlist);
    ...
    List<JjgFbgcSdgcSdlqlmysd> selectljxsd(String proname, String htd, String fbgc, String sdmc, List<Long> idlist);
