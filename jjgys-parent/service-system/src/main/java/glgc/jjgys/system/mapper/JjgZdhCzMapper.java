...
public interface JjgZdhCzMapper extends BaseMapper<JjgZdhCz> {
    ...
    List<Map<String, Object>> selectsdczyh(String proname, String bz, String lf, String sdzhq, String sdz, String zx, String zhq1, String zhz1, List<Long> idlist);
    ...
    List<Map<String, Object>> selectqlczyh(String proname, String bz, String lf, String qlzhq, String qlzhz, String zx, String zhq1, String zhz1, List<Long> idlist);
    ...
    List<Map<String, Object>> selectsdczyhx(String proname, String lf, String wz, String sdzhq, String sdz, String sdname, String zhq1, String zhz1, List<Long> idlist);

    List<Map<String, Object>> selectqlczyhx(String proname, String lf, String wz, String qlzhq, String qlzhz, String qlname, String zhq1, String zhz1, List<Long> idlist);
