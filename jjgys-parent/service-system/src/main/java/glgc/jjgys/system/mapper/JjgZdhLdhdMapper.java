...
public interface JjgZdhLdhdMapper extends BaseMapper<JjgZdhLdhd> {
    ...
    List<Map<String, Object>> selectSdZfDatayh(String proname, String htd, String zhq, String zhz, String result, List<Long> idlist);

    List<Map<String, Object>> selectSdyfData(String proname, String htd, String zhq, String zhz,String result);

    List<Map<String, Object>> selectSdyfDatayh(String proname, String htd, String zhq, String zhz, String result, List<Long> idlist);

    List<Map<String, Object>> selectQlZfData(String proname, String htd, String zhq, String zhz,String result);

    List<Map<String, Object>> selectQlZfDatayh(String proname, String htd, String zhq, String zhz, String result, List<Long> idlist);

    List<Map<String, Object>> selectQlYfData(String proname, String htd, String zhq, String zhz,String result);

    List<Map<String, Object>> selectQlYfDatayh(String proname, String htd, String zhq, String zhz, String result, List<Long> idlist);
    ...
    List<Map<String, Object>> selectsdldhdyh(String proname, String bz, String lf, String zx, String sdzhq, String sdzhz,String result ,List<Long> idlist);

    List<Map<String, Object>> selectqlldhd(String proname, String bz, String lf, String zx, String qlzhq, String qlzhz);

    List<Map<String, Object>> selectqlldhdyh(String proname, String bz, String lf, String zx, String qlzhq, String qlzhz, String result, List<Long> idlist);
    ...
    List<Map<String, Object>> selectsdldhdyhx(String proname, String lf, String wz, String sdzhq, String sdzhz, String sdname, List<Long> idlist);

    List<Map<String, Object>> selectqlldhdyhx(String proname, String lf, String wz, String qlzhq, String qlzhz, String qlname, List<Long> idlist);
