...
public class JjgFbgcJtaqssJathlqdServiceImpl extends ServiceImpl<JjgFbgcJtaqssJathlqdMapper, JjgFbgcJtaqssJathlqd> implements JjgFbgcJtaqssJathlqdService {
    ...
    public void importjathlqd(MultipartFile file, CommonInfoVo commonInfoVo) {
        ...
        try {
                                ...
                                public void handle(List<JjgFbgcJtaqssJathlqdVo> dataList) {
                                    ...
                                    for(JjgFbgcJtaqssJathlqdVo jtaqssJathlqdVo: dataList)
                                    {
                                        if (StringUtils.isEmpty(jtaqssJathlqdVo.getZh())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中04交安砼护栏强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，桩号为空，请修改后重新上传");
                                        }
                                        if (StringUtils.isEmpty(jtaqssJathlqdVo.getBw1())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中04交安砼护栏强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，部位1值为空，请修改后重新上传");
                                        }
                                        if (StringUtils.isEmpty(jtaqssJathlqdVo.getBw2())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中04交安砼护栏强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，部位2值为空，请修改后重新上传");
                                        }
                                        if (!StringUtils.isNumeric(jtaqssJathlqdVo.getCdz1()) || StringUtils.isEmpty(jtaqssJathlqdVo.getCdz1())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中04交安砼护栏强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，测定值1值有误，请修改后重新上传");
                                        }
                                        if (!StringUtils.isNumeric(jtaqssJathlqdVo.getZ2()) || StringUtils.isEmpty(jtaqssJathlqdVo.getZ2())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中04交安砼护栏强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，值2有误，请修改后重新上传");
                                        }
                                        if (!StringUtils.isNumeric(jtaqssJathlqdVo.getZ3()) || StringUtils.isEmpty(jtaqssJathlqdVo.getZ3())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中04交安砼护栏强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，值3有误，请修改后重新上传");
                                        }
                                        if (!StringUtils.isNumeric(jtaqssJathlqdVo.getZ4()) || StringUtils.isEmpty(jtaqssJathlqdVo.getZ4())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中04交安砼护栏强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，值4有误，请修改后重新上传");
                                        }
                                        if (!StringUtils.isNumeric(jtaqssJathlqdVo.getZ5()) || StringUtils.isEmpty(jtaqssJathlqdVo.getZ5())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中04交安砼护栏强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，值5有误，请修改后重新上传");
                                        }
                                        if (!StringUtils.isNumeric(jtaqssJathlqdVo.getZ6())|| StringUtils.isEmpty(jtaqssJathlqdVo.getZ6())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中04交安砼护栏强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，值6有误，请修改后重新上传");
                                        }
                                        if (!StringUtils.isNumeric(jtaqssJathlqdVo.getZ7())|| StringUtils.isEmpty(jtaqssJathlqdVo.getZ7())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中04交安砼护栏强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，值7有误，请修改后重新上传");
                                        }
                                        if (!StringUtils.isNumeric(jtaqssJathlqdVo.getZ8())|| StringUtils.isEmpty(jtaqssJathlqdVo.getZ8())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中04交安砼护栏强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，值8有误，请修改后重新上传");
                                        }
                                        if (!StringUtils.isNumeric(jtaqssJathlqdVo.getZ9())|| StringUtils.isEmpty(jtaqssJathlqdVo.getZ9())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中04交安砼护栏强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，值9有误，请修改后重新上传");
                                        }
                                        if (!StringUtils.isNumeric(jtaqssJathlqdVo.getZ10()) || StringUtils.isEmpty(jtaqssJathlqdVo.getZ10())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中04交安砼护栏强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，值10有误，请修改后重新上传");
                                        }
                                        if (!StringUtils.isNumeric(jtaqssJathlqdVo.getZ11()) || StringUtils.isEmpty(jtaqssJathlqdVo.getZ11())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中04交安砼护栏强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，值11有误，请修改后重新上传");
                                        }
                                        if (!StringUtils.isNumeric(jtaqssJathlqdVo.getZ12()) || StringUtils.isEmpty(jtaqssJathlqdVo.getZ12())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中04交安砼护栏强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，值12有误，请修改后重新上传");
                                        }
                                        if (!StringUtils.isNumeric(jtaqssJathlqdVo.getZ13())|| StringUtils.isEmpty(jtaqssJathlqdVo.getZ13())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中04交安砼护栏强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，值13有误，请修改后重新上传");
                                        }
                                        if (!StringUtils.isNumeric(jtaqssJathlqdVo.getZ14()) || StringUtils.isEmpty(jtaqssJathlqdVo.getZ14())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中04交安砼护栏强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，值14有误，请修改后重新上传");
                                        }
                                        if (!StringUtils.isNumeric(jtaqssJathlqdVo.getZ15())|| StringUtils.isEmpty(jtaqssJathlqdVo.getZ15())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中04交安砼护栏强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，值15有误，请修改后重新上传");
                                        }
                                        if (!StringUtils.isNumeric(jtaqssJathlqdVo.getZ16())|| StringUtils.isEmpty(jtaqssJathlqdVo.getZ16())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中04交安砼护栏强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，值16有误，请修改后重新上传");
                                        }
                                        if (StringUtils.isEmpty(jtaqssJathlqdVo.getHtjd())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中04交安砼护栏强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，回弹角度值是空的，请修改后重新上传");
                                        }
                                        if (StringUtils.isEmpty(jtaqssJathlqdVo.getJzm())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中04交安砼护栏强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，浇筑面值是空的，请修改后重新上传");
                                        }
                                        if (StringUtils.isEmpty(jtaqssJathlqdVo.getThsd())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中04交安砼护栏强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，碳化深度值是空的，请修改后重新上传");
                                        }
                                        if (StringUtils.isEmpty(jtaqssJathlqdVo.getSfbs())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中04交安砼护栏强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，是否泵送值是空的，请修改后重新上传");
                                        }
                                        if (StringUtils.isEmpty(jtaqssJathlqdVo.getSjqd()) || jtaqssJathlqdVo.getSjqd().contains("C")) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中04交安砼护栏强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，设计强度值有误（为空或者有C字样），请修改后重新上传");
                                        }
                                        ...
                                        jtaqssJathlqd.setUserid(commonInfoVo.getUserid());
            ...
            throw new JjgysException(20001,"您上传的"+htd+"合同段中04交安砼护栏强度实测数据.xlsx文件，解析excel出错，请传入正确格式的excel");
        }catch (NullPointerException e) {
            throw new JjgysException(20001,"您上传的"+htd+"合同段中04交安砼护栏强度实测数据.xlsx文件，请检查数据的正确性或删除文件最后的空数据，然后重新上传");
        }catch (ExcelAnalysisException e) {
            throw new JjgysException(20001,"您上传的"+htd+"合同段中04交安砼护栏强度实测数据.xlsx文件，请将检测日期修改为2021/01/01的格式，然后重新上传");
        }
    ...
    public void exportjathlqd(HttpServletResponse response) {
        ...
        try {
            ...
            File t = new File(courseFile+File.separator+"04交安砼护栏强度实测数据.xlsx");
            if (t.exists()){
                t.delete();
            }
        }
    ...
    @Override
    public int createMoreRecords(List<JjgFbgcJtaqssJathlqd> data, String userID) {
        return ReceiveUtils.createMore(data, jjgFbgcJtaqssJathlqdMapper, userID);
    }
