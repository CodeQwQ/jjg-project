...
public class JjgFbgcLjgcServiceImpl implements JjgFbgcLjgcService {
    ...
    public void exportljgc(HttpServletResponse response,String workpath) {
        ...
        try {
            List<String> filenames=asList("08涵洞砼强度实测数据","09涵洞结构尺寸实测数据","04排水断面尺寸实测数据","05排水铺砌厚度实测数据","01路基沉降量实测数据",
            ...
            list.add(new File(filepath+"/01路基沉降量实测数据.xlsx"));
    ...
    public  void download(HttpServletResponse response,String filename,String workpath){
        ...
        list.add(new File(workpath+"/01路基沉降量.xlsx"));
    ...
    public void getFile(String workpath, String htd) {//String workpath=filespath+ File.separator+proname;
        ...
        list.add(new File(workpath+File.separator+htd+File.separator+"01路基沉降量.xlsx"));
