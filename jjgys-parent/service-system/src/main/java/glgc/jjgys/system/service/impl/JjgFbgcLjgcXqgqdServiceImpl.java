...
public class JjgFbgcLjgcXqgqdServiceImpl extends ServiceImpl<JjgFbgcLjgcXqgqdMapper, JjgFbgcLjgcXqgqd> implements JjgFbgcLjgcXqgqdService {
    ...
    public boolean generateJdb(CommonInfoVo commonInfoVo) throws Exception {
        ...
        if (data == null || data.size()==0){
            ...
            try {
                ...
                InputStream inputStream = getClass().getClassLoader().getResourceAsStream("static/小桥砼强度.xlsx");
    ...
    public void exportxqgqd(HttpServletResponse response) {
        ...
        try {
            ...
            File t = new File(courseFile+File.separator+"06小桥砼强度实测数据.xlsx");
            if (t.exists()){
                t.delete();
            }
        }
    ...
    public void importxqgqd(MultipartFile file,CommonInfoVo commonInfoVo) {
        ...
        try {
                                ...
                                public void handle(List<JjgFbgcLjgcXqgqdVo> dataList) {
                                    ...
                                    for(JjgFbgcLjgcXqgqdVo xqgqdVo: dataList)
                                    {
                                        if (StringUtils.isEmpty(xqgqdVo.getZh())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中06小桥砼强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，桩号为空，请修改后重新上传");
                                        }
                                        if (StringUtils.isEmpty(xqgqdVo.getBw1())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中06小桥砼强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，部位1值为空，请修改后重新上传");
                                        }
                                        if (StringUtils.isEmpty(xqgqdVo.getBw2())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中06小桥砼强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，部位2值为空，请修改后重新上传");
                                        }
                                        if (!StringUtils.isNumeric(xqgqdVo.getCdz1()) || StringUtils.isEmpty(xqgqdVo.getCdz1())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中06小桥砼强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，测定值1值有误，请修改后重新上传");
                                        }
                                        if (!StringUtils.isNumeric(xqgqdVo.getZ2()) || StringUtils.isEmpty(xqgqdVo.getZ2())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中06小桥砼强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，值2有误，请修改后重新上传");
                                        }
                                        if (!StringUtils.isNumeric(xqgqdVo.getZ3()) || StringUtils.isEmpty(xqgqdVo.getZ3())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中06小桥砼强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，值3有误，请修改后重新上传");
                                        }
                                        if (!StringUtils.isNumeric(xqgqdVo.getZ4()) || StringUtils.isEmpty(xqgqdVo.getZ4())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中06小桥砼强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，值4有误，请修改后重新上传");
                                        }
                                        if (!StringUtils.isNumeric(xqgqdVo.getZ5()) || StringUtils.isEmpty(xqgqdVo.getZ5())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中06小桥砼强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，值5有误，请修改后重新上传");
                                        }
                                        if (!StringUtils.isNumeric(xqgqdVo.getZ6())|| StringUtils.isEmpty(xqgqdVo.getZ6())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中06小桥砼强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，值6有误，请修改后重新上传");
                                        }
                                        if (!StringUtils.isNumeric(xqgqdVo.getZ7())|| StringUtils.isEmpty(xqgqdVo.getZ7())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中06小桥砼强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，值7有误，请修改后重新上传");
                                        }
                                        if (!StringUtils.isNumeric(xqgqdVo.getZ8())|| StringUtils.isEmpty(xqgqdVo.getZ8())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中06小桥砼强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，值8有误，请修改后重新上传");
                                        }
                                        if (!StringUtils.isNumeric(xqgqdVo.getZ9())|| StringUtils.isEmpty(xqgqdVo.getZ9())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中06小桥砼强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，值9有误，请修改后重新上传");
                                        }
                                        if (!StringUtils.isNumeric(xqgqdVo.getZ10()) || StringUtils.isEmpty(xqgqdVo.getZ10())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中06小桥砼强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，值10有误，请修改后重新上传");
                                        }
                                        if (!StringUtils.isNumeric(xqgqdVo.getZ11()) || StringUtils.isEmpty(xqgqdVo.getZ11())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中06小桥砼强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，值11有误，请修改后重新上传");
                                        }
                                        if (!StringUtils.isNumeric(xqgqdVo.getZ12()) || StringUtils.isEmpty(xqgqdVo.getZ12())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中06小桥砼强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，值12有误，请修改后重新上传");
                                        }
                                        if (!StringUtils.isNumeric(xqgqdVo.getZ13())|| StringUtils.isEmpty(xqgqdVo.getZ13())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中06小桥砼强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，值13有误，请修改后重新上传");
                                        }
                                        if (!StringUtils.isNumeric(xqgqdVo.getZ14()) || StringUtils.isEmpty(xqgqdVo.getZ14())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中06小桥砼强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，值14有误，请修改后重新上传");
                                        }
                                        if (!StringUtils.isNumeric(xqgqdVo.getZ15())|| StringUtils.isEmpty(xqgqdVo.getZ15())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中06小桥砼强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，值15有误，请修改后重新上传");
                                        }
                                        if (!StringUtils.isNumeric(xqgqdVo.getZ16())|| StringUtils.isEmpty(xqgqdVo.getZ16())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中06小桥砼强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，值16有误，请修改后重新上传");
                                        }
                                        if (StringUtils.isEmpty(xqgqdVo.getHtjd())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中06小桥砼强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，回弹角度值是空的，请修改后重新上传");
                                        }
                                        if (StringUtils.isEmpty(xqgqdVo.getJzm())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中06小桥砼强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，浇筑面值是空的，请修改后重新上传");
                                        }
                                        if (StringUtils.isEmpty(xqgqdVo.getThsd())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中06小桥砼强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，碳化深度值是空的，请修改后重新上传");
                                        }
                                        if (StringUtils.isEmpty(xqgqdVo.getSfbs())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中06小桥砼强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，是否泵送值是空的，请修改后重新上传");
                                        }
                                        if (StringUtils.isEmpty(xqgqdVo.getSjqd())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中06小桥砼强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，设计强度值是空的，请修改后重新上传");
                                        }
                                        ...
                                        fbgcLjgcXqgqd.setUserid(commonInfoVo.getUserid());
            ...
            throw new JjgysException(20001,"您上传的"+htd+"合同段中06小桥砼强度实测数据.xlsx文件，解析excel出错，请传入正确格式的excel");
        }catch (NullPointerException e) {
            throw new JjgysException(20001,"您上传的"+htd+"合同段中06小桥砼强度实测数据.xlsx文件，请检查数据的正确性或删除文件最后的空数据，然后重新上传");
        }catch (ExcelAnalysisException e) {
            throw new JjgysException(20001,"您上传的"+htd+"合同段中06小桥砼强度实测数据.xlsx文件，请将检测日期修改为2021/01/01的格式，然后重新上传");
        }
    ...
    @Override
    public int createMoreRecords(List<JjgFbgcLjgcXqgqd> data, String userID) {
        return ReceiveUtils.createMore(data, jjgFbgcLjgcXqgqdMapper, userID);
    }
