...
public class JjgFbgcLjgcZdgqdServiceImpl extends ServiceImpl<JjgFbgcLjgcZdgqdMapper, JjgFbgcLjgcZdgqd> implements JjgFbgcLjgcZdgqdService {
    ...
    public boolean generateJdb(CommonInfoVo commonInfoVo) throws IOException, ParseException {
        ...
        if (data == null || data.size()==0){
            ...
            try {
                ...
                InputStream inputStream = getClass().getClassLoader().getResourceAsStream("static/支挡砼强度.xlsx");
    ...
    public void exportzdgqd(HttpServletResponse response) {
        ...
        try {
            ...
            File t = new File(courseFile+File.separator+"10支挡砼强度实测数据.xlsx");
            if (t.exists()){
                t.delete();
            }
        }
    ...
    public void importzdgqd(MultipartFile file,CommonInfoVo commonInfoVo) {
        ...
        try {
                                ...
                                public void handle(List<JjgFbgcLjgcZdgqdVo> dataList) {
                                    ...
                                    for(JjgFbgcLjgcZdgqdVo zdgqdVo: dataList)
                                    {
                                        if (StringUtils.isEmpty(zdgqdVo.getZh())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中10支挡砼强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，桩号为空，请修改后重新上传");
                                        }
                                        if (StringUtils.isEmpty(zdgqdVo.getBw1())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中10支挡砼强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，部位1值为空，请修改后重新上传");
                                        }
                                        if (StringUtils.isEmpty(zdgqdVo.getBw2())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中10支挡砼强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，部位2值为空，请修改后重新上传");
                                        }
                                        if (!StringUtils.isNumeric(zdgqdVo.getCdz1()) || StringUtils.isEmpty(zdgqdVo.getCdz1())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中10支挡砼强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，测定值1值有误，请修改后重新上传");
                                        }
                                        if (!StringUtils.isNumeric(zdgqdVo.getZ2()) || StringUtils.isEmpty(zdgqdVo.getZ2())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中10支挡砼强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，值2有误，请修改后重新上传");
                                        }
                                        if (!StringUtils.isNumeric(zdgqdVo.getZ3()) || StringUtils.isEmpty(zdgqdVo.getZ3())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中10支挡砼强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，值3有误，请修改后重新上传");
                                        }
                                        if (!StringUtils.isNumeric(zdgqdVo.getZ4()) || StringUtils.isEmpty(zdgqdVo.getZ4())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中10支挡砼强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，值4有误，请修改后重新上传");
                                        }
                                        if (!StringUtils.isNumeric(zdgqdVo.getZ5()) || StringUtils.isEmpty(zdgqdVo.getZ5())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中10支挡砼强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，值5有误，请修改后重新上传");
                                        }
                                        if (!StringUtils.isNumeric(zdgqdVo.getZ6())|| StringUtils.isEmpty(zdgqdVo.getZ6())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中10支挡砼强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，值6有误，请修改后重新上传");
                                        }
                                        if (!StringUtils.isNumeric(zdgqdVo.getZ7())|| StringUtils.isEmpty(zdgqdVo.getZ7())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中10支挡砼强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，值7有误，请修改后重新上传");
                                        }
                                        if (!StringUtils.isNumeric(zdgqdVo.getZ8())|| StringUtils.isEmpty(zdgqdVo.getZ8())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中10支挡砼强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，值8有误，请修改后重新上传");
                                        }
                                        if (!StringUtils.isNumeric(zdgqdVo.getZ9())|| StringUtils.isEmpty(zdgqdVo.getZ9())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中10支挡砼强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，值9有误，请修改后重新上传");
                                        }
                                        if (!StringUtils.isNumeric(zdgqdVo.getZ10()) || StringUtils.isEmpty(zdgqdVo.getZ10())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中10支挡砼强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，值10有误，请修改后重新上传");
                                        }
                                        if (!StringUtils.isNumeric(zdgqdVo.getZ11()) || StringUtils.isEmpty(zdgqdVo.getZ11())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中10支挡砼强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，值11有误，请修改后重新上传");
                                        }
                                        if (!StringUtils.isNumeric(zdgqdVo.getZ12()) || StringUtils.isEmpty(zdgqdVo.getZ12())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中10支挡砼强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，值12有误，请修改后重新上传");
                                        }
                                        if (!StringUtils.isNumeric(zdgqdVo.getZ13())|| StringUtils.isEmpty(zdgqdVo.getZ13())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中10支挡砼强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，值13有误，请修改后重新上传");
                                        }
                                        if (!StringUtils.isNumeric(zdgqdVo.getZ14()) || StringUtils.isEmpty(zdgqdVo.getZ14())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中10支挡砼强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，值14有误，请修改后重新上传");
                                        }
                                        if (!StringUtils.isNumeric(zdgqdVo.getZ15())|| StringUtils.isEmpty(zdgqdVo.getZ15())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中10支挡砼强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，值15有误，请修改后重新上传");
                                        }
                                        if (!StringUtils.isNumeric(zdgqdVo.getZ16())|| StringUtils.isEmpty(zdgqdVo.getZ16())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中10支挡砼强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，值16有误，请修改后重新上传");
                                        }
                                        if (StringUtils.isEmpty(zdgqdVo.getHtjd())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中10支挡砼强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，回弹角度值是空的，请修改后重新上传");
                                        }
                                        if (StringUtils.isEmpty(zdgqdVo.getJzm())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中10支挡砼强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，浇筑面值是空的，请修改后重新上传");
                                        }
                                        if (StringUtils.isEmpty(zdgqdVo.getThsd())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中10支挡砼强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，碳化深度值是空的，请修改后重新上传");
                                        }
                                        if (StringUtils.isEmpty(zdgqdVo.getSfbs())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中10支挡砼强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，是否泵送值是空的，请修改后重新上传");
                                        }
                                        if (StringUtils.isEmpty(zdgqdVo.getSjqd())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中10支挡砼强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，设计强度值是空的，请修改后重新上传");
                                        }
                                        ...
                                        fbgcLjgcZdgqd.setUserid(commonInfoVo.getUserid());
            ...
            throw new JjgysException(20001,"您上传的"+htd+"合同段中10支挡砼强度实测数据.xlsx文件，解析excel出错，请传入正确格式的excel");
        }catch (NullPointerException e) {
            throw new JjgysException(20001,"您上传的"+htd+"合同段中10支挡砼强度实测数据.xlsx文件，请检查数据的正确性或删除文件最后的空数据，然后重新上传");
        }catch (ExcelAnalysisException e) {
            throw new JjgysException(20001,"您上传的"+htd+"合同段中10支挡砼强度实测数据.xlsx文件，请将检测日期修改为2021/01/01的格式，然后重新上传");
        }
    ...
    @Override
    public int createMoreRecords(List<JjgFbgcLjgcZdgqd> data, String userID) {
        return ReceiveUtils.createMore(data, jjgFbgcLjgcZdgqdMapper, userID);
    }
