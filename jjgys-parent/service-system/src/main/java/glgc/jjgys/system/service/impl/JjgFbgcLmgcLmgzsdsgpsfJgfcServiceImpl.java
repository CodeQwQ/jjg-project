...
public class JjgFbgcLmgcLmgzsdsgpsfJgfcServiceImpl extends ServiceImpl<JjgFbgcLmgcLmgzsdsgpsfJgfcMapper, JjgFbgcLmgcLmgzsdsgpsfJgfc> implements JjgFbgcLmgcLmgzsdsgpsfJgfcService {
    ...
    public void exportlmgzsdsgpsf(HttpServletResponse response) {
        ...
        try {
            ...
            File t = new File(courseFile+File.separator+"路面构造深度手工铺砂法实测数据.xlsx");
            if (t.exists()){
                t.delete();
            }
        }
    ...
    @Override
    public int createMoreRecords(List<JjgFbgcLmgcLmgzsdsgpsfJgfc> data, String userID) {
        return ReceiveUtils.createMore(data, jjgFbgcLmgcLmgzsdsgpsfJgfcMapper, userID);
    }
    ...
    public List<Map<String, Object>> lookJdbjg(String proname) throws IOException {
        ...
        List<String> gethtd = jjgFbgcLmgcLmgzsdsgpsfJgfcMapper.gethtd(proname);
