...
public class JjgFbgcLmgcLmssxsServiceImpl extends ServiceImpl<JjgFbgcLmgcLmssxsMapper, JjgFbgcLmgcLmssxs> implements JjgFbgcLmgcLmssxsService {
    ...
    public Boolean generateJdb(CommonInfoVo commonInfoVo) throws IOException, ParseException {
        ...
        List<JjgFbgcLmgcLmssxs> ljxzfdata = new ArrayList<>();
            List<JjgFbgcLmgcLmssxs> ljxyfdata = new ArrayList<>();
        ...
        for (JjgFbgcLmgcLmssxs lmssxs : data){
            if (lmssxs.getZh().substring(0,1).equals("Z") && lmssxs.getLxlx().equals("主线")){
                ...
                zddata.add(lmssxs);
            }else if (lmssxs.getLxlx().contains("连接线")){
                if (lmssxs.getZh().substring(0,1).equals("Y")){
                    ljxyfdata.add(lmssxs);
                }else {
                    ljxzfdata.add(lmssxs);
                }
            }
        }
        ...
        if (data == null || data.size()==0){
            ...
            try {
                ...
                InputStream inputStream = getClass().getClassLoader().getResourceAsStream("static/沥青路面渗水系数.xlsx");
                ...
                createTable(getzxzftableNum(zddata.size()),wb,"连接线路面左幅");
                createTable(getzxzftableNum(zddata.size()),wb,"连接线路面右幅");
                ...
                DBtoExcel(ljxzfdata,wb,"连接线路面左幅");
                DBtoExcel(ljxyfdata,wb,"连接线路面右幅");
                ...
                wb.setSheetHidden(wb.getSheetIndex("source"), HSSFWorkbook.SHEET_STATE_VERY_HIDDEN);
    ...
    private void calculateOneSheet(XSSFSheet sheet) {
        ...
        for (int i = sheet.getFirstRowNum(); i <= sheet.getPhysicalNumberOfRows(); i++) {
            ...
            if (flag) {
                ...
                if ("".equals(row.getCell(0).toString()) && row.getCell(1).getCellType() == Cell.CELL_TYPE_NUMERIC) {// !"合计".equals(row.getCell(0).toString())){
                    cal = true;
                    rowend = row;
                } else {
                    if (cal) {
    ...
    private void DBtoExcel(List<JjgFbgcLmgcLmssxs> data, XSSFWorkbook wb,String sheetname) throws ParseException {
        ...
        if (data.size()>0){
            ...
            sheet.getRow(3).getCell(2).setCellValue("沥青混凝土");
            ...
            for(int i =0; i < data.size(); i++){
                if(type.equals(data.get(i).getLxlx()) && zh.equals(data.get(i).getZh())){
                    ...
                    if ("主线".equals(type)){
                        ...
                        sheet.getRow(index-3).getCell(0).setCellValue(type+zh);
                    }

                    sheet.addMergedRegion(new CellRangeAddress(index-3, index-1, 8, 8));
                    sheet.addMergedRegion(new CellRangeAddress(index-3, index-1, 9, 9));
                    sheet.getRow(index-3).getCell(9).setCellValue(Double.valueOf(data.get(i).getSsxsgdz()));
                    sheet.addMergedRegion(new CellRangeAddress(index-3, index-1, 10, 10));
                    sheet.addMergedRegion(new CellRangeAddress(index-3, index-1, 11, 11));
                    i += 2;
                }
                else{
    ...
    private void fillCommonCellData(XSSFSheet sheet, int index, JjgFbgcLmgcLmssxs row) {
        sheet.getRow(index).getCell(1).setCellValue((index-6)%3+1);
            ...
            for (int j = 0; j < wb.getNumberOfSheets(); j++) {
                if (!wb.isSheetHidden(wb.getSheetIndex(wb.getSheetAt(j)))) {
                    ...
                    if (!"source".equals(sheetName) && (flag == 1 || sheetName.contains("沥青路面") || sheetName.contains("匝道路面"))){
                        ...
                        slSheet.getRow(sllastRowNum).getCell(10).setCellType(CellType.STRING);//合格率（%）
                        slSheet.getRow(6).getCell(9).setCellType(CellType.STRING);//合格率（%）

                        slSheet.getRow(sllastRowNum).getCell(12).setCellType(CellType.STRING);
                        slSheet.getRow(sllastRowNum).getCell(13).setCellType(CellType.STRING);
                        ...
                        map1.put("合格率",df.format(Double.valueOf(slSheet.getRow(sllastRowNum).getCell(10).getStringCellValue())));

                        map1.put("最大值",slSheet.getRow(sllastRowNum).getCell(12).getStringCellValue());
                    ...
                    /*if (sheetName.equals("沥青路面(左幅)")){
                        ...
                        mapList.add(map1);
                    }else if (sheetName.equals("沥青路面(右幅)")){
                        int sllastRowNum = slSheet.getLastRowNum();
                        slSheet.getRow(sllastRowNum).getCell(4).setCellType(CellType.STRING);//检测点数
                        slSheet.getRow(sllastRowNum).getCell(8).setCellType(CellType.STRING);//合格点数
                        slSheet.getRow(sllastRowNum).getCell(10).setCellType(CellType.STRING);//合格率（%）
                        ...
                        map2.put("规定值",slSheet.getRow(6).getCell(9).getStringCellValue());
                        map2.put("检测点数",decf.format(Double.valueOf(slSheet.getRow(sllastRowNum).getCell(4).getStringCellValue())));
                        map2.put("合格点数",decf.format(Double.valueOf(slSheet.getRow(sllastRowNum).getCell(8).getStringCellValue())));
                        map2.put("合格率",df.format(Double.valueOf(slSheet.getRow(sllastRowNum).getCell(10).getStringCellValue())));
                        map2.put("最大值",slSheet.getRow(sllastRowNum).getCell(12).getStringCellValue());
                        map2.put("最小值",slSheet.getRow(sllastRowNum).getCell(13).getStringCellValue());
                        mapList.add(map2);
                        
                    }else if (sheetName.equals("隧道路面(左幅)")){
                        int sllastRowNum = slSheet.getLastRowNum();
                        slSheet.getRow(sllastRowNum).getCell(4).setCellType(CellType.STRING);//检测点数
                        slSheet.getRow(sllastRowNum).getCell(8).setCellType(CellType.STRING);//合格点数
                        slSheet.getRow(sllastRowNum).getCell(10).setCellType(CellType.STRING);//合格率（%）
                        ...
                        map3.put("规定值",slSheet.getRow(6).getCell(9).getStringCellValue());
                        map3.put("检测点数",decf.format(Double.valueOf(slSheet.getRow(sllastRowNum).getCell(4).getStringCellValue())));
                        map3.put("合格点数",decf.format(Double.valueOf(slSheet.getRow(sllastRowNum).getCell(8).getStringCellValue())));
                        map3.put("合格率",df.format(Double.valueOf(slSheet.getRow(sllastRowNum).getCell(10).getStringCellValue())));
                        map3.put("最大值",slSheet.getRow(sllastRowNum).getCell(12).getStringCellValue());
                        map3.put("最小值",slSheet.getRow(sllastRowNum).getCell(13).getStringCellValue());
                        mapList.add(map3);

                    }else if (sheetName.equals("隧道路面(右幅)")){
                        int sllastRowNum = slSheet.getLastRowNum();
                        slSheet.getRow(sllastRowNum).getCell(4).setCellType(CellType.STRING);//检测点数
                        slSheet.getRow(sllastRowNum).getCell(8).setCellType(CellType.STRING);//合格点数
                        slSheet.getRow(sllastRowNum).getCell(10).setCellType(CellType.STRING);//合格率（%）
                        ...
                        map4.put("规定值",slSheet.getRow(6).getCell(9).getStringCellValue());
                        map4.put("检测点数",decf.format(Double.valueOf(slSheet.getRow(sllastRowNum).getCell(4).getStringCellValue())));
                        map4.put("合格点数",decf.format(Double.valueOf(slSheet.getRow(sllastRowNum).getCell(8).getStringCellValue())));
                        map4.put("合格率",df.format(Double.valueOf(slSheet.getRow(sllastRowNum).getCell(10).getStringCellValue())));
                        map4.put("最大值",slSheet.getRow(sllastRowNum).getCell(12).getStringCellValue());
                        map4.put("最小值",slSheet.getRow(sllastRowNum).getCell(13).getStringCellValue());
                        mapList.add(map4);

                    }else if (sheetName.equals("匝道路面")){
                        int sllastRowNum = slSheet.getLastRowNum();
                        slSheet.getRow(sllastRowNum).getCell(4).setCellType(CellType.STRING);//检测点数
                        slSheet.getRow(sllastRowNum).getCell(8).setCellType(CellType.STRING);//合格点数
                        slSheet.getRow(sllastRowNum).getCell(10).setCellType(CellType.STRING);//合格率（%）
                        ...
                        slSheet.getRow(sllastRowNum).getCell(13).setCellType(CellType.STRING);
                        map5.put("检测项目","匝道路面");
                        map5.put("规定值",slSheet.getRow(6).getCell(9).getStringCellValue());
                        map5.put("检测点数",decf.format(Double.valueOf(slSheet.getRow(sllastRowNum).getCell(4).getStringCellValue())));
                        map5.put("合格点数",decf.format(Double.valueOf(slSheet.getRow(sllastRowNum).getCell(8).getStringCellValue())));
                        map5.put("合格率",df.format(Double.valueOf(slSheet.getRow(sllastRowNum).getCell(10).getStringCellValue())));
                        map5.put("最大值",slSheet.getRow(sllastRowNum).getCell(12).getStringCellValue());
                        map5.put("最小值",slSheet.getRow(sllastRowNum).getCell(13).getStringCellValue());
                        mapList.add(map5);

                    }else if (sheetName.equals("连接线路面左幅")){
                        int sllastRowNum = slSheet.getLastRowNum();
                        slSheet.getRow(sllastRowNum).getCell(4).setCellType(CellType.STRING);//检测点数
                        slSheet.getRow(sllastRowNum).getCell(8).setCellType(CellType.STRING);//合格点数
                        slSheet.getRow(sllastRowNum).getCell(10).setCellType(CellType.STRING);//合格率（%）
                    ...
                    } else if (sheetName.equals("连接线路面右幅")){
                        int sllastRowNum = slSheet.getLastRowNum();
                        slSheet.getRow(sllastRowNum).getCell(4).setCellType(CellType.STRING);//检测点数
                        slSheet.getRow(sllastRowNum).getCell(8).setCellType(CellType.STRING);//合格点数
                        slSheet.getRow(sllastRowNum).getCell(10).setCellType(CellType.STRING);//合格率（%）
    ...
    public void exportLmssxs(HttpServletResponse response) {
        ...
        try {
            ...
            File t = new File(courseFile+File.separator+"04沥青路面渗水系数实测数据.xlsx");
            if (t.exists()){
                t.delete();
            }
        }
    ...
    public void importLmssxs(MultipartFile file, CommonInfoVo commonInfoVo) {
        ...
        try {
                    ...
                    .registerReadListener(
                            new ExcelHandler<JjgFbgcLmgcLmssxsVo>(JjgFbgcLmgcLmssxsVo.class) {
                                ...
                                public void handle(List<JjgFbgcLmgcLmssxsVo> dataList) {
                                    ...
                                    if (size % 3 != 0){
                                        throw new JjgysException(20001,"您上传的"+htd+"合同段中04沥青路面渗水系数实测数据.xlsx文件，数据量错误，请确保每个桩号有三条数据");
                                    }
                                    int rowNumber=2;
                                    for(JjgFbgcLmgcLmssxsVo lmssxsVo: dataList)
                                    {
                                        ...
                                        if (StringUtils.isEmpty(lmssxsVo.getLxlx())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中04沥青路面渗水系数实测数据.xlsx文件，第"+rowNumber+"行的数据中，主线匝道隧道为空，请修改后重新上传");
                                        }
                                        if (StringUtils.isEmpty(lmssxsVo.getZh())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中04沥青路面渗水系数实测数据.xlsx文件，第"+rowNumber+"行的数据中，桩号为空，请修改后重新上传");
                                        }
                                        if (!StringUtils.isNumeric(lmssxsVo.getCds()) || StringUtils.isEmpty(lmssxsVo.getCds())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中04沥青路面渗水系数实测数据.xlsx文件，第"+rowNumber+"行的数据中，初读数有误，请修改后重新上传");
                                        }
                                        if (!StringUtils.isNumeric(lmssxsVo.getOfzds()) || StringUtils.isEmpty(lmssxsVo.getOfzds())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中04沥青路面渗水系数实测数据.xlsx文件，第"+rowNumber+"行的数据中，第一分钟读数值有误，请修改后重新上传");
                                        }
                                        if (!StringUtils.isNumeric(lmssxsVo.getTfzds()) || StringUtils.isEmpty(lmssxsVo.getTfzds())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中04沥青路面渗水系数实测数据.xlsx文件，第"+rowNumber+"行的数据中，第二分钟读数值有误，请修改后重新上传");
                                        }
                                        if (!StringUtils.isNumeric(lmssxsVo.getSl()) || StringUtils.isEmpty(lmssxsVo.getSl())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中04沥青路面渗水系数实测数据.xlsx文件，第"+rowNumber+"行的数据中，水量值有误，请修改后重新上传");
                                        }
                                        if (!StringUtils.isNumeric(lmssxsVo.getSj()) || StringUtils.isEmpty(lmssxsVo.getSj())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中04沥青路面渗水系数实测数据.xlsx文件，第"+rowNumber+"行的数据中，时间值有误，请修改后重新上传");
                                        }
                                        if (!StringUtils.isNumeric(lmssxsVo.getSsxsgdz()) || StringUtils.isEmpty(lmssxsVo.getSsxsgdz())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中04沥青路面渗水系数实测数据.xlsx文件，第"+rowNumber+"行的数据中，深水系数规定值有误，请修改后重新上传");
                                        }
                                        ...
                                        lmssxs.setUserid(commonInfoVo.getUserid());
            ...
            throw new JjgysException(20001,"您上传的"+htd+"合同段中04沥青路面渗水系数实测数据.xlsx文件，解析excel出错，请传入正确格式的excel");
        }catch (NullPointerException e) {
            throw new JjgysException(20001,"您上传的"+htd+"合同段中04沥青路面渗水系数实测数据.xlsx文件，请检查数据的正确性或删除文件最后的空数据，然后重新上传");
        }catch (ExcelAnalysisException e) {
            throw new JjgysException(20001,"您上传的"+htd+"合同段中04沥青路面渗水系数实测数据.xlsx文件，请将检测日期修改为2021/01/01的格式，然后重新上传");
        }
    ...
    @Override
    public int createMoreRecords(List<JjgFbgcLmgcLmssxs> data, String userID) {
        return ReceiveUtils.createMore(data, jjgFbgcLmgcLmssxsMapper, userID);
    }
}
