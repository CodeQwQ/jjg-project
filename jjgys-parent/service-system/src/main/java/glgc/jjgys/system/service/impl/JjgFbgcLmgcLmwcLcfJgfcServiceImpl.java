...
import glgc.jjgys.model.projectvo.lmgc.JjgFbgcLmgcLmwcLcfJgfcVo;
import glgc.jjgys.system.easyexcel.ExcelHandler;
import glgc.jjgys.system.exception.JjgysException;
import glgc.jjgys.system.mapper.JjgFbgcLmgcLmwcLcfJgfcMapper;
 ...
 */
@Service
public class JjgFbgcLmgcLmwcLcfJgfcServiceImpl extends ServiceImpl<JjgFbgcLmgcLmwcLcfJgfcMapper, JjgFbgcLmgcLmwcLcfJgfc> implements JjgFbgcLmgcLmwcLcfJgfcService {

    @Autowired
    private JjgFbgcLmgcLmwcLcfJgfcMapper jjgFbgcLmgcLmwcLcfJgfcMapper;
    ...
    public List<Map<String, Object>> selecthtd(String proname) {
        List<Map<String,Object>> htdList = jjgFbgcLmgcLmwcLcfJgfcMapper.selecthtd(proname);
        return htdList;
    }

    @Override
    public boolean generateJdb(String proname) {
        List<String> htds = jjgFbgcLmgcLmwcLcfJgfcMapper.gethtd(proname);
        if (htds.size()>0){
            for (String htd : htds) {
    ...
    private void gethtdjdb(String proname, String htd) {
        ...
        List<JjgFbgcLmgcLmwcLcfJgfc> data = jjgFbgcLmgcLmwcLcfJgfcMapper.selectList(wrapper);

        //获取“温度修正”所需要的数据
        //List<Map<String,Object>> wdata = jjgFbgcLmgcLmwcLcfMapper.selectwdata(proname,htd,fbgc);

        File f = new File(jgfilepath+File.separator+proname+File.separator+htd+File.separator+"13路面弯沉(落锤法).xlsx");
...
//            }
     ...
     * @return
     */
    private boolean DBtoExcel(List<JjgFbgcLmgcLmwcLcfJgfc> data, XSSFWorkbook wb) {
        Collections.sort(data, new Comparator<JjgFbgcLmgcLmwcLcfJgfc>() {
            @Override
            public int compare(JjgFbgcLmgcLmwcLcfJgfc o1, JjgFbgcLmgcLmwcLcfJgfc o2) {
                // 名字相同时按照 qdzh 排序
                String zh = o1.getZh();
                String zh1 = o2.getZh();
        ...
        List<JjgFbgcLmgcLmwcLcfJgfc> zfdata = new ArrayList<>();
        List<JjgFbgcLmgcLmwcLcfJgfc> yfdata = new ArrayList<>();
        for (JjgFbgcLmgcLmwcLcfJgfc datum : data) {
     ...
     * @param sheetname
     */
    private void writezyfdata(List<JjgFbgcLmgcLmwcLcfJgfc> data, XSSFWorkbook wb,String sheetname) {
        Collections.sort(data, new Comparator<JjgFbgcLmgcLmwcLcfJgfc>() {
            @Override
            public int compare(JjgFbgcLmgcLmwcLcfJgfc o1, JjgFbgcLmgcLmwcLcfJgfc o2) {
                String zh = o1.getXh();
        ...
        for(JjgFbgcLmgcLmwcLcfJgfc row: data){
     ...
     * @return
     */
    private int gettableNum(List<JjgFbgcLmgcLmwcLcfJgfc> data) {
        Map<String, List<JjgFbgcLmgcLmwcLcfJgfc>> classifiedData = new HashMap<>();

        for (JjgFbgcLmgcLmwcLcfJgfc item : data) {
        ...
        int num = 0;
        // 分别统计每个List的长度
        for (Map.Entry<String, List<JjgFbgcLmgcLmwcLcfJgfc>> entry : classifiedData.entrySet()) {
            String xh = entry.getKey();
            List<JjgFbgcLmgcLmwcLcfJgfc> dataList = entry.getValue();
     ...
     * @param cellstyle
     */
    private void fillCommonCellData(XSSFSheet sheet, int tableNum, int index, JjgFbgcLmgcLmwcLcfJgfc row, XSSFCellStyle cellstyle) {
        if(row.getBz() == null || "".equals(row.getBz())){
     ...
     * @param position
     */
    private void fillTitleCellData(XSSFSheet sheet,int tableNum, JjgFbgcLmgcLmwcLcfJgfc row, String position) {
        SimpleDateFormat simpleDateFormat = new SimpleDateFormat("yyyy.MM.dd");
    ...
    public void exportlmwclcf(HttpServletResponse response) {
        ...
        try {
            ...
            ExcelUtil.writeExcelWithSheets(response, null, fileName, sheetName, new JjgFbgcLmgcLmwcLcfJgfcVo()).finish();
    ...
    public void importlmwclcf(MultipartFile file, CommonInfoVo commonInfoVo) {
        ...
        try {
            EasyExcel.read(file.getInputStream())
                    .sheet(0)
                    .head(JjgFbgcLmgcLmwcLcfJgfcVo.class)
                    .headRowNumber(1)
                    .registerReadListener(
                            new ExcelHandler<JjgFbgcLmgcLmwcLcfJgfcVo>(JjgFbgcLmgcLmwcLcfJgfcVo.class) {
                                @Override
                                public void handle(List<JjgFbgcLmgcLmwcLcfJgfcVo> dataList) {
                                    int rowNumber=2;
                                    for(JjgFbgcLmgcLmwcLcfJgfcVo lmwcLcfVo: dataList)
                                    {
                                        ...
                                        JjgFbgcLmgcLmwcLcfJgfc lmwcLcf = new JjgFbgcLmgcLmwcLcfJgfc();
                                        ...
                                        jjgFbgcLmgcLmwcLcfJgfcMapper.insert(lmwcLcf);
                                        rowNumber++;
                                    }
                                }
                            }
