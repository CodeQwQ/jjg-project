...
public class JjgFbgcQlgcSbTqdServiceImpl extends ServiceImpl<JjgFbgcQlgcSbTqdMapper, JjgFbgcQlgcSbTqd> implements JjgFbgcQlgcSbTqdService {
    ...
    public void exportqlsbtqd(HttpServletResponse response) {
        ...
        try {
            ...
            File t = new File(courseFile+File.separator+"05桥梁上部砼强度实测数据.xlsx");
            if (t.exists()){
                t.delete();
            }
        }
    ...
    public void importqlsbtqd(MultipartFile file, CommonInfoVo commonInfoVo) {
        ...
        try {
                                ...
                                public void handle(List<JjgFbgcQlgcSbTqdVo> dataList) {
                                    ...
                                    for(JjgFbgcQlgcSbTqdVo sbTqdVo: dataList)
                                    {
                                        if (StringUtils.isEmpty(sbTqdVo.getQlmc())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中05桥梁上部砼强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，桥梁名称为空，请修改后重新上传");
                                        }
                                        if (StringUtils.isEmpty(sbTqdVo.getBw1())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中05桥梁上部砼强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，部位1值为空，请修改后重新上传");
                                        }
                                        if (StringUtils.isEmpty(sbTqdVo.getBw2())) {
                                            throw new JjgysException(20001,"您上传的"+htd+"合同段中05桥梁上部砼强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，部位2值为空，请修改后重新上传");
                                        }
                                        if (!StringUtils.isNumeric(sbTqdVo.getCdz1()) || StringUtils.isEmpty(sbTqdVo.getCdz1())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中05桥梁上部砼强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，测定值1值有误，请修改后重新上传");
                                        }
                                        if (!StringUtils.isNumeric(sbTqdVo.getZ2()) || StringUtils.isEmpty(sbTqdVo.getZ2())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中05桥梁上部砼强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，值2有误，请修改后重新上传");
                                        }
                                        if (!StringUtils.isNumeric(sbTqdVo.getZ3()) || StringUtils.isEmpty(sbTqdVo.getZ3())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中05桥梁上部砼强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，值3有误，请修改后重新上传");
                                        }
                                        if (!StringUtils.isNumeric(sbTqdVo.getZ4()) || StringUtils.isEmpty(sbTqdVo.getZ4())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中05桥梁上部砼强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，值4有误，请修改后重新上传");
                                        }
                                        if (!StringUtils.isNumeric(sbTqdVo.getZ5()) || StringUtils.isEmpty(sbTqdVo.getZ5())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中05桥梁上部砼强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，值5有误，请修改后重新上传");
                                        }
                                        if (!StringUtils.isNumeric(sbTqdVo.getZ6())|| StringUtils.isEmpty(sbTqdVo.getZ6())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中05桥梁上部砼强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，值6有误，请修改后重新上传");
                                        }
                                        if (!StringUtils.isNumeric(sbTqdVo.getZ7())|| StringUtils.isEmpty(sbTqdVo.getZ7())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中05桥梁上部砼强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，值7有误，请修改后重新上传");
                                        }
                                        if (!StringUtils.isNumeric(sbTqdVo.getZ8())|| StringUtils.isEmpty(sbTqdVo.getZ8())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中05桥梁上部砼强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，值8有误，请修改后重新上传");
                                        }
                                        if (!StringUtils.isNumeric(sbTqdVo.getZ9())|| StringUtils.isEmpty(sbTqdVo.getZ9())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中05桥梁上部砼强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，值9有误，请修改后重新上传");
                                        }
                                        if (!StringUtils.isNumeric(sbTqdVo.getZ10()) || StringUtils.isEmpty(sbTqdVo.getZ10())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中05桥梁上部砼强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，值10有误，请修改后重新上传");
                                        }
                                        if (!StringUtils.isNumeric(sbTqdVo.getZ11()) || StringUtils.isEmpty(sbTqdVo.getZ11())) {
                                            throw new JjgysException(20001,"您上传的"+htd+"合同段中05桥梁上部砼强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，值11有误，请修改后重新上传");
                                        }
                                        if (!StringUtils.isNumeric(sbTqdVo.getZ12()) || StringUtils.isEmpty(sbTqdVo.getZ12())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中05桥梁上部砼强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，值12有误，请修改后重新上传");
                                        }
                                        if (!StringUtils.isNumeric(sbTqdVo.getZ13())|| StringUtils.isEmpty(sbTqdVo.getZ13())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中05桥梁上部砼强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，值13有误，请修改后重新上传");
                                        }
                                        if (!StringUtils.isNumeric(sbTqdVo.getZ14()) || StringUtils.isEmpty(sbTqdVo.getZ14())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中05桥梁上部砼强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，值14有误，请修改后重新上传");
                                        }
                                        if (!StringUtils.isNumeric(sbTqdVo.getZ15())|| StringUtils.isEmpty(sbTqdVo.getZ15())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中05桥梁上部砼强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，值15有误，请修改后重新上传");
                                        }
                                        if (!StringUtils.isNumeric(sbTqdVo.getZ16())|| StringUtils.isEmpty(sbTqdVo.getZ16())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中05桥梁上部砼强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，值16有误，请修改后重新上传");
                                        }
                                        if (StringUtils.isEmpty(sbTqdVo.getHtjd())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中05桥梁上部砼强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，回弹角度值是空的，请修改后重新上传");
                                        }
                                        if (StringUtils.isEmpty(sbTqdVo.getJzm())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中05桥梁上部砼强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，浇筑面值是空的，请修改后重新上传");
                                        }
                                        if (StringUtils.isEmpty(sbTqdVo.getThsd())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中05桥梁上部砼强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，碳化深度值是空的，请修改后重新上传");
                                        }
                                        if (StringUtils.isEmpty(sbTqdVo.getSfbs())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中05桥梁上部砼强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，是否泵送值是空的，请修改后重新上传");
                                        }
                                        if (StringUtils.isEmpty(sbTqdVo.getSjqd()) || sbTqdVo.getSjqd().contains("C")) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中05桥梁上部砼强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，设计强度值有误（为空或者有C字样），请修改后重新上传");
                                        }
                                        ...
                                        fbgcQlgcSbTqd.setUserid(commonInfoVo.getUserid());
            ...
            throw new JjgysException(20001,"您上传的"+htd+"合同段中05桥梁上部砼强度实测数据.xlsx文件，解析excel出错，请传入正确格式的excel");
        }catch (NullPointerException e) {
            throw new JjgysException(20001,"您上传的"+htd+"合同段中05桥梁上部砼强度实测数据.xlsx文件，请检查数据的正确性或删除文件最后的空数据，然后重新上传");
        }catch (ExcelAnalysisException e) {
            throw new JjgysException(20001,"您上传的"+htd+"合同段中05桥梁上部砼强度实测数据.xlsx文件，请将检测日期修改为2021/01/01的格式，然后重新上传");
        }
    ...
    @Override
    public int createMoreRecords(List<JjgFbgcQlgcSbTqd> data, String userID) {
        return ReceiveUtils.createMore(data, jjgFbgcQlgcSbTqdMapper, userID);
    }
}
