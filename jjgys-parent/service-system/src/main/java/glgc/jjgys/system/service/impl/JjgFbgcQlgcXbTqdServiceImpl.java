...
public class JjgFbgcQlgcXbTqdServiceImpl extends ServiceImpl<JjgFbgcQlgcXbTqdMapper, JjgFbgcQlgcXbTqd> implements JjgFbgcQlgcXbTqdService {
    ...
    public void importqlxbtqd(MultipartFile file, CommonInfoVo commonInfoVo) {
        ...
        try {
                                ...
                                public void handle(List<JjgFbgcQlgcXbTqdVo> dataList) {
                                    ...
                                    for(JjgFbgcQlgcXbTqdVo xbTqdVo: dataList)
                                    {
                                        if (StringUtils.isEmpty(xbTqdVo.getQlmc())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中01桥梁下部墩台砼强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，桥梁名称为空，请修改后重新上传");
                                        }
                                        if (StringUtils.isEmpty(xbTqdVo.getBw1())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中01桥梁下部墩台砼强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，部位1值为空，请修改后重新上传");
                                        }
                                        if (StringUtils.isEmpty(xbTqdVo.getBw2())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中01桥梁下部墩台砼强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，部位2值为空，请修改后重新上传");
                                        }
                                        if (!StringUtils.isNumeric(xbTqdVo.getCdz1()) || StringUtils.isEmpty(xbTqdVo.getCdz1())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中01桥梁下部墩台砼强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，测定值1值有误，请修改后重新上传");
                                        }
                                        if (!StringUtils.isNumeric(xbTqdVo.getZ2()) || StringUtils.isEmpty(xbTqdVo.getZ2())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中01桥梁下部墩台砼强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，值2有误，请修改后重新上传");
                                        }
                                        if (!StringUtils.isNumeric(xbTqdVo.getZ3()) || StringUtils.isEmpty(xbTqdVo.getZ3())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中01桥梁下部墩台砼强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，值3有误，请修改后重新上传");
                                        }
                                        if (!StringUtils.isNumeric(xbTqdVo.getZ4()) || StringUtils.isEmpty(xbTqdVo.getZ4())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中01桥梁下部墩台砼强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，值4有误，请修改后重新上传");
                                        }
                                        if (!StringUtils.isNumeric(xbTqdVo.getZ5()) || StringUtils.isEmpty(xbTqdVo.getZ5())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中01桥梁下部墩台砼强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，值5有误，请修改后重新上传");
                                        }
                                        if (!StringUtils.isNumeric(xbTqdVo.getZ6())|| StringUtils.isEmpty(xbTqdVo.getZ6())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中01桥梁下部墩台砼强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，值6有误，请修改后重新上传");
                                        }
                                        if (!StringUtils.isNumeric(xbTqdVo.getZ7())|| StringUtils.isEmpty(xbTqdVo.getZ7())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中01桥梁下部墩台砼强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，值7有误，请修改后重新上传");
                                        }
                                        if (!StringUtils.isNumeric(xbTqdVo.getZ8())|| StringUtils.isEmpty(xbTqdVo.getZ8())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中01桥梁下部墩台砼强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，值8有误，请修改后重新上传");
                                        }
                                        if (!StringUtils.isNumeric(xbTqdVo.getZ9())|| StringUtils.isEmpty(xbTqdVo.getZ9())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中01桥梁下部墩台砼强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，值9有误，请修改后重新上传");
                                        }
                                        if (!StringUtils.isNumeric(xbTqdVo.getZ10()) || StringUtils.isEmpty(xbTqdVo.getZ10())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中01桥梁下部墩台砼强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，值10有误，请修改后重新上传");
                                        }
                                        if (!StringUtils.isNumeric(xbTqdVo.getZ11()) || StringUtils.isEmpty(xbTqdVo.getZ11())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中01桥梁下部墩台砼强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，值11有误，请修改后重新上传");
                                        }
                                        if (!StringUtils.isNumeric(xbTqdVo.getZ12()) || StringUtils.isEmpty(xbTqdVo.getZ12())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中01桥梁下部墩台砼强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，值12有误，请修改后重新上传");
                                        }
                                        if (!StringUtils.isNumeric(xbTqdVo.getZ13())|| StringUtils.isEmpty(xbTqdVo.getZ13())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中01桥梁下部墩台砼强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，值13有误，请修改后重新上传");
                                        }
                                        if (!StringUtils.isNumeric(xbTqdVo.getZ14()) || StringUtils.isEmpty(xbTqdVo.getZ14())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中01桥梁下部墩台砼强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，值14有误，请修改后重新上传");
                                        }
                                        if (!StringUtils.isNumeric(xbTqdVo.getZ15())|| StringUtils.isEmpty(xbTqdVo.getZ15())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中01桥梁下部墩台砼强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，值15有误，请修改后重新上传");
                                        }
                                        if (!StringUtils.isNumeric(xbTqdVo.getZ16())|| StringUtils.isEmpty(xbTqdVo.getZ16())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中01桥梁下部墩台砼强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，值16有误，请修改后重新上传");
                                        }
                                        if (StringUtils.isEmpty(xbTqdVo.getHtjd())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中01桥梁下部墩台砼强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，回弹角度值是空的，请修改后重新上传");
                                        }
                                        if (StringUtils.isEmpty(xbTqdVo.getJzm())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中01桥梁下部墩台砼强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，浇筑面值是空的，请修改后重新上传");
                                        }
                                        if (StringUtils.isEmpty(xbTqdVo.getThsd())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中01桥梁下部墩台砼强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，碳化深度值是空的，请修改后重新上传");
                                        }
                                        if (StringUtils.isEmpty(xbTqdVo.getSfbs())) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中01桥梁下部墩台砼强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，是否泵送值是空的，请修改后重新上传");
                                        }
                                        if (StringUtils.isEmpty(xbTqdVo.getSjqd()) || xbTqdVo.getSjqd().contains("C")) {
                                            throw new JjgysException(20001, "您上传的"+htd+"合同段中01桥梁下部墩台砼强度实测数据.xlsx文件，第"+rowNumber+"行的数据中，设计强度值有误（为空或者有C字样），请修改后重新上传");
                                        }
                                        ...
                                        fbgcQlgcXbTqd.setUserid(commonInfoVo.getUserid());
            ...
            throw new JjgysException(20001,"您上传的"+htd+"合同段中01桥梁下部墩台砼强度实测数据.xlsx文件，第解析excel出错，请传入正确格式的excel");
        }catch (NullPointerException e) {
            throw new JjgysException(20001,"您上传的"+htd+"合同段中01桥梁下部墩台砼强度实测数据.xlsx文件，第请检查数据的正确性或删除文件最后的空数据，然后重新上传");
        }catch (ExcelAnalysisException e) {
            throw new JjgysException(20001,"您上传的"+htd+"合同段中01桥梁下部墩台砼强度实测数据.xlsx文件，第请将检测日期修改为2021/01/01的格式，然后重新上传");
        }
    ...
    public void exportqlxbtqd(HttpServletResponse response) {
        ...
        try {
            ...
            File t = new File(courseFile+File.separator+"01桥梁下部墩台砼强度实测数据.xlsx");
            if (t.exists()){
                t.delete();
            }
        }
                ...
                while (rowIterator.hasNext()) {
                    ...
                    if (rowNum > 4 && row !=null) {
                        ...
                        if (cell0 != null && cell34 != null) {
                            ...
                            if (!cellValue0.isEmpty() && !cellValue34.isEmpty() && !cellValue34.equals("0")) {
                                Map map = new HashMap();
    ...
    public List<Map<String, Object>> getqlname(String proname, String htd) {
        List<Map<String, Object>> list = jjgFbgcQlgcXbTqdMapper.getqlName(proname,htd);
        return list;
    }

    @Override
    public int createMoreRecords(List<JjgFbgcQlgcXbTqd> data, String userID) {
        return ReceiveUtils.createMore(data, jjgFbgcQlgcXbTqdMapper, userID);
    }
}
