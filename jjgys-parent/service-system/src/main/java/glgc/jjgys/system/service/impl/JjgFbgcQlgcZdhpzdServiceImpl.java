...
public class JjgFbgcQlgcZdhpzdServiceImpl extends ServiceImpl<JjgFbgcQlgcZdhpzdMapper, JjgFbgcQlgcZdhpzd> implements JjgFbgcQlgcZdhpzdService {
    ...
    public void importpzd(MultipartFile file, CommonInfoVo commonInfoVo) throws IOException {
        ...
        for (int i = 0; i < number; i++) {
            ...
            try {
                ...
                throw new JjgysException(20001,"您上传的"+htd+"合同段中平整度实测数据.xlsx文件，解析excel出错，请传入正确格式的excel");
            }catch (NullPointerException e) {
                throw new JjgysException(20001,"您上传的"+htd+"合同段中平整度实测数据.xlsx文件，请检查数据的正确性或删除文件最后的空数据，然后重新上传");
            }catch (ExcelAnalysisException e) {
                throw new JjgysException(20001,"您上传的"+htd+"合同段中平整度实测数据.xlsx文件，请将检测日期修改为2021/01/01的格式，然后重新上传");
            }
        }
    ...
    public List<Map<String, Object>> lookJdbjgPage(CommonInfoVo commonInfoVo) throws IOException {
        ...
        List<Map<String,Object>> lxlist = jjgFbgcQlgcZdhpzdMapper.selectlxid(proname,htd,idlist);
        if (lxlist.size()>0){
            for (Map<String, Object> map : lxlist) {
                String zx = map.get("qlname").toString();
                int num = jjgFbgcQlgcZdhpzdMapper.selectcdnumid(proname,htd,zx,idlist);
    ...
    private void handlezxData(String proname, String htd, String zx, int cdsl, String sjz, List<Long> idlist) throws IOException, ParseException {
        ...
        List<Map<String,Object>> datazf = jjgFbgcQlgcZdhpzdMapper.selectzfListyh(proname,htd,zx,result,idlist);
        List<Map<String,Object>> datayf = jjgFbgcQlgcZdhpzdMapper.selectyfListyh(proname,htd,zx,result,idlist);
    ...
    private void writeExcelData(String proname, String htd, List<Map<String, Object>> lmzfList, List<Map<String, Object>> lmyfList, int cdsl, String sjz, String zx) throws IOException, ParseException {
        ...
        try {
            ...
            if (lmzfList.size()>0 && !lmzfList.isEmpty()){
                ...
                /*String lxbs = mapslist.get(0).get("name").toString();
    ...
    private List<Map<String, Object>> mergedList(List<Map<String, Object>> dataLists,int cds) {
        ...
        Collections.sort(dataLists, new Comparator<Map<String, Object>>() {
            @Override
            public int compare(Map<String, Object> o1, Map<String, Object> o2) {
                /*String name1 = o1.get("qlname").toString();
                String name2 = o2.get("qlname").toString();
                // 按照名字进行排序
    ...
    private List<Map<String, Object>> groupadd(List<Map<String, Object>> dataList,int cdsl) {
        ...
        for (Map<String, Object> data : dataList) {
            String name = (String) data.get("qlname");
