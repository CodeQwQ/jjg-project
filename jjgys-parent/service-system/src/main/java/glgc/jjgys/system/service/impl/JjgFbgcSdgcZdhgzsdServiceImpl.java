...
public class JjgFbgcSdgcZdhgzsdServiceImpl extends ServiceImpl<JjgFbgcSdgcZdhgzsdMapper, JjgFbgcSdgcZdhgzsd> implements JjgFbgcSdgcZdhgzsdService {
    ...
    public boolean generateJdb(CommonInfoVo commonInfoVo) throws IOException, ParseException {
        ...
        List<Map<String,Object>> lxlist = jjgFbgcSdgcZdhgzsdMapper.selectlxid(proname,htd,idlist);
        if (lxlist.size()>0){
            for (Map<String, Object> map : lxlist) {
                String zx = map.get("lxbs").toString();
                int num = jjgFbgcSdgcZdhgzsdMapper.selectcdnumid(proname,htd,zx,idlist);
                int cds = 0;
                if (num == 1){
                    cds = 2;
                }else {
    ...
    private void handlezxData(String proname, String htd, String zx, int cdsl, String sjz, List<Long> idlist) throws IOException, ParseException {
         ...
         */
        List<Map<String, Object>> datazf = jjgFbgcSdgcZdhgzsdMapper.selectzfListyh(proname, htd,zx,idlist);
        List<Map<String, Object>> datayf = jjgFbgcSdgcZdhgzsdMapper.selectyfListyh(proname, htd,zx,idlist);
    ...
    private void writeExcelData(String proname, String htd, List<Map<String, Object>> sdzxList, List<Map<String, Object>> sdyxList, int cdsl, String sjz, String zx) throws IOException, ParseException {
        ...
        String fname="51隧道路面构造深度-"+zx+".xlsx";;
    ...
    private List<Map<String, Object>> lookdata(String proname, String htd, String zx, int cds) throws IOException {
        ...
        File f = new File(filepath + File.separator + proname + File.separator + htd + File.separator + "51隧道路面构造深度-"+zx+".xlsx");
        if (!f.exists()) {
            return new ArrayList<>();
        } else {
    ...
    public void exportgzsd(HttpServletResponse response, String cdsl) throws IOException {
        ...
        try {
            ...
            File t = new File(courseFile+File.separator+"隧道构造深度实测数据.xlsx");
            if (t.exists()){
                t.delete();
            }
        }
