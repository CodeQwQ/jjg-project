...
public class JjgFbgcSdgcZdhpzdServiceImpl extends ServiceImpl<JjgFbgcSdgcZdhpzdMapper, JjgFbgcSdgcZdhpzd> implements JjgFbgcSdgcZdhpzdService {
    ...
    public boolean generateJdb(CommonInfoVo commonInfoVo) throws IOException, ParseException {
        ...
        List<Map<String,Object>> lxlist = jjgFbgcSdgcZdhpzdMapper.selectlxid(proname,htd,idlist);
        if (lxlist.size()>0){
            for (Map<String, Object> map : lxlist) {
                String zx = map.get("lxbs").toString();
                int num = jjgFbgcSdgcZdhpzdMapper.selectcdnumid(proname,htd,zx,idlist);
                int cds = 0;
                if (num == 1){
                    cds = 2;
                }else {
    ...
    private void handlezxData(String proname, String htd, String zx, int cdsl, String sjz, List<Long> idlist) throws IOException, ParseException {
        ...
        List<Map<String, Object>> sdzxList = jjgFbgcSdgcZdhpzdMapper.selectzfListyh(proname, htd,zx, result,idlist);
        List<Map<String, Object>> sdyxList = jjgFbgcSdgcZdhpzdMapper.selectyfListyh(proname, htd,zx, result,idlist);
