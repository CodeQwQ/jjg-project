...
public class JjgFbgcSdgcZtkdServiceImpl extends ServiceImpl<JjgFbgcSdgcZtkdMapper, JjgFbgcSdgcZtkd> implements JjgFbgcSdgcZtkdService {
    ...
    public boolean generateJdb(CommonInfoVo commonInfoVo) throws IOException, ParseException {
        ...
        if (data == null || data.size()==0){
            ...
            try {
                ...
                InputStream inputStream = getClass().getClassLoader().getResourceAsStream("static/隧道总体宽度.xlsx");
     ...
     * @return
     */
    private int gettableNum(List<JjgFbgcSdgcZtkd> data) {
        Map<String, Integer> resultMap = new HashMap<>();
        for (JjgFbgcSdgcZtkd map : data) {
    ...
    public void exportsdztkd(HttpServletResponse response) {
        ...
        try {
            ...
            File t = new File(courseFile+File.separator+"04隧道总体宽度实测数据.xlsx");
            if (t.exists()){
                t.delete();
            }
        }
                            ...
                            new ExcelHandler<JjgFbgcSdgcZtkdVo>(JjgFbgcSdgcZtkdVo.class) {
                                ...
                                public void handle(List<JjgFbgcSdgcZtkdVo> dataList) {
                                    ...
                                    for(JjgFbgcSdgcZtkdVo ztkdVo: dataList)
                                    {
                                        ...
                                        if (StringUtils.isEmpty(ztkdVo.getSjz()) || !StringUtils.isNumeric(ztkdVo.getSjz())) {
                                        ...
                                        fbgcSdgcZtkd.setUserid(commonInfoVo.getUserid());
    ...
    public List<Map<String, Object>> getsdnum(String proname, String htd) {
        List<Map<String,Object>> list = jjgFbgcSdgcZtkdMapper.getsdnum(proname,htd);
        return list;
    }
    ...
    @Override
    public int createMoreRecords(List<JjgFbgcSdgcZtkd> data, String userID) {
        return ReceiveUtils.createMore(data, jjgFbgcSdgcZtkdMapper, userID);
    }
}
