...
public class JjgHtdServiceImpl extends ServiceImpl<JjgHtdMapper, JjgHtd> implements JjgHtdService {
    ...
    public boolean addhtd(JjgHtd jjgHtd) {
        ...
        if ("".equals(scid) || scid == null){
            ...
            scSysMenu.setCompanyId(jjgHtd.getCompanyId());
       ...
       String scid2 =  jjgHtdMapper.selectscDataId(jjgHtd.getProname());
        ...
        htdSysMenu.setCompanyId(jjgHtd.getCompanyId());
        ...
        for (String s : lx) {
            ...
            fbgcSysMenu.setCompanyId(jjgHtd.getCompanyId());
            if(s.equals("路基工程")){
    ...
    public void exporthtd(HttpServletResponse response, String workpath, String proname, String[] htd) {
        ...
        JjgFbgcUtils.createDirectory(proname+"实测数据模板文件",workpath);
    ...
    @Override
    public boolean generateJdb(CommonInfoVo commonInfoVo, String[] htds) throws Exception {
        if (htds.length > 0) {
            for (String htd : htds) {
                commonInfoVo.setHtd(htd);
    ...
    @Override
    public boolean generateZip(String proname, String[] htds, String userid) {
            ...
            for (String lx : lxs) {
                switch (lx) {
                    ...
                    case "路面工程":
                        ...
                        break;
                    case "桥梁工程":
                        jjgFbgcQlgcService.getFile(workpath,proname,htd,idlist);
                        break;
                    case "隧道工程":
                        jjgFbgcSdgcService.getFile(workpath,proname, htd,idlist);
                        break;
                    case "交安工程":
