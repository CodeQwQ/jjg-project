...
public class JjgZdhGzsdJgfcServiceImpl extends ServiceImpl<JjgZdhGzsdJgfcMapper, JjgZdhGzsdJgfc> implements JjgZdhGzsdJgfcService {
    ...
    private void handlezxData(String proname, String htd, String zx, int cdsl, String sjz) throws IOException, ParseException {
        ...
        if (zx.equals("主线")){
             ...
             */
            List<Map<String,Object>> datazf = jjgZdhGzsdJgfcMapper.selectzfListyh(proname,htd,zx);
            List<Map<String,Object>> datayf = jjgZdhGzsdJgfcMapper.selectyfListyh(proname,htd,zx);
            ...
            if (jjgLqsSdzf.size()>0){
                for (JjgLqsJgSd jjgLqsSd : jjgLqsSdzf) {
                    ...
                    hpsdzfdata.addAll(jjgZdhGzsdJgfcMapper.selectSdZfDatayh(proname,htd,zx,zhq,zhz));
                }
            }
            ...
            if (jjgLqsSdyf.size()>0){
                for (JjgLqsJgSd jjgLqsSd : jjgLqsSdyf) {
                    String zhq = String.valueOf(jjgLqsSd.getZhq());
                    String zhz = String.valueOf(jjgLqsSd.getZhz());
                    hpsdyfdata.addAll(jjgZdhGzsdJgfcMapper.selectSdyfDatayh(proname,htd,zx,zhq,zhz));
                }
            }
            ...
            if (jjgLqsQlzf.size()>0){
                for (JjgLqsJgQl jjgLqsQl : jjgLqsQlzf) {
                    ...
                    hpqlzfdata.addAll(jjgZdhGzsdJgfcMapper.selectQlZfDatayh(proname,htd,zx,zhq,zhz));
                }
            }
            ...
            if (jjgLqsQlyf.size()>0){
                for (JjgLqsJgQl jjgLqsQl : jjgLqsQlyf) {
                    String zhq = String.valueOf(jjgLqsQl.getZhq());
                    String zhz = String.valueOf(jjgLqsQl.getZhz());
                    hpqlyfdata.addAll(jjgZdhGzsdJgfcMapper.selectQlYfDatayh(proname,htd,zx,zhq,zhz));
                }
            }
            ...
            //查询的是摩擦系数表中的连接线
            List<Map<String,Object>> dataljxzf = jjgZdhGzsdJgfcMapper.selectzfListyh(proname,htd,zx);
            List<Map<String,Object>> dataljxyf = jjgZdhGzsdJgfcMapper.selectyfListyh(proname,htd,zx);
            //连接线
                ...
                for (JjgLqsJgLjx jjgLjx : jjgLjxList) {
                    ...
                    if (jjgLqssd != null){
                        for (JjgLqsJgSd jjgLqsSd : jjgLqssd) {
                            ...
                            sdmcxs.addAll(jjgZdhGzsdJgfcMapper.selectsdgzsdyhx(proname,lf,wz,sdzhq,sdz,sdname,zhq1,zhz1));
                        }
                    }
                    ...
                    if (jjgLqsql != null){
                        for (JjgLqsJgQl jjgLqsQl : jjgLqsql) {
                            ...
                            qlmcxs.addAll(jjgZdhGzsdJgfcMapper.selectqlgzsdyhx(proname,lf,wz, qlzhq, qlzhz, qlname, zhq1, zhz1));
            ...
            //匝道
            List<Map<String,Object>> datazdzf = jjgZdhGzsdJgfcMapper.selectzfListyh(proname,htd,zx);
            List<Map<String,Object>> datazdyf = jjgZdhGzsdJgfcMapper.selectyfListyh(proname,htd,zx);
                ...
                for (JjgLqsJgHntlmzd jjgLqsHntlmzd : zdList) {
                    ...
                    if (jjgLqssd != null){
                        for (JjgLqsJgSd jjgLqsSd : jjgLqssd) {
                            ...
                            String zhq1 = String.valueOf((jjgLqsSd.getZhq()));
                            String zhz1 = String.valueOf((jjgLqsSd.getZhz()));
                            sdmcxs.addAll(jjgZdhGzsdJgfcMapper.selectsdgzsdyh(proname,bz,lf,sdzhq,sdz,zx,zhq1,zhz1));
                        }
                    }
                    ...
                    if (jjgLqsql != null){
                        for (JjgLqsJgQl jjgLqsQl : jjgLqsql) {
                            ...
                            String zhq1 = String.valueOf(jjgLqsQl.getZhq());
                            String zhz1 = String.valueOf(jjgLqsQl.getZhz());
                            qlmcxs.addAll(jjgZdhGzsdJgfcMapper.selectqlgzsdyh(proname,bz,lf, qlzhq, qlzhz, zx, zhq1, zhz1));
                ...
                if (!f.exists()) {
                    ...
                    for (int j = 0; j < wb.getNumberOfSheets(); j++) {
                        if (!wb.isSheetHidden(wb.getSheetIndex(wb.getSheetAt(j)))) {
                            ...
                            slSheet.getRow(0).getCell(c).setCellType(CellType.STRING);
    ...
    private List<Map<String, Object>> lookjdb(String proname, String htd, String zx,int cds) throws IOException {
        ...
        if (zx.equals("主线")){
            ...
            f = new File(jgfilepath + File.separator + proname + File.separator + htd + File.separator + "63互通构造深度-"+zx+".xlsx");
        }
        if (!f.exists()) {
            return new ArrayList<>();
        } else {
            ...
            for (int j = 0; j < wb.getNumberOfSheets(); j++) {
                if (!wb.isSheetHidden(wb.getSheetIndex(wb.getSheetAt(j)))) {
                    ...
                    if (proname.equals(xmname.toString()) && htd.equals(htdname.toString())) {
                        ...
                        slSheet.getRow(0).getCell(4*cds+8).setCellType(CellType.STRING);//min
                        ...
                        map.put("pjz", slSheet.getRow(0).getCell(4*cds+8).getStringCellValue());
                        jgmap.add(map);
                    }
