...
public class JjgZdhLdhdServiceImpl extends ServiceImpl<JjgZdhLdhdMapper, JjgZdhLdhd> implements JjgZdhLdhdService {
    ...
    public boolean generateJdb(CommonInfoVo commonInfoVo) throws IOException, ParseException {
        ...
        List<Map<String,Object>> lxlist = jjgZdhLdhdMapper.selectlxid(proname,htd,idlist);
        if (lxlist.size()>0){
            for (Map<String, Object> map : lxlist) {
                String zx = map.get("lxbs").toString();
                int num = jjgZdhLdhdMapper.selectcdnumid(proname,htd,zx,idlist);
                int n = 0;
                if (num == 1){
                    n=2;
                }else {
                ...
                handlezxData(proname,htd,zx,n,commonInfoVo,idlist,num);
            }
            return true;
        }else {
            return false;
     ...
     * @param idlist
     */
    private void handlezxData(String proname, String htd, String zx, int cdsl, CommonInfoVo commonInfoVo, List<Long> idlist,int num) throws IOException, ParseException {
        String[] arr = null;
        if (cdsl == 2) {
        ...
        if (zx.equals("主线")){
            List<Map<String,Object>> datazf = jjgZdhLdhdMapper.selectzfListyh(proname,htd,zx,result,idlist);
            List<Map<String,Object>> datayf = jjgZdhLdhdMapper.selectyfListyh(proname,htd,zx,result,idlist);
            ...
            String zfzhq = jjgHtd.getZhq();
            String zfzhz = jjgHtd.getZhz();

            String yfzhq = jjgHtd.getYfzhq();
            String yfzhz = jjgHtd.getYfzhz();
            ...
            List<JjgLqsSd> jjgLqsSdzf = jjgLqsSdMapper.selectsdzf(proname,zfzhq,zfzhz,"左幅");
            List<JjgLqsSd> jjgLqsSdyf = jjgLqsSdMapper.selectsdyf(proname,yfzhq,yfzhz,"右幅");

            List<JjgLqsQl> jjgLqsQlzf = jjgLqsQlMapper.selectqlzf(proname,zfzhq,zfzhz,"左幅");
            List<JjgLqsQl> jjgLqsQlyf = jjgLqsQlMapper.selectqlyf(proname,yfzhq,yfzhz,"右幅");
            ...
            if (jjgLqsSdzf.size()>0){
                for (JjgLqsSd jjgLqsSd : jjgLqsSdzf) {
                    ...
                    hpsdzfdata.addAll(jjgZdhLdhdMapper.selectSdZfDatayh(proname,htd,zhq,zhz,result,idlist));
                }
            }
            if (jjgLqsSdyf.size()>0){
                for (JjgLqsSd jjgLqsSd : jjgLqsSdyf) {
                    String zhq = String.valueOf(jjgLqsSd.getZhq());
                    String zhz = String.valueOf(jjgLqsSd.getZhz());
                    hpsdyfdata.addAll(jjgZdhLdhdMapper.selectSdyfDatayh(proname,htd,zhq,zhz,result,idlist));
                }
            }
            if (jjgLqsQlzf.size()>0){
                for (JjgLqsQl jjgLqsQl : jjgLqsQlzf) {
                    ...
                    hpqlzfdata.addAll(jjgZdhLdhdMapper.selectQlZfDatayh(proname,htd,zhq,zhz,result,idlist));
                }
            }
            if (jjgLqsQlyf.size()>0){
                for (JjgLqsQl jjgLqsQl : jjgLqsQlyf) {
                    String zhq = String.valueOf(jjgLqsQl.getZhq());
                    String zhz = String.valueOf(jjgLqsQl.getZhz());
                    hpqlyfdata.addAll(jjgZdhLdhdMapper.selectQlYfDatayh(proname,htd,zhq,zhz,result,idlist));
                }
            }
            if (jjgLqsFhlmzf.size()>0){
                for (JjgLqsFhlm jjgLqsFhlm : jjgLqsFhlmzf) {
                    ...
                    flmzfdata.addAll(jjgZdhLdhdMapper.seletcfhlmzfDatayh(proname,htd,zhq,zhz,idlist));
                }
            }
            if (jjgLqsFhlmyf.size()>0){
                for (JjgLqsFhlm jjgLqsFhlm : jjgLqsFhlmyf) {
                    String zhq = String.valueOf(jjgLqsFhlm.getZhq());
                    String zhz = String.valueOf(jjgLqsFhlm.getZhz());
                    flmyfdata.addAll(jjgZdhLdhdMapper.seletcfhlmyfDatayh(proname,htd,zhq,zhz,idlist));
                }
            }
            ...
            List<Map<String,Object>> dataljxzf = jjgZdhLdhdMapper.selectzfListyh(proname,htd,zx,result,idlist);
            List<Map<String,Object>> dataljxyf = jjgZdhLdhdMapper.selectyfListyh(proname,htd,zx,result,idlist);
            ...
            if (jjgLjxList != null){
                for (JjgLjx jjgLjx : jjgLjxList) {
                    ...
                    List<JjgLqsSd> jjgLqssd = jjgLqsSdMapper.selectsdListx(proname,zhq,zhz,wz,ljxlf);
                    //有可能是单幅，有可能是左右幅都有
                    if (jjgLqssd != null){
                        for (JjgLqsSd jjgLqsSd : jjgLqssd) {
                            ...
                            //sdldhd.addAll(jjgZdhLdhdMapper.selectsdldhdyh(proname,bz,lf,zx,sdzhq,sdzhz,idlist));
                            sdldhd.addAll(jjgZdhLdhdMapper.selectsdldhdyhx(proname,lf,wz,sdzhq,sdzhz,sdname,idlist));
                        }
                    }

                    //List<JjgLqsQl> jjgLqsql = jjgLqsQlMapper.selectqlList(proname,zhq,zhz,bz,wz,ljxlf);
                    List<JjgLqsQl> jjgLqsql = jjgLqsQlMapper.selectqlListx(proname,zhq,zhz,wz,ljxlf);
                    if (jjgLqsql != null){
                        for (JjgLqsQl jjgLqsQl : jjgLqsql) {
                            ...
                            //qlldhd.addAll(jjgZdhLdhdMapper.selectqlldhdyh(proname,bz,lf,zx,qlzhq,qlzhz,idlist));
                            qlldhd.addAll(jjgZdhLdhdMapper.selectqlldhdyhx(proname,lf,wz,qlzhq,qlzhz,qlname,idlist));
            ...
            //匝道
            List<Map<String,Object>> datazdzf = jjgZdhLdhdMapper.selectzfListyh(proname,htd,zx,result,idlist);
            List<Map<String,Object>> datazdyf = jjgZdhLdhdMapper.selectyfListyh(proname,htd,zx,result,idlist);
                ...
                for (JjgLqsHntlmzd jjgLqsHntlmzd : zdList) {
                    ...
                    if (jjgLqssd != null){
                        for (JjgLqsSd jjgLqsSd : jjgLqssd) {
                            ...
                            sdldhd.addAll(jjgZdhLdhdMapper.selectsdldhdyh(proname,bz,lf,zx,sdzhq,sdzhz,result,idlist));
                        }
                    }
                    ...
                    if (jjgLqsql != null){
                        for (JjgLqsQl jjgLqsQl : jjgLqsql) {
                            ...
                            String qlzhq = String.valueOf(jjgLqsQl.getZhq());
                            String qlzhz = String.valueOf(jjgLqsQl.getZhz());
                            qlldhd.addAll(jjgZdhLdhdMapper.selectqlldhdyh(proname,bz,lf, zx, qlzhq, qlzhz,result,idlist));
                        }
                    }
            ...
            List<Map<String, Object>> qlzfsj = montageldzd(zfqlldhd,num);
            List<Map<String, Object>> qlyfsj = montageldzd(yfqlldhd,num);

            List<Map<String, Object>> sdzfsj = montageldzd(zfsdldhd,num);
            List<Map<String, Object>> sdyfsj = montageldzd(yfsdldhd,num);

            List<Map<String, Object>> fhlmzmontageld = montageldzd(flmzfdata,num);
            List<Map<String, Object>> fhlmymontageld = montageldzd(flmyfdata,num);

            List<Map<String, Object>> zdzfmontageld = montageldzd(datazdzf,num);
            List<Map<String, Object>> zdyfmontageld = montageldzd(datazdyf,num);

            //writeExcelData(proname,htd,zdzfmontageld,zdyfmontageld,qlzfsj,qlyfsj,sdzfsj,sdyfsj,fhlmzmontageld,fhlmymontageld,cdsl,zx,commonInfoVo);
            writeExcelData(proname,htd,zdzfmontageld,zdyfmontageld,sdzfsj,sdyfsj,qlzfsj,qlyfsj,fhlmzmontageld,fhlmymontageld,cdsl,zx,commonInfoVo);
    ...
    private void zdwriteExcelData(String proname, String htd, List<Map<String, Object>> zdzfList, List<Map<String, Object>> zdyfList, List<Map<String, Object>> sdList, List<Map<String, Object>> qlList, List<Map<String, Object>> fhlmz, List<Map<String, Object>> fhlmy, int cdsl, CommonInfoVo commonInfoVo, String zx) throws IOException, ParseException {
        ...
        if (sdList.size() >0 && !sdList.isEmpty()){
            ...
            DBtoExcel(proname,htd,sdList,wb,"匝道隧道",cdsl,commonInfoVo.getSdsjz(),zx);
        }
        ...
        if (qlList.size() >0 && !qlList.isEmpty()){
            ...
            DBtoExcel(proname,htd,qlList,wb,"匝道桥",cdsl,commonInfoVo.getQlsjz(),zx);
        }
    ...
    private void writeExcelData(String proname, String htd, List<Map<String, Object>> lmzfList, List<Map<String, Object>> lmyfList, List<Map<String, Object>> sdzxList, List<Map<String, Object>> sdyxList, List<Map<String, Object>> qlzxList, List<Map<String, Object>> qlyxList, List<Map<String, Object>> flmzxList, List<Map<String, Object>> flmyxList, int cdsl, String zx,CommonInfoVo commonInfoVo) throws IOException, ParseException {
        ...
        try {
            ...
            if (flmyxList.size()>0 && !flmyxList.isEmpty()){
                ...
                DBtoExcel(proname,htd,mapslist,wb,"复合路面右幅",cdsl,commonInfoVo.getYffhlmsjz(),zx);
            }
            ...
            if (lmzfList.size()>0 && !lmzfList.isEmpty()){
                if (zx.equals("主线") || zx.contains("连接线")){
                    ...
                    //匝道
                    DBtoExcelZDNew(proname,htd,lmzfList,sdqllmData,wb,"左幅",cdsl,commonInfoVo.getSjz(),zx);
                }
            ...
            if (lmyfList.size()>0 && !lmyfList.isEmpty()){
                if (zx.equals("主线") || zx.contains("连接线")){
                    DBtoExcelLM(proname,htd,lmyfList,sdqllmData,wb,"右幅",cdsl,commonInfoVo.getYfsjz(),zx);
                }else {
                    DBtoExcelZDNew(proname,htd,lmyfList,sdqllmData,wb,"右幅",cdsl,commonInfoVo.getYfsjz(),zx);
                }
            ...
            wb.setSheetHidden(wb.getSheetIndex("Sheet1"), HSSFWorkbook.SHEET_STATE_VERY_HIDDEN);
            FileOutputStream fileOut = new FileOutputStream(f);
            wb.write(fileOut);
            fileOut.flush();
            fileOut.close();
    ...
    private void calculateBridgeAndTunnelSheet(XSSFWorkbook wb,XSSFSheet sheet,int cdsl,String sjz){
        ...
        double value1 = e.evaluate(sheet.getRow(4).getCell(cdsl*3+7)).getNumberValue();
        sheet.getRow(4).getCell(cdsl*3+7).setCellFormula(null);
        sheet.getRow(4).getCell(cdsl*3+7).setCellValue(value1);

        /*BigDecimal row4value = new BigDecimal(e.evaluate(sheet.getRow(4).getCell(cdsl*3+7)).getNumberValue());
        sheet.getRow(4).getCell(cdsl*3+7).setCellFormula(null);
        sheet.getRow(4).getCell(cdsl*3+7).setCellValue(row4value.setScale(1, BigDecimal.ROUND_HALF_UP).doubleValue());*/


       /* double valueq = e.evaluate(sheet.getRow(4).getCell(cdsl*3+7)).getNumberValue();
        System.out.println(valueq);
        sheet.getRow(4).getCell(cdsl*3+7).setCellFormula(null);
        sheet.getRow(4).getCell(cdsl*3+7).setCellType(CellType.STRING);//总点数
        sheet.getRow(4).getCell(cdsl*3+7).setCellValue(String.valueOf(valueq));*/
        ...
        double valuea = e.evaluate(sheet.getRow(4).getCell(cdsl*3+8)).getNumberValue();
        sheet.getRow(4).getCell(cdsl*3+8).setCellFormula(null);
        sheet.getRow(4).getCell(cdsl*3+8).setCellValue(valuea);
        ...
        sheet.getRow(5).createCell(cdsl*3+7).setCellFormula(sheet.getRow(7).getCell(cdsl*2+4).getReference());
        ...
        sheet.getRow(5).createCell(cdsl*3+8).setCellFormula(sheet.getRow(8).getCell(cdsl*2+4).getReference());
        ...
        for (int i = 5; i <= sheet.getPhysicalNumberOfRows(); i++) {
            row = sheet.getRow(i);
            if (row == null || row.getCell(cdsl*3+7) == null || "".equals(row.getCell(cdsl*3+7).toString())) {
                continue;
            }
            zds += Double.valueOf(e.evaluate(row.getCell(cdsl*3+7)).getNumberValue()).intValue();
        }
        sheet.getRow(4).getCell(cdsl*3+7).setCellFormula(null);
        sheet.getRow(4).getCell(cdsl*3+7).setCellValue(zds);
    }
    ...
    private void fillBridgeAndTunnelTotal(XSSFWorkbook wb,XSSFSheet sheet, XSSFRow rowstart,XSSFRow rowend,int cdsl,String sjz) {
         ...
         */
            ...
            System.out.println(rowstart.getCell(2).getAddress()+":"+rowend.getCell(cdsl*2+1).getAddress()+"wq");
    ...
    private void calculatePavementSheet(XSSFWorkbook wb,XSSFSheet sheet,int cdsl){
        ...
        sheet.getRow(4).createCell(cdsl*3+4).setCellFormula("MAX("
                ...
                +sheet.getRow(sheet.getPhysicalNumberOfRows()-1).createCell(cdsl*3+4).getReference()+")");
        double value2 = e.evaluate(sheet.getRow(4).getCell(cdsl*3+4)).getNumberValue();
        sheet.getRow(4).getCell(cdsl*3+4).setCellFormula(null);
        sheet.getRow(4).getCell(cdsl*3+4).setCellValue(value2);

        sheet.getRow(4).createCell(cdsl*3+5).setCellFormula("MIN("
                +sheet.getRow(6).createCell(cdsl*3+5).getReference()+":"
                +sheet.getRow(sheet.getPhysicalNumberOfRows()-1).createCell(cdsl*3+5).getReference()+")");
        double value3 = e.evaluate(sheet.getRow(4).getCell(cdsl*3+5)).getNumberValue();
        sheet.getRow(4).getCell(cdsl*3+5).setCellFormula(null);
        sheet.getRow(4).getCell(cdsl*3+5).setCellValue(value3);
        ...
        double value = e.evaluate(sheet.getRow(4).getCell(cdsl*3+6)).getNumberValue();
        sheet.getRow(4).getCell(cdsl*3+6).setCellFormula(null);
        sheet.getRow(4).getCell(cdsl*3+6).setCellValue(value);
    ...
    public void fillPavementTotal(XSSFWorkbook wb,XSSFSheet sheet, XSSFRow rowstart, XSSFRow rowend,int cdsl){
        System.out.println(rowstart.getRowNum());
        System.out.println(rowend.getRowNum());
        /**cdsl*2+5
         * 2c 8
         * 3c 10
         * 4c 12
        ...
        sheet.getRow(rowend.getRowNum()-7).getCell(cdsl*2+4).setCellFormula("COUNT("
                +rowstart.getCell(1).getReference()+":"+rowend.getCell(cdsl).getReference()+","
                 ...
                 * 4c 9
                 */
                +rowstart.getCell(cdsl+2).getReference()+":" +rowend.getCell(cdsl*2+1).getReference()+","
                 ...
                 * 5c 17
                 */
                +rowstart.getCell(cdsl*2+3).getReference()+":"+sheet.getRow(rowend.getRowNum()-10).getCell(cdsl*3+2).getReference()+")");//I37=COUNT(B6:C44,E6:F44,H6:I27)
    ...
    private boolean shouldBeCalculate(XSSFSheet sheet) {
        ...
        if(sheet.getRow(5).getCell(0) == null || "".equals(sheet.getRow(5).getCell(0).getStringCellValue()) || "".equals(sheet.getRow(1).getCell(1).getStringCellValue())){
            return false;
        }
    ...
    private void DBtoExcelZd(String proname, String htd, List<Map<String, Object>> data, List<Map<String, Object>> sdqllmData, XSSFWorkbook wb, String sheetname, int cdsl, String sjz, String zx) throws ParseException {
        ...
        if (data!=null && !data.isEmpty()) {
            ...
            String zdbs = name+ lmdata.get(0).get("zdbs").toString();
                ...
                if (lm.get("zdbs").toString().equals(zdbs)) {
                    ...
                    if (!lm.get("ld").toString().equals("") && !lm.get("ld").toString().isEmpty()) {
                        ...
                        for (int i = 0; i < sfc.length; i++) {
                            System.out.println(lm.get("zdbs").toString());
    ...
    private void DBtoExcelZDNew(String proname, String htd, List<Map<String, Object>> data, List<Map<String, Object>> sdqllmData, XSSFWorkbook wb, String sheetname, int cdsl, String sjz, String zx) throws ParseException {
        SimpleDateFormat simpleDateFormat = new SimpleDateFormat("yyyy-MM-dd");
        SimpleDateFormat outputDateFormat  = new SimpleDateFormat("yyyy.MM.dd");
        if (data!=null && !data.isEmpty()) {
            int a = 0;
            ...
            List<Map<String, Object>> lmdata = handlezdData(proname,data,sdqllmData,zx);
            Collections.sort(lmdata, new Comparator<Map<String, Object>>() {
                @Override
            ...
            createTableLM(getNumZDNew(data,cdsl), wb, sheetname, cdsl);
            XSSFSheet sheet = wb.getSheet(sheetname);
            ...
            fillTitleCellDatazd(sheet, tableNum, proname, htd, zdbs,time,sheetname,cdsl,sjz);
    ...
    private List<Map<String,Object>> incrementByTen(double start, double end,String zdsfzname,String sszd) {
        ...
        if (start < end) {
            ...
            double roundedValue = customRounding(start);

//            /*int a = (int) start/10;
//
//            double s = (a*10)+10;*/
            for (double i = roundedValue; i < end; i += 10) {
                Map map = new HashMap();
                map.put("zh",i);
    ...
    public static double customRounding(double start) {
        // 获取个位数
        double decimalPart = start - Math.floor(start);
        double lastDigit = decimalPart * 10;
        ...
        // 根据个位数的大小决定向上取整还是向下取整
        if (lastDigit < 5) {
            return Math.floor(start); // 向下取整
        } else if (lastDigit > 5) {
            return Math.ceil(start); // 向上取整
        } else {
            // 如果个位数等于5，可以选择向上或向下取整，这里我们向下取整
    ...
    private int getNumZDNew(List<Map<String, Object>> data, int cdsl) {
        int a = 0;
        if (cdsl == 2 || cdsl == 3){
            a = 107;
        }else if (cdsl == 4){
    ...
    private void fillCommonCellData(XSSFSheet sheet, int tableNum, int index, Map<String, Object> row, int cdsl, String zx) {
        ...
        sheet.getRow(tableNum * b + 5 + index % b).getCell(0).setCellValue(row.get("name").toString());
        sheet.getRow(tableNum * b + 5+ index % b).getCell(1).setCellValue(Double.valueOf(row.get("zh").toString()));

        String[] sfc = row.get("ld").toString().split(",");
        if (!sfc[0].isEmpty()) {
            for (int i = 0 ; i < sfc.length ; i++) {
                if (!sfc[i].equals("-")){
                    sheet.getRow(tableNum * b+ 5 + index % b).getCell(2+i).setCellValue(Double.parseDouble(sfc[i]));
                }else {
                    sheet.getRow(tableNum * b + 5+ index % b).getCell(2+i).setCellValue("-");
                }
    ...
    private void fillTitleCellDatazd(XSSFSheet sheet, int tableNum, String proname, String htd, String zd, String sj, String sheetname, int cdsl, String sjz) {
        int a = 0;
        int dd = 0;
        ...
        sheet.getRow(tableNum * a + 2).getCell(1).setCellValue("路面面层("+zd+"匝道)");
     ...
     * @return
     */
    private static List<Map<String, Object>> montageldzd(List<Map<String, Object>> list, int num) {
        if (list == null || list.isEmpty()){
            return new ArrayList<>();
        }else {
            if (num == 1 ){
                for (Map<String, Object> map : list) {
                    if (map.containsKey("ld")){
                        String ziri = map.get("ld").toString()+",-";
                        map.put("ld",ziri);
                    }
                }
            }
    ...
    public List<Map<String, Object>> lookJdbjg(CommonInfoVo commonInfoVo) throws IOException {
        ...
        String htd = commonInfoVo.getHtd();
        List<Map<String, Object>> mapList = new ArrayList<>();
        // 选出类型的map[{lxbx:主线}, {lxbx: ...}, ...]
        List<Map<String,Object>> lxlist = jjgZdhLdhdMapper.selectlx(proname,htd);

        if (lxlist.size()>0){
            for (Map<String, Object> map : lxlist) {
                String zx = map.get("lxbs").toString(); // ...主线
                int num = jjgZdhLdhdMapper.selectcdnum(proname,htd,zx); // 该...主线有几种val值， 相当于有几车道
                int n = 0;
                if (num == 1){
                    n=2;
                }else {
        ...
        if (!f.exists()) {
            ...
            for (int j = 0; j < wb.getNumberOfSheets(); j++) {
                if (!wb.isSheetHidden(wb.getSheetIndex(wb.getSheetAt(j)))) {
                    int zc = 0; // 由于车道数不同，表格的宽度也不同，在第几列拿也不同，“总点数”和“合格数”用到
                    int dd = 0; // 表格中取数字的行，只有“设计值”用到了
                    int m = cds*3+4; // 拿最小值和最大值的列
                    ...
                    /*对于不同的sheet，需要做不同的处理
                            16雷达厚度
                            1. 主线左右幅、复合路面：直接拿最顶上的总数据
                            2. 桥、隧道： 没有了表头 ，每个表高25，去遍历
                            16雷达厚度-
                            1. 左右幅 直接拿总数据
                            2. 桥、隧道：遍历 ，表高不一样
                     */
                    if(wb.getSheetAt(j).getSheetName().equals("左幅") || wb.getSheetAt(j).getSheetName().equals("右幅") || wb.getSheetAt(j).getSheetName().contains("复合路面")) {
                        // 使用原来的代码，原来代码就是直接取值。最后map添加的时候添加多一个字段“工程名称”：“路面”
                        ...
                        if (proname.equals(xmname.toString()) && htd.equals(htdname.toString())) {
                            ...
                            slSheet.getRow(dd).getCell(cds*2+4).setCellType(CellType.STRING);

                            System.out.println(zx+":"+slSheet.getSheetName()+":"+slSheet.getRow(4).getCell(zc).getStringCellValue());
                    ...
                    // 区分开不同表高的文件， 16 和 16-的桥和隧道的表高不同，仅仅是表高不同看看能不能共用代码，能！
                    else if(wb.getSheetAt(j).getSheetName().equals("桥") || wb.getSheetAt(j).getSheetName().equals("隧道")){
                        int tableHeight = 0;// 表高
                        if(zx.equals("主线")) tableHeight = 23;
                        else tableHeight = 42;
                        // 竖向遍历每个sheet内的表格,表格高是固定的，前5行是基本信息，后面的每个表高为23
                        int index = 0;
                        // 16文件的 桥和隧道 的基本信息只有前5行有，因此不用循环遍历
                        XSSFCell xmname = slSheet.getRow(1).getCell(1);//项目名
                        XSSFCell htdname = slSheet.getRow(1).getCell(cds*2+3);//合同段名
                        XSSFCell gcmcname = slSheet.getRow(8+index*tableHeight).getCell(0);//工程名称。由于是合并单元格，所以在区间中的行号都可以。选8为了吉利

                        // 每次加入list<map>前都看看是不是相同的工程名称，如果是的话就先不加起来而不是new一个
                        // 初始化
                        double zds = 0;
                        double hgds = 0;
                        Map map = new HashMap();
                        while(true) {
                            // 跳出循环的条件该行为null或者拿到的单元格为空
                            XSSFRow row = slSheet.getRow(5 + index * tableHeight); // 由于前5行是基本信息，所以要取第六行
                            if (row == null || row.getCell(1).toString().isEmpty()) {// 第二列就是桩号信息
                                jgmap.add(map); // 把之前没有添加进去的map加上再break
                                break;
                            }

                            // 判断工程名称是否相同，如果不相同，就要把map加入list，再初始化一个map
                            if(!gcmcname.getStringCellValue().equals(slSheet.getRow(8+index*tableHeight).getCell(0).getStringCellValue())){
                                // 把上一个 map加入list，再初始化map 和 记录总点数的 变量
                                jgmap.add(map);
                                map = new HashMap();
                                zds = 0;
                                hgds = 0;
                                gcmcname = slSheet.getRow(8+index*tableHeight).getCell(0);
                            }

                            // 遍历处理每个纵向表
                            if (proname.equals(xmname.toString()) && htd.equals(htdname.toString())) {
                                // 给要取的单元格转换格式
                                slSheet.getRow(5 + index * tableHeight).getCell(zc).setCellType(CellType.STRING);//总点数
                                slSheet.getRow(5 + index * tableHeight).getCell(zc+1).setCellType(CellType.STRING);//合格点数
                                slSheet.getRow(4).getCell(m).setCellType(CellType.STRING); // 最大最小值
                                slSheet.getRow(4).getCell(m+1).setCellType(CellType.STRING);
                                slSheet.getRow(dd).getCell(cds*2+4).setCellType(CellType.STRING);//设计值，每个纵向表都是一样，所以直接取第一个表的
                                //System.out.println(zx+":"+slSheet.getSheetName()+":"+slSheet.getRow(4).getCell(zc).getStringCellValue());

                                // 取点，如果是相同的工程名称，就相加，不是就清空
                                zds += Double.valueOf(slSheet.getRow(5 + index * tableHeight).getCell(zc).getStringCellValue());
                                hgds += Double.valueOf(slSheet.getRow(5 + index * tableHeight).getCell(zc+1).getStringCellValue());
                                String zdsz1 = decf.format(zds);
                                String hgdsz1 = decf.format(hgds);
                                ...
                                map.put("检测项目", zx);
                                map.put("路面类型", wb.getSheetName(j));
                                map.put("工程名称", gcmcname.getStringCellValue());
                                map.put("总点数", zdsz1);
                                map.put("设计值", slSheet.getRow(dd).getCell(cds*2+4).getStringCellValue());
                                map.put("Max", slSheet.getRow(4).getCell(m).getStringCellValue());
                                map.put("Min", slSheet.getRow(4).getCell(m+1).getStringCellValue());
...
//                    }
    ...
    public void exportldhd(HttpServletResponse response, String cdsl) throws IOException {
        ...
        try {
            ...
            File t = new File(courseFile+File.separator+"雷达厚度实测数据.xlsx");
            if (t.exists()){
                t.delete();
            }
        }
                                ...
                                new ExcelHandler<JjgZdhLdhdVo>(JjgZdhLdhdVo.class) {
                                    ...
                                    public void handle(List<JjgZdhLdhdVo> dataList) {
                                        for(JjgZdhLdhdVo ldhdVo: dataList)
                                        {
                                            ...
                                            ldhd.setUserid(commonInfoVo.getUserid());
    ...
    @Override
    public List<Map<String, Object>> selectlx(String proname, String htd, String userid) {
        QueryWrapper<SysUser> wrapperuser = new QueryWrapper<>();
        wrapperuser.eq("id",userid);
        SysUser one = sysUserService.getOne(wrapperuser);
        String type = one.getType();
        ...
        List<Map<String, Object>> selectlx = jjgZdhLdhdMapper.selectlxid(proname, htd,idlist);
        return selectlx;
    }
