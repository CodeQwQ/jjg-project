...
public class JjgZdhMcxsJgfcServiceImpl extends ServiceImpl<JjgZdhMcxsJgfcMapper, JjgZdhMcxsJgfc> implements JjgZdhMcxsJgfcService {
    ...
    @Override
    public boolean generateJdb(JgCommonEntity jgCommon) throws IOException, ParseException {
    ...
    public List<Map<String, Object>> lookJdbjg(String proname) throws IOException {
        ...
        List<String> gethtd = jjgZdhMcxsJgfcMapper.gethtd(proname);
    ...
    private List<Map<String, Object>> lookjdb(String proname, String htd, String zx, int cds) throws IOException {
        ...
        if (zx.equals("主线")){
            ...
            f = new File(jgfilepath + File.separator + proname + File.separator + htd + File.separator + "62互通摩擦系数-"+zx+".xlsx");
        }
        if (!f.exists()) {
            return new ArrayList<>();
        } else {
            ...
            for (int j = 0; j < wb.getNumberOfSheets(); j++) {
                if (!wb.isSheetHidden(wb.getSheetIndex(wb.getSheetAt(j)))) {
                    ...
                    if (proname.equals(xmname.toString()) && htd.equals(htdname.toString())) {
                        ...
                        slSheet.getRow(1).getCell(zdscd+5).setCellType(CellType.STRING);//zdscd+4
                        ...
                        map.put("pjz", slSheet.getRow(1).getCell(zdscd+5).getStringCellValue());//zdscd+3
                        jgmap.add(map);
                    }
    ...
    private void handlezxData(String proname, String htd, String zx, int cdsl, String sjz) throws IOException, ParseException {
        if (zx.equals("主线")){
             ...
             */
            List<Map<String,Object>> datazf = jjgZdhMcxsJgfcMapper.selectzfListyh(proname,htd,zx);
            List<Map<String,Object>> datayf = jjgZdhMcxsJgfcMapper.selectyfListyh(proname,htd,zx);
            ...
            if (htdList != null){
                ...
                if (jjgLqsSdzf.size()>0){
                    for (JjgLqsJgSd jjgLqsSd : jjgLqsSdzf) {
                        ...
                        hpsdzfdata.addAll(jjgZdhMcxsJgfcMapper.selectSdZfDatayh(proname,htd,zhq,zhz,String.valueOf(jjgLqsSd.getZhq()),String.valueOf(jjgLqsSd.getZhz())));
                    }
                }
                ...
                if (jjgLqsSdyf.size()>0){
                    for (JjgLqsJgSd jjgLqsSd : jjgLqsSdyf) {
                        String zhq = String.valueOf(jjgLqsSd.getZhq());
                        String zhz = String.valueOf(jjgLqsSd.getZhz());
                        hpsdyfdata.addAll(jjgZdhMcxsJgfcMapper.selectSdyfDatayh(proname,htd,zhq,zhz,String.valueOf(jjgLqsSd.getZhq()),String.valueOf(jjgLqsSd.getZhz())));
                    }
                }
                ...
                if (jjgLqsQlzf.size()>0){
                    for (JjgLqsJgQl jjgLqsQl : jjgLqsQlzf) {
                        ...
                        hpqlzfdata.addAll(jjgZdhMcxsJgfcMapper.selectQlZfDatayh(proname,htd,zhq,zhz,String.valueOf(jjgLqsQl.getZhq()),String.valueOf(jjgLqsQl.getZhz())));
                    }
                }
                ...
                if (jjgLqsQlyf.size()>0){
                    for (JjgLqsJgQl jjgLqsQl : jjgLqsQlyf) {
                        String zhq = String.valueOf(jjgLqsQl.getZhq());
                        String zhz = String.valueOf(jjgLqsQl.getZhz());
                        hpqlyfdata.addAll(jjgZdhMcxsJgfcMapper.selectQlYfDatayh(proname,htd,zhq,zhz,String.valueOf(jjgLqsQl.getZhq()),String.valueOf(jjgLqsQl.getZhz())));
                    }
                }
            ...
            //查询的是摩擦系数表中的连接线
            List<Map<String,Object>> dataljxzf = jjgZdhMcxsJgfcMapper.selectzfListyh(proname,htd,zx);
            List<Map<String,Object>> dataljxyf = jjgZdhMcxsJgfcMapper.selectyfListyh(proname,htd,zx);
                ...
                for (JjgLqsJgLjx jjgLjx : jjgLjxList) {
                    ...
                    if (jjgLqssd!=null){
                        ...
                        for (JjgLqsJgSd jjgLqsSd : jjgLqssd) {
                            ...
                            sdmcxs.addAll(jjgZdhMcxsJgfcMapper.selectsdmcxsyh(proname,lf,wz,sdzhq,sdz,sdname,zhq1,zhz1));
                        }
                    }
                    ...
                    if (jjgLqsql!=null){
                        for (JjgLqsJgQl jjgLqsQl : jjgLqsql) {
                            ...
                            qlmcxs.addAll(jjgZdhMcxsJgfcMapper.selectqlmcxsyh(proname,lf,wz, qlzhq, qlzhz, qlname, zhq1, zhz1));
            ...
            //匝道
            List<Map<String,Object>> datazdzf = jjgZdhMcxsJgfcMapper.selectzfListyh(proname,htd,zx);
            List<Map<String,Object>> datazdyf = jjgZdhMcxsJgfcMapper.selectyfListyh(proname,htd,zx);
            ...
            if (zdList !=null){
                for (JjgLqsJgHntlmzd jjgLqsHntlmzd : zdList) {
                    ...
                    if (jjgLqssd != null && jjgLqssd.size()>0){
                        //有可能是单幅，有可能是左右幅都有
                        for (JjgLqsJgSd jjgLqsSd : jjgLqssd) {
                            String lf = jjgLqsSd.getLf();
                            Double sdq = jjgLqsSd.getZhq();
                            ...
                            String zhq1 = String.valueOf((jjgLqsSd.getZhq()));
                            String zhz1 = String.valueOf((jjgLqsSd.getZhz()));
                            sdmcxs.addAll(jjgZdhMcxsJgfcMapper.selectsdmcxsyh(proname,bz,lf,sdzhq,sdz,zx,zhq1,zhz1));
                        }
                    }

                    List<JjgLqsJgQl> jjgLqsql = jjgLqsJgQlMapper.selectqlList(proname,zhq,zhz,bz,wz,zdlf);
                    if (jjgLqsql != null && jjgLqsql.size()>0){
                        for (JjgLqsJgQl jjgLqsQl : jjgLqsql) {
                            String lf = jjgLqsQl.getLf();
                            Double qlq = jjgLqsQl.getZhq();
                            Double qlz = jjgLqsQl.getZhz();
                            ...
                            String zhq1 = String.valueOf(jjgLqsQl.getZhq());
                            String zhz1 = String.valueOf(jjgLqsQl.getZhz());
                            qlmcxs.addAll(jjgZdhMcxsJgfcMapper.selectqlmcxsyh(proname,bz,lf, qlzhq, qlzhz, zx, zhq1, zhz1));
