...
//        写入数据到通道
     ...
     * @param wb
     */
    public static void deletwcEmptySheets(XSSFWorkbook wb){
        ArrayList<String> delsheets = new ArrayList<String>();;
        for (int i = 0; i < wb.getNumberOfSheets(); i++) {
            if(wb.getSheetAt(i).getSheetName().contains("路面弯沉") && wb.getSheetAt(i).getRow(10) == null ){
    ...
    public static void hiddenSheets(XSSFWorkbook wb){
        ArrayList<String> delsheets = new ArrayList<String>();
        for (int i = 0; i < wb.getNumberOfSheets(); i++) {
            String sheetName = wb.getSheetAt(i).getSheetName();
            if (sheetName.equals("表4.1.4-3")){
                if ("".equals(wb.getSheet(sheetName).getRow(2).getCell(2).getStringCellValue())){
                    delsheets.add(wb.getSheetAt(i).getSheetName());
                }
            }else if (sheetName.equals("表4.1.1-6")|| sheetName.equals("表4.1.2-14") || sheetName.equals("表4.1.4-4")|| sheetName.equals("表4.1.5-5")){
                if ("".equals(wb.getSheet(sheetName).getRow(2).getCell(3).getStringCellValue())){
                    delsheets.add(wb.getSheetAt(i).getSheetName());
                }
            }else if (sheetName.equals("表4.1.2-10")  || sheetName.equals("表4.1.2-23") || sheetName.equals("表4.1.2-24")){
                if ("".equals(wb.getSheet(sheetName).getRow(2).getCell(4).getStringCellValue())){
                    delsheets.add(wb.getSheetAt(i).getSheetName());
                }
            } else {
                System.out.println(wb.getSheetName(i));
                if ("".equals(wb.getSheetAt(i).getRow(3).getCell(0).getStringCellValue())){
                    delsheets.add(wb.getSheetAt(i).getSheetName());
                }
                /*if (wb.getSheetAt(i).getRow(3) == null || wb.getSheetAt(i).getRow(3).getCell(0).getStringCellValue().equals("")) {
                    delsheets.add(wb.getSheetAt(i).getSheetName());
    ...
    public static void deleteEmptySheets(XSSFWorkbook wb){
        ...
        for (int i = 0; i < wb.getNumberOfSheets(); i++) {
            /*if (wb.getSheetAt(i).getSheetName().contains("路面弯沉") && "".equals(wb.getSheetAt(i).getRow(10).getCell(0)) && wb.getSheetAt(i).getRow(10).getCell(0)==null){
                delsheets.add(wb.getSheetAt(i).getSheetName());
            }*/
