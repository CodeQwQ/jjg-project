<template>
    <div class="app-container">
        ...
        >
          ...
          <el-table-column prop="gcbw" label="工程部位" width="220px" />
          ...
          <el-table-column prop="clchd" label="材料层厚度Ha" width="120px"/>
          <el-table-column prop="ljdmhtml" label="路基顶面回弹模量EO" width="120px"/>
          <el-table-column prop="lcz" label="落锤重(T)" width="100px"/>
          
          
          <el-table-column prop="cd" label="车道" />
          <el-table-column prop="scwcz" label="实测弯沉值(0.01mm)" width="120px"/>
          
          <el-table-column prop="lbwd" label="路表温度" />
          <el-table-column prop="lmbzlx" label="路面类型标注"  />
          <el-table-column prop="cqpjwd" label="测前5h平均温度" width="100px"/>
          <el-table-column prop="lqczhd" label="沥青层总厚度" width="120px"/>
          <el-table-column prop="lqbmwd" label="沥青表面温度" width="120px"/>
        ...
        <img v-viewer style="height: 100px;width: 450px;" src="@/assets/填写说明/路面/路面弯沉落锤法.png" alt="" >
        ...
        >
          ...
          <el-table-column prop="合格单元数" label="合格单元数" />
          <el-table-column prop="检测单元数" label="检测单元数"  />
        ...
        <el-form ref="dataForm" :model="modifyData"  label-width="210px" size="small" style="padding-right: 40px;" :rules="rules">
          ...
          <el-form-item label="工程部位" prop="gcbw">
            <el-input v-model="modifyData.gcbw"></el-input>
          </el-form-item>
          ...
          <el-form-item label="材料层厚度Ha" prop="clchd">
            <el-input v-model="modifyData.clchd"></el-input>
          </el-form-item>
          <el-form-item label="路基顶面回弹模量EO" prop="ljdmhtml">
            <el-input v-model="modifyData.ljdmhtml"></el-input>
          </el-form-item>
          ...
          <el-form-item label="实测弯沉值(0.01mm)" prop="scwcz">
          ...
          <el-form-item label="路面类型标注" prop="lmbzlx">
            <el-input v-model="modifyData.lmbzlx"></el-input>
          </el-form-item>
          ...
          <el-form-item label="沥青层总厚度" prop="lqczhd">
            <el-input v-model="modifyData.lqczhd"></el-input>
          </el-form-item>
          <el-form-item label="沥青表面温度" prop="lqbmwd">
            <el-input v-model="modifyData.lqbmwd"></el-input>
          </el-form-item>
          <el-form-item label="测前5h平均温度" prop="cqpjwd">
            <el-input v-model="modifyData.cqpjwd"></el-input>
          </el-form-item>
    ...
    <script>
    // 引入定义接口js文件
    import api from "@/api/jgproject/fczb/jglmwclcf";
      ...
      methods: {
        ...
        exportlmwclcf() {
          ...
          api.exportlmwclcf().then((res) => {
            ...
            // 设置导出的文件名称
            link.download = `02路面弯沉(落锤法)实测数据` + ".xlsx";
