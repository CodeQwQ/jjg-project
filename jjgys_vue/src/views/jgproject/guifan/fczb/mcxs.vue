<template>
    <div class="app-container">
        ...
        >
          ...
          <el-table-column prop="htd" label="合同段"  />
          <el-table-column prop="lxbs" label="路线类型" />
          <el-table-column prop="lmlx" label="路面类型" />
          <el-table-column prop="pjz" label="平均值" />
    ...
    <script>
    // 引入定义接口js文件
    import api from "@/api/jgproject/fczb/mcxs.js";
    ...
    export default {
      ...
      methods: {
        ...
        ckpjz(){
            ...
            api.ckpjz(commonInfoVo.proname).then((res)=>{
        ...
        exportmcxs() {
          ...
          api.exportmcxs(this.cd).then((res) => {
            ...
            // 设置导出的文件名称
            link.download = projectname + `摩擦系数` + ".xlsx";
