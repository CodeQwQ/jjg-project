<template>
    <div class="app-container">
      ...
      <div class="search-div">
        <el-form :inline="true" class="demo-form-inline">
          <el-form-item label="混凝土路面名称:">
            <el-input v-model="searchObj.hntlmname" />
          </el-form-item>
          <el-button
            type="primary"
            icon="el-icon-search"
      ...
      >
        ...
        <el-table-column prop="hntlmname" label="混凝土路面名称" width="150px" />
        ...
        <el-table-column prop="lmqc" label="路面全长" />
        
        <el-table-column prop="pzlx" label="铺筑类型" />
        <el-table-column prop="zdlx" label="A/B/M(匝道桥填匝道标志)" width="200px" />
        <el-table-column prop="wz" label="位置" />
        <el-table-column prop="htlmsshtd" label="互通路面所属合同段" width="150px" />
      ...
      >
        ...
        <img v-viewer style="height: 100px;width: 450px;" src="@/assets/填写说明/路桥隧/混凝土路面及匝道清单.png" alt="" >
      ...
      <el-dialog title="修改" :visible.sync="dialogVisible2" width="40%" >
          <el-form ref="dataForm" :model="modifyData"  label-width="200px" size="small" style="padding-right: 40px;" :rules="rules">
            <el-form-item label="混凝土路面名称" prop="hntlmname">
            <el-input v-model="modifyData.hntlmname"></el-input>
            </el-form-item>
            ...
            <el-form-item label="路面全长" prop="lmqc">
            <el-input v-model="modifyData.lmqc"></el-input>
            </el-form-item>
            <el-form-item label="铺筑类型" prop="pzlx">
            <el-input v-model="modifyData.pzlx"></el-input>
            </el-form-item>
            <el-form-item label="A/B/M(匝道桥填匝道标志)" prop="zdlx">
            <el-input v-model="modifyData.zdlx"></el-input>
            </el-form-item>
            <el-form-item label="位置" prop="wz">
            <el-input v-model="modifyData.wz"></el-input>
            </el-form-item>
            <el-form-item label="互通路面所属合同段" prop="htlmsshtd">
            <el-input v-model="modifyData.htlmsshtd"></el-input>
            </el-form-item>
  ...
  <script>
  // 引入定义接口js文件
  import api from "@/api/jgproject/lqszb/hntlmjzd.js";
    ...
    methods: {
      ...
      exporthntlmzd() {
        ...
        api.exportlmzd().then((res) => {
          ...
          // 设置导出的文件名称
          link.download = projectname + `混凝土路面及匝道清单` + ".xlsx";
