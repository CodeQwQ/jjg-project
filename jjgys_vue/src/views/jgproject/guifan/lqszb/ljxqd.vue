<template>
    <div class="app-container">
      ...
      >
        ...
        <el-table-column prop="ljxlmsshtd" label="连接线路面所属合同段"  width="200px"/>
        <el-table-column prop="bz" label="标志" />
      ...
      >
        ...
        <img v-viewer style="height: 100px;width: 450px;" src="@/assets/填写说明/路桥隧/连接线清单.png" alt="" >
      ...
      <el-dialog title="修改" :visible.sync="dialogVisible2" width="40%" >
          <el-form ref="dataForm" :model="modifyData"  label-width="200px" size="small" style="padding-right: 40px;">
            <el-form-item label="连接线名称" prop="ljxname">
            <el-input v-model="modifyData.ljxname"></el-input>
            </el-form-item>
            ...
            <el-form-item label="连接线路面所属合同段" prop="ljxlmsshtd">
            <el-input v-model="modifyData.ljxlmsshtd"></el-input>
            </el-form-item>
            
           
            <el-form-item label="标志" prop="bz">
  ...
  <script>
  // 引入定义接口js文件
  import api from "@/api/jgproject/lqszb/ljxqd.js";
