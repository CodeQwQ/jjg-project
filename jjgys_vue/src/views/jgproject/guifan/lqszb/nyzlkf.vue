<template>
    <div class="app-container">
      ...
      <el-dialog title="修改" :visible.sync="dialogVisible2" width="40%" >
          <el-form ref="dataForm" :model="modifyData"  label-width="200px" size="small" style="padding-right: 40px;">
            ...
            <el-input v-model="modifyData.wt"></el-input>
            </el-form-item>
            <el-form-item label="扣分" prop="kf">
            <el-input v-model="modifyData.kf"></el-input>
            </el-form-item>
  ...
  <script>
  // 引入定义接口js文件
  import api from "@/api/jgproject/lqszb/nyzlkf.js";
  ...
  export default {
    ...
    methods: {
      ...
      exportnyzl() {
        ...
        api.exportnyzl(projectname).then((res) => {
          ...
          // 设置导出的文件名称
          link.download = projectname + `内页资料扣分` + ".xlsx";
