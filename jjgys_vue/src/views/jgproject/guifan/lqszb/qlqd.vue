<template>
    <div class="app-container">
      ...
      <div class="search-div">
        <el-form :inline="true" class="demo-form-inline">
          <el-form-item label="桥梁名称:">
            <el-input v-model="searchObj.qlname" />
          </el-form-item>
          <el-button
            type="primary"
            icon="el-icon-search"
      ...
      >
        ...
        <el-table-column prop="qlname" label="桥梁名称" />
        ...
        <el-table-column prop="qlqc" label="桥梁全长" />
        <el-table-column prop="dkkj" label="单孔跨径" />
        <el-table-column prop="pzlx" label="铺筑类型" />
        <el-table-column prop="bz" label="A/B/M(匝道桥填匝道标志)" />
      ...
      >
        ...
        <img v-viewer style="height: 100px;width: 450px;" src="@/assets/填写说明/路桥隧/桥梁清单.png" alt="" >
      ...
      <el-dialog title="修改" :visible.sync="dialogVisible2" width="40%" >
          <el-form ref="dataForm" :model="modifyData"  label-width="200px" size="small" style="padding-right: 40px;">
            <el-form-item label="桥梁名称" prop="qlname">
            <el-input v-model="modifyData.qlname"></el-input>
            </el-form-item>
            ...
            <el-input v-model="modifyData.qlqc"></el-input>
            </el-form-item>
            <el-form-item label="单孔跨径" prop="dkkj">
            <el-input v-model="modifyData.dkkj"></el-input>
            </el-form-item>
            <el-form-item label="铺筑类型" prop="pzlx">
            <el-input v-model="modifyData.pzlx"></el-input>
            </el-form-item>
            <el-form-item label="A/B/M(匝道桥填匝道标志)" prop="bz">
  ...
  <script>
  // 引入定义接口js文件
  import api from "@/api/jgproject/lqszb/qlqd.js";
  ...
  export default {
    ...
    methods: {
      ...
      exportql() {
        ...
        api.exportql(projectname).then((res) => {
          ...
          // 设置导出的文件名称
          link.download = projectname + `桥梁清单` + ".xlsx";
