<template>
    <div class="app-container">
      ...
      <div class="search-div">
        <el-form :inline="true" class="demo-form-inline">
          <el-form-item label="隧道名称:">
            <el-input v-model="searchObj.sdname" />
          </el-form-item>
          <el-button
            type="primary"
            icon="el-icon-search"
      ...
      >
        ...
        <el-table-column prop="sdname" label="隧道名称" />
        ...
        <el-table-column prop="sdqc" label="隧道全长" />
        <el-table-column prop="pzlx" label="铺筑类型" />
        <el-table-column prop="zdbz" label="A/B/M(匝道桥填匝道标志)" />
      ...
      >
        ...
        <img v-viewer style="height: 100px;width: 450px;" src="@/assets/填写说明/路桥隧/隧道清单.png" alt="" >
      ...
      <el-dialog title="修改" :visible.sync="dialogVisible2" width="40%" >
          <el-form ref="dataForm" :model="modifyData"  label-width="200px" size="small" style="padding-right: 40px;">
            ...
            <el-input v-model="modifyData.sdname"></el-input>
            </el-form-item>
            ...
            <el-form-item label="隧道全长" prop="sdqc">
            <el-input v-model="modifyData.sdqc"></el-input>
            </el-form-item>
            
            <el-form-item label="铺筑类型" prop="pzlx">
            <el-input v-model="modifyData.pzlx"></el-input>
            </el-form-item>
            <el-form-item label="A/B/M(匝道桥填匝道标志)" prop="zdbz">
            <el-input v-model="modifyData.zdbz"></el-input>
            </el-form-item>
  ...
  <script>
  // 引入定义接口js文件
  import api from "@/api/jgproject/lqszb/sdqd.js";
  ...
  export default {
    ...
    methods: {
      ...
      exportsd() {
        ...
        api.exportsd(projectname).then((res) => {
          ...
          // 设置导出的文件名称
          link.download = projectname + `隧道清单` + ".xlsx";
