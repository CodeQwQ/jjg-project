<template>
    <div class="app-container">
      ...
      <div class="search-div">
        <el-form :inline="true" class="demo-form-inline">
          <el-form-item label="分部工程:">
            <el-input v-model="searchObj.fbgc" />
          </el-form-item>
          <el-button
            type="primary"
            icon="el-icon-search"
      ...
      >
        ...
        <el-table-column prop="fbgckf" label="分部工程扣分" />
      ...
      <el-dialog title="修改" :visible.sync="dialogVisible2" width="40%" >
          <el-form ref="dataForm" :model="modifyData"  label-width="200px" size="small" style="padding-right: 40px;">
            ...
            <el-input v-model="modifyData.dwgc"></el-input>
            </el-form-item>
            <el-form-item label="分部工程" prop="fbgc">
            <el-input v-model="modifyData.fbgc"></el-input>
            </el-form-item>
            <el-form-item label="分部工程扣分" prop="fbgckf">
            <el-input v-model="modifyData.fbgckf"></el-input>
            </el-form-item>
  ...
  <script>
  // 引入定义接口js文件
  import api from "@/api/jgproject/lqszb/wgkf.js";
  ...
  export default {
    ...
    methods: {
      ...
      exportwgkf() {
        ...
        api.exportwgkf(projectname).then((res) => {
          ...
          // 设置导出的文件名称
          link.download = projectname + `外观扣分` + ".xlsx";
