<template>
      ...
      <el-row >  
        ...
        <el-row>
          <el-col :span="8">
            ...
            <el-col :span="8">
                <el-card shadow="hover" @click.native="dwgctze()"> 单位工程投资额 </el-card>
            </el-col>
            <el-col :span="8">
        ...
        <el-row>
            ...
            <el-col :span="8">
                <el-card shadow="hover" @click.native="wgkf()"> 外观扣分 </el-card>
            </el-col>
          <el-col :span="8">
                <el-card shadow="hover" @click.native="nyzlkf()"> 内页资料扣分 </el-card>
            </el-col>
  ...
  import api from "@/api/jgproject/old.js";
  ...
  export default {
    ...
    methods: {
      ...
      ryxxjgfc(){
        let proname = this.$route.query.projecttitle;
        this.$router.push({path:"/jgproject/guifan/ryxxjgfc",query:{projecttitle:proname}});
      },
      jgjcsj(){
        let proname = this.$route.query.projecttitle;
        this.$router.push({path:"/jgproject/guifan/jgjcsj",query:{projecttitle:proname,guifan:'old'}});
      },
      importlqs() {
      ...
      exportlqs() {
        ...
        api.exportold().then((res) => {
          ...
          // 设置导出的文件名称
          link.download = projectname+`路桥隧数据文件(旧)` + '.xlsx'
