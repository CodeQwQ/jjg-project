<template>
  <div class="app-container">
      ...
      <img v-viewer style="height: 100px;width: 450px;" src="@/assets/填写说明/路基/涵洞结构尺寸.png" alt="" >
  ...
  <script>
  // 引入定义接口js文件
  import api from "@/api/project/fbgc/ljgc/hdjgcc.js";
    ...
    methods: {
      ...
      ckjdb(){
          ...
          api.lookjdb(commonInfoVo).then((res)=>{
            ...
            this.descriptions['检测总点数']=res.data[0]["总点数"]
      ...
      exporthdjgcc() {
        ...
        api.exporthdjgcc().then((res) => {
          ...
          // 设置导出的文件名称
          link.download = `09涵洞结构尺寸实测数据` + ".xlsx";
