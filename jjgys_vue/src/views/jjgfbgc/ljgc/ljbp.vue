<template>
    <div class="app-container">
        ...
        >
          ...
          <el-table-column prop="wz" label="位置" width="220px" />
          <el-table-column prop="sjz" label="设计值" width="150x"/>
          <el-table-column prop="length" label="长" width="100x"/>
          <el-table-column prop="high" label="高" width="100x"/>
        ...
        <img v-viewer style="height: 100px;width: 450px;" src="@/assets/填写说明/路基/路基边坡.png" alt="" >
        ...
        <el-dialog title="修改" :visible.sync="dialogVisible2" width="40%" >
          <el-form ref="dataForm" :model="modifyData"  label-width="150px" size="small" style="padding-right: 40px;" :rules="rules">
            ...
            <el-form-item label="高" prop="high">
              <el-input v-model="modifyData.high"></el-input>
            </el-form-item>
    ...
    <script>
    // 引入定义接口js文件
    import api from "@/api/project/fbgc/ljgc/ljbp.js";
