<template>
  <div class="app-container">
      ...
      >
        ...
        <el-table-column prop="sdyxxs" label="温度影响系数" width="120px"/>
      ...
      <img v-viewer style="height: 100px;width: 450px;" src="@/assets/填写说明/路基/路基弯沉贝克曼梁法.png" alt="" >
      ...
      <el-dialog title="修改" :visible.sync="dialogVisible2" width="40%" >
        <el-form ref="dataForm" :model="modifyData"  label-width="170px" size="small" style="padding-right: 40px;" :rules="rules">
          ...
          <el-form-item label="温度影响系数" prop="sdyxxs">
    ...
    methods: {
      ...
      ckjdb(){
          ...
          api.lookjdb(commonInfoVo).then((res)=>{
            ...
            this.descriptions['合格点数']=res.data[0]["合格单元数"]
            this.descriptions['总点数']=res.data[0]["检测单元数"]
      ...
      exportljwcbkmlf() {
        ...
        api.exportljwcbkmlf().then((res) => {
          ...
          // 设置导出的文件名称
          link.download = `02路基弯沉(贝克曼梁法)实测数据` + ".xlsx";
