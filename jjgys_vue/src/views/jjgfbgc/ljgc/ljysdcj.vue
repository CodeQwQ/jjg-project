<template>
    <div class="app-container">
        ...
        <img v-viewer style="height: 100px;width: 450px;" src="@/assets/填写说明/路基/路基压实度沉降.png" alt="" >
        ...
        <el-dialog title="修改" :visible.sync="dialogVisible2" width="40%" >
          <el-form ref="dataForm" :model="modifyData"  label-width="150px" size="small" style="padding-right: 40px;" :rules="rules">
            ...
            <el-form-item label="检查桩号" prop="jczh">
              <el-input v-model="modifyData.jczh"></el-input>
            </el-form-item>
            <el-form-item label="碾压读数1" prop="nyds1">
              <el-input v-model="modifyData.nyds1"></el-input>
            </el-form-item>
            <el-form-item label="碾压读数2" prop="nyds2">
              <el-input v-model="modifyData.nyds2"></el-input>
            </el-form-item>
    ...
    <script>
    // 引入定义接口js文件
    import api from "@/api/project/fbgc/ljgc/ljysdcj.js";
      ...
      methods: {
        ...
        exportljysdcj() {
          ...
          api.exportljysdcj().then((res) => {
            ...
            // 设置导出的文件名称 01路基沉降量实测数据
            link.download = `01路基沉降量实测数据` + ".xlsx";
