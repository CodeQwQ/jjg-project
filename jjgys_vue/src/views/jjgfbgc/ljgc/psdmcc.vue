<template>
    <div class="app-container">
        ...
        <img v-viewer style="height: 100px;width: 450px;" src="@/assets/填写说明/路基/排水断面尺寸.png" alt="" >
    ...
    <script>
    // 引入定义接口js文件
    import api from "@/api/project/fbgc/ljgc/psdmcc.js";
      ...
      methods: {
        ...
        exportpsdmcc() {
          ...
          api.exportpsdmcc().then((res) => {
            ...
            // 设置导出的文件名称
            link.download = `04排水断面尺寸实测数据` + ".xlsx";
