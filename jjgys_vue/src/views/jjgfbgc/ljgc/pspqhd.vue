<template>
    <div class="app-container">
        ...
        >
          ...
          <el-table-column prop="lb" label="类别" width="220px" />
          <el-table-column prop="sjz" label="设计值(mm)" />
          <el-table-column prop="scz" label="实测值(mm)" />
          <el-table-column prop="yxwc" label="允许误差(mm)" />
        ...
        <img v-viewer style="height: 100px;width: 450px;" src="@/assets/填写说明/路基/排水铺砌厚度.png" alt="" >
        ...
        <el-dialog title="修改" :visible.sync="dialogVisible2" width="40%" >
          <el-form ref="dataForm" :model="modifyData"  label-width="150px" size="small" style="padding-right: 40px;" :rules="rules">
            ...
            <el-form-item label="允许误差(mm)" prop="yxwcz">
              <el-input v-model="modifyData.yxwc"></el-input>
            </el-form-item>
    ...
    <script>
    // 引入定义接口js文件
    import api from "@/api/project/fbgc/ljgc/pspqhd.js";
      ...
      methods: {
        ...
        exportpspqhd() {
          ...
          api.exportpspqhd().then((res) => {
            ...
            // 设置导出的文件名称
            link.download = `05排水铺砌厚度实测数据` + ".xlsx";
