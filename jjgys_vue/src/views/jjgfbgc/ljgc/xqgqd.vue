<template>
    <div class="app-container">
        ...
        >
          ...
          <el-table-column prop="sjqd" label="设计强度" />
        ...
        <img v-viewer style="height: 100px;width: 450px;" src="@/assets/填写说明/路基/小桥砼强度.png" alt="" >
    ...
    <script>
    // 引入定义接口js文件
    import api from "@/api/project/fbgc/ljgc/xqgqd.js";
      ...
      methods: {
        ...
        ckjdb(){
            ...
            api.lookjdb(commonInfoVo).then((res)=>{
              ...
              this.descriptions['总点数']=res.data[0]["检测总点数"]
        ...
        exportxqgqd() {
          ...
          api.exportxqgqd().then((res) => {
            ...
            // 设置导出的文件名称
            link.download = `06小桥砼强度实测数据` + ".xlsx";
