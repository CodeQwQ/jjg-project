<template>
    <div class="app-container">
        ...
        <img v-viewer style="height: 100px;width: 450px;" src="@/assets/填写说明/路基/小桥结构尺寸.png" alt="" >
    ...
    <script>
    // 引入定义接口js文件
    import api from "@/api/project/fbgc/ljgc/xqjgcc.js";
      ...
      methods: {
        ...
        exportxqjgcc() {
          ...
          api.exportxqjgcc().then((res) => {
            ...
            // 设置导出的文件名称
            link.download = `07小桥结构尺寸实测数据` + ".xlsx";
