<template>
    <div class="app-container">
        ...
        <div class="search-div">
          <el-form :inline="true" class="demo-form-inline">
            ...
            <el-form-item label="桩号及位置:">
              <el-input v-model="searchObj.zhjwz" />
            </el-form-item>
            <el-button
              type="primary"
              icon="el-icon-search"
        ...
        <img v-viewer style="height: 100px;width: 450px;" src="@/assets/填写说明/路基/支挡断面尺寸.png" alt="" >
    ...
    <script>
    // 引入定义接口js文件
    import api from "@/api/project/fbgc/ljgc/zddmcc.js";
      ...
      methods: {
        ...
        exportzddmcc() {
          ...
          api.exportzddmcc().then((res) => {
            ...
            // 设置导出的文件名称
            link.download = `11支挡断面尺寸实测数据` + ".xlsx";
