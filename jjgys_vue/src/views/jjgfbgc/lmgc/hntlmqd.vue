<template>
    <div class="app-container">
        ...
        >
          ...
          <el-table-column label="序号" width="50px">
            ...
            <el-table-column prop="sypjzj" label="试样平均直径(mm)" />
            <el-table-column prop="sypjhd" label="试样平均厚度(mm)" />
            <el-table-column prop="jxhz" label="极限荷载(N)" />
            <el-table-column prop="lmqdgdz" label="路面强度规定值" />
        ...
        <img v-viewer style="height: 100px;width: 450px;" src="@/assets/填写说明/路面/混凝土路面强度.png" alt="" >
        ...
        <el-dialog title="修改" :visible.sync="dialogVisible2" width="40%" >
          <el-form ref="dataForm" :model="modifyData"  label-width="120px" size="small" style="padding-right: 40px;" :rules="rules">
            ...
            <el-form-item label="试样平均直径" prop="sypjzj">
            <el-input v-model="modifyData.sypjzj"></el-input>
            </el-form-item>
            <el-form-item label="试样平均厚度" prop="sypjhd">
            <el-input v-model="modifyData.sypjhd"></el-input>
            </el-form-item>
            <el-form-item label="极限荷载" prop="jxhz">
            <el-input v-model="modifyData.jxhz"></el-input>
            </el-form-item>
            <el-form-item label="路面强度规定值" prop="lmqdgdz">
            <el-input v-model="modifyData.lmqdgdz"></el-input>
            </el-form-item>
    ...
    <script>
    // 引入定义接口js文件
    import api from "@/api/project/fbgc/lmgc/hntlmqd";
      ...
      methods: {
        ...
        exporthntlmqd() {
          ...
          api.exporthntlmqd().then((res) => {
            ...
            // 设置导出的文件名称
            link.download = `05混凝土路面强度实测数据` + ".xlsx";
