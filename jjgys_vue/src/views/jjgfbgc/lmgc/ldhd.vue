<template>
    <div class="app-container">
        ...
        >
          ...
          <el-table-column label="序号" width="50px">
            ...
            <el-table-column prop="zh" label="起点桩号" width="220px" />
            <el-table-column prop="zhz" label="终点桩号" width="220px" />
            <el-table-column prop="ld" label="雷达" />
        ...
        <img v-viewer style="height: 100px;width: 450px;" src="@/assets/填写说明/路面/雷达厚度.png" alt="" >
       <div style="color: rgb(84, 151, 198);" align="middle">双击查看大图</div>
        ...
        <el-dialog title="修改" :visible.sync="dialogVisible2" width="40%" >
          <el-form ref="dataForm" :model="modifyData"  label-width="120px" size="small" style="padding-right: 40px;" :rules="rules1">
            ...
            <el-form-item label="起点桩号" prop="zh">
            <el-input v-model="modifyData.zh"></el-input>
            </el-form-item>
            <el-form-item label="终点桩号" prop="zh">
            <el-input v-model="modifyData.zhz"></el-input>
            </el-form-item>
            
            <el-form-item label="雷达" prop="ld">
            <el-input v-model="modifyData.ld"></el-input>
            </el-form-item>
        ...
        <el-dialog title="选择车道" :visible.sync="dialogVisible3" width="18%"  >
          ...
          <span slot="footer" class="dialog-footer">
            ...
            <el-button type="primary"  icon="el-icon-check" @click="exportldhd()" size="small">确 定</el-button>
          </span>
        </el-dialog>
        <el-dialog title="输入设计值" :visible.sync="dialogVisible4" width="40%"  >
          <el-form ref="sjzForm" :model="sjzdata"  label-width="150px" size="small" style="padding-right: 40px;" :rules="rules">
            
            <el-form-item label="沥青路面左幅设计值" prop="lqsjz">
            <el-input v-model="sjzdata.lqsjz"></el-input>
            </el-form-item>
            <el-form-item label="沥青路面右幅设计值" prop="lqsjzyf">
            <el-input v-model="sjzdata.lqsjzyf"></el-input>
            </el-form-item>
            <el-form-item label="隧道设计值" prop="sdsjz">
            <el-input v-model="sjzdata.sdsjz"></el-input>
            </el-form-item>
            <el-form-item label="桥梁设计值" prop="qlsjz">
            <el-input v-model="sjzdata.qlsjz"></el-input>
            </el-form-item>
            <el-form-item label="复合路面左幅设计值" prop="fhlmsjz">
            <el-input v-model="sjzdata.fhlmsjz"></el-input>
            </el-form-item>
            <el-form-item label="复合路面右幅设计值" prop="fhlmsjzyf">
            <el-input v-model="sjzdata.fhlmsjzyf"></el-input>
            </el-form-item>
    ...
    <script>
    // 引入定义接口js文件
    import api from "@/api/project/fbgc/lmgc/ldhd";
    ...
    export default {
      ...
      methods: {
        ...
        scjdb(){
          this.$refs["sjzForm"].validate((valid)=>{
              if(valid){
                ...
                commonInfoVo.sjz =this.sjzdata.lqsjz
                commonInfoVo.yfsjz =this.sjzdata.lqsjzyf
                commonInfoVo.qlsjz=this.sjzdata.qlsjz
                commonInfoVo.sdsjz=this.sjzdata.sdsjz
                commonInfoVo.fhlmsjz=this.sjzdata.fhlmsjz
                commonInfoVo.yffhlmsjz=this.sjzdata.fhlmsjzyf
        ...
        exportldhd() {
          ...
          api.exportldhd(this.cd).then((res) => {
