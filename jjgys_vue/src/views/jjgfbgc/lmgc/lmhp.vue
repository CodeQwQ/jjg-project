<template>
    <div class="app-container">
        ...
        >
          ...
          <el-table-column prop="zy" label="Z/Y" />
          ...
          <el-table-column prop="length" label="长(mm)" />
          <el-table-column prop="sjz" label="设计值(%)" />
          <el-table-column prop="yxps" label="允许偏差(%)" width="120px"/>
          <el-table-column prop="lxlx" label="路线类型" width="120px"/>
        ...
        >
          ...
          <img v-viewer style="height: 100px;width: 450px;" src="@/assets/填写说明/路面/路面横坡.png" alt="" >
        ...
        >
          ...
          <el-table-column prop="检测项目" label="检测项目" width="130px"/>
          <el-table-column prop="路面类型" label="路面类型" width="130px" />
          <el-table-column prop="检测点数" label="检测点数" />
          <el-table-column prop="合格点数" label="合格点数" />
         
          <el-table-column prop="合格率" label="合格率(%)" />
          <el-table-column prop="允许偏差" label="允许偏差" width="100px" />
        ...
        <el-dialog title="修改" :visible.sync="dialogVisible2" width="40%" >
          <el-form ref="dataForm" :model="modifyData"  label-width="150px" size="small" style="padding-right: 40px;" :rules="rules">
            ...
            <el-form-item label="Z/Y" prop="zy">
              <el-input v-model="modifyData.zy"></el-input>
            </el-form-item>
            ...
            <el-form-item label="路线类型" prop="lxlx">
    ...
    <script>
    // 引入定义接口js文件
    import api from "@/api/project/fbgc/lmgc/lmhp";
    ...
    export default {
      ...
      data() {
        ...
        return {
          ...
          fileList:[],
          modifyData:{},
          instruction:"1，日期格式：yyyy/MM/dd，例如：2021/05/23；\n2，若某个桩号点的位置不分左右幅时，请填写单幅，若分左右幅时，请填写左幅或右幅，请勿填写左线或右线；\n3，填写模板如下：",
          rules:{
            jcsj:[
              {
                required:true,
