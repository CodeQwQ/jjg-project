<template>
    <div class="app-container">
        ...
        >
          ...
          <el-table-column label="序号" width="50px">
            ...
            <el-table-column prop="lxlx" label="主线、匝道、隧道" width="150px" />
            <el-table-column prop="zh" label="桩号" />
            <el-table-column prop="cds" label="初读数(mL)" />
            <el-table-column prop="ofzds" label="第一分钟读数(mL)" />
            <el-table-column prop="tfzds" label="第二分钟读数(mL)" />
            <el-table-column prop="sl" label="水量(mL)" />
            <el-table-column prop="sj" label="时间(s)" />
            <el-table-column prop="ssxsgdz" label="渗水系数规定值" width="80px" />
        ...
        >
          ...
          <img v-viewer style="height: 100px;width: 450px;" src="@/assets/填写说明/路面/沥青路面渗水系数.png" alt="" >
        ...
        <el-dialog title="修改" :visible.sync="dialogVisible2" width="40%" >
          <el-form ref="dataForm" :model="modifyData"  label-width="150px" size="small" style="padding-right: 40px;" :rules="rules">
            ...
            <el-form-item label="主线、匝道、隧道" prop="lxlx">
            <el-input v-model="modifyData.lxlx"></el-input>
            </el-form-item>
            <el-form-item label="桩号" prop="zh">
            <el-input v-model="modifyData.zh"></el-input>
            </el-form-item>
            
            <el-form-item label="初读数" prop="cds">
            <el-input v-model="modifyData.cds"></el-input>
            </el-form-item>
            <el-form-item label="第一分钟读数" prop="ofzds">
            <el-input v-model="modifyData.ofzds"></el-input>
            </el-form-item>
            <el-form-item label="第二分钟读数" prop="tfzds">
            <el-input v-model="modifyData.tfzds"></el-input>
            </el-form-item>
            <el-form-item label="水量" prop="sl">
            <el-input v-model="modifyData.sl"></el-input>
            </el-form-item>
            <el-form-item label="时间" prop="sj">
            <el-input v-model="modifyData.sj"></el-input>
            </el-form-item>
            <el-form-item label="渗水系数规定值" prop="ssxsgdz">
            <el-input v-model="modifyData.ssxsgdz"></el-input>
            </el-form-item>
    ...
    <script>
    // 引入定义接口js文件
    import api from "@/api/project/fbgc/lmgc/lqlmssxs";
    ...
    export default {
      ...
      data() {
        ...
        return {
          ...
          fileList:[],
          modifyData:{},
          instruction:"1，日期格式：yyyy/MM/dd，例如：2021/05/23；\n2，若路线类型为路的时候，填写主线；若路线类型为隧道或者匝道时，填写隧道或者匝道的名称，并且与路桥隧清单中的名称相对应；\n3，填写模板如下：",
          rules:{
            jcsj:[
              {
                required:true,
      ...
      methods: {
        ...
        exportlqlmssxs() {
          ...
          api.exportlqlmssxs().then((res) => {
            ...
            // 设置导出的文件名称
            link.download = `04沥青路面渗水系数实测数据` + ".xlsx";
