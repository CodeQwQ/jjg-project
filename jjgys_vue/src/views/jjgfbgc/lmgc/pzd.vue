<template>
    <div class="app-container">
        ...
        >
          ...
          <el-table-column label="序号" width="50px">
            ...
            <el-table-column prop="ziri" label="IRI" />
        ...
        >
          ...
          <img v-viewer style="height: 100px;width: 450px;" src="@/assets/填写说明/路面/平整度.png" alt="" >
        ...
        <el-dialog title="修改" :visible.sync="dialogVisible2" width="40%" >
          <el-form ref="dataForm" :model="modifyData"  label-width="120px" size="small" style="padding-right: 40px;" :rules="rules1">
            ...
            <el-form-item label="IRI" prop="ziri">
            <el-input v-model="modifyData.ziri"></el-input>
            </el-form-item>
        ...
        <el-dialog title="选择车道" :visible.sync="dialogVisible3" width="18%" >
          ...
          <span slot="footer" class="dialog-footer">
            ...
            <el-button type="primary" icon="el-icon-check" @click="exportpzd()" size="small">确 定</el-button>
          </span>
        </el-dialog>
        <el-dialog title="输入设计值" :visible.sync="dialogVisible4" width="40%"  >
          <el-form ref="sjzForm" :model="sjzdata"  label-width="170px" size="small" style="padding-right: 40px;" :rules="rules">
            
            
            <el-form-item label="主线路面设计值" prop="zlsjz">
            <el-input v-model="sjzdata.zlsjz"></el-input>
            </el-form-item>
            <el-form-item label="主线隧道路面设计值" prop="zssjz">
            <el-input v-model="sjzdata.zssjz"></el-input>
            </el-form-item>
            <el-form-item label="主线桥梁路面设计值" prop="zqsjz">
            <el-input v-model="sjzdata.zqsjz"></el-input>
            </el-form-item>

            <el-form-item label="互通路面设计值" prop="hlsjz">
            <el-input v-model="sjzdata.hlsjz"></el-input>
            </el-form-item>
            <el-form-item label="互通隧道路面设计值" prop="hssjz">
            <el-input v-model="sjzdata.hssjz"></el-input>
            </el-form-item>
            <el-form-item label="互通桥梁路面设计值" prop="hqsjz">
            <el-input v-model="sjzdata.hqsjz"></el-input>
            </el-form-item>

            <el-form-item label="连接线路面设计值" prop="llsjz">
            <el-input v-model="sjzdata.llsjz"></el-input>
            </el-form-item>
            <el-form-item label="连接线隧道路面设计值" prop="lssjz">
            <el-input v-model="sjzdata.lssjz"></el-input>
            </el-form-item>
            <el-form-item label="连接线桥梁路面设计值" prop="lqsjz">
            <el-input v-model="sjzdata.lqsjz"></el-input>
            </el-form-item>
    ...
    <script>
    // 引入定义接口js文件
    import api from "@/api/project/fbgc/lmgc/pzd";
    ...
    export default {
        ...
        return {
          ...
          rules:{
            ...
            zqsjz:[
              {
                required:true,
                message:"主线桥梁路面设计值不能为空！"
              },
              {
                type:'number',
                message:"主线桥梁路面设计值必须为数字！",
                transform: (value) => Number(value)
              }
            ],
            ...
            hssjz:[
              {
                required:true,
                message:"互通隧道路面设计值不能为空！"
              },
              {
                type:'number',
                message:"互通隧道路面设计值必须为数字！",
                transform: (value) => Number(value)
              }
            ],
            hqsjz:[
              {
                required:true,
                message:"互通桥梁路面设计值不能为空！"
              },
              {
                type:'number',
                message:"互通桥梁路面设计值必须为数字！",
                transform: (value) => Number(value)
              }
            ],
            ...
            llsjz:[
              {
                required:true,
                message:"连接线路面设计值不能为空！"
              },
              {
                type:'number',
                message:"连接线路面设计值必须为数字！",
                transform: (value) => Number(value)
              }
            ],
            lssjz:[
              {
                required:true,
                message:"连接线隧道路面设计值不能为空！"
              },
              {
                type:'number',
                message:"连接线隧道路面设计值必须为数字！",
                transform: (value) => Number(value)
              }
            ],
            lqsjz:[
              {
                required:true,
                message:"连接线桥梁路面设计值不能为空！"
              },
              {
                type:'number',
                message:"连接线桥梁路面设计值必须为数字！",
                transform: (value) => Number(value)
              }
            ],
          },
      ...
      methods: {
        ...
        scjdb(){
          this.$refs["sjzForm"].validate((valid)=>{
              if(valid){
                ...
                commonInfoVo.zlsjz=this.sjzdata.zlsjz
                commonInfoVo.zssjz=this.sjzdata.zssjz
                commonInfoVo.zqsjz=this.sjzdata.zqsjz
                commonInfoVo.hlsjz=this.sjzdata.hlsjz
                commonInfoVo.hssjz=this.sjzdata.hssjz
                commonInfoVo.hqsjz=this.sjzdata.hqsjz
                commonInfoVo.llsjz=this.sjzdata.llsjz
                commonInfoVo.lssjz=this.sjzdata.lssjz
                commonInfoVo.lqsjz=this.sjzdata.lqsjz
        ...
        exportpzd() {
          ...
          api.exportpzd(this.cd).then((res) => {
