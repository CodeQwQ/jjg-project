<template>
    <div class="app-container">
        ...
        >
          ...
          <el-table-column label="序号" width="50px">
            ...
            <el-table-column prop="sfc" label="SFC" />
            <el-table-column prop="lxbs" label="桥梁名称" />
            <!-- <el-table-column prop="zdbs" label="匝道桥标识" /> -->
        ...
        >
          ...
          <img v-viewer style="height: 100px;width: 450px;" src="@/assets/填写说明/路面/摩擦系数.png" alt="" >
        ...
        >
        <el-table-column prop="桥梁名称" label="桥梁名称" />
        ...
        <el-dialog title="修改" :visible.sync="dialogVisible2" width="40%" >
          <el-form ref="dataForm" :model="modifyData"  label-width="120px" size="small" style="padding-right: 40px;" :rules="rules1">
            ...
            <el-form-item label="SFC" prop="sfc">
            <el-input v-model="modifyData.sfc"></el-input>
            </el-form-item>
            <el-form-item label="桥梁名称" prop="lxbs">
            <el-input v-model="modifyData.lxbs"></el-input>
            </el-form-item>
            <!-- <el-form-item label="匝道桥标识" prop="zdbs">
        ...
        <el-dialog title="选择车道" :visible.sync="dialogVisible3" width="18%"  >
          ...
          <span slot="footer" class="dialog-footer">
            ...
            <el-button type="primary"  icon="el-icon-check" @click="exportmcxs()" size="small">确 定</el-button>
          </span>
        </el-dialog>
    ...
    <script>
    // 引入定义接口js文件
    import api from "@/api/project/fbgc/qlgc/mcxs";
    ...
    export default {
      ...
      methods: {
        ...
        exportmcxs() {
          ...
          api.exportmcxs(this.cd).then((res) => {
