<template>
    <div class="app-container">
        ...
        >
          ...
          <el-table-column label="序号" width="50px">
            ...
            <el-table-column prop="qlname" label="桥梁名称" width="220px" />
        ...
        >
          ...
          <img v-viewer style="height: 100px;width: 450px;" src="@/assets/填写说明/桥梁/桥平整度.png" alt="" >
        ...
        >
          ...
          <el-table-column prop="检测项目" label="桥梁名称" />
    ...
    <script>
    // 引入定义接口js文件
    import api from "@/api/project/fbgc/qlgc/pzd";
