<template>
  <div class="app-container">
      ...
      >
        ...
        <el-table-column prop="jgmc" label="路面类型" width="220px" />
      ...
      <img v-viewer style="height: 100px;width: 450px;" src="@/assets/填写说明/桥梁/桥面构造深度.png" alt="" >
      ...
      <el-dialog title="修改" :visible.sync="dialogVisible2" width="40%" >
        <el-form ref="dataForm" :model="modifyData"  label-width="150px" size="small" style="padding-right: 40px;" :rules="rules">
          ...
          <el-form-item label="路面类型" prop="jgmc">
    ...
    methods: {
      ...
      exportqmgzsd() {
        ...
        api.exportqmgzsd().then((res) => {
          ...
          // 设置导出的文件名称
          link.download = `11桥面构造深度手工铺砂法实测数据` + ".xlsx";
