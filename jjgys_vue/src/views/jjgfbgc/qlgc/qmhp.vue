<template>
    <div class="app-container">
        ...
        >
          ...
          <el-table-column prop="qsds" label="前视读数(mm)" />
          <el-table-column prop="hsds" label="后视读数(mm)" />
        ...
        <img v-viewer style="height: 100px;width: 450px;" src="@/assets/填写说明/桥梁/桥面横坡.png" alt="" >
        ...
        >
          ...
          <el-table-column prop="zyf" label="左/右幅" />
          <el-table-column prop="yxpc" label="允许偏差" />
    ...
    <script>
    // 引入定义接口js文件
    import api from "@/api/project/fbgc/qlgc/qmhp.js";
