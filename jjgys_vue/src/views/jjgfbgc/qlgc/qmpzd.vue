<template>
    <div class="app-container">
        ...
        <img v-viewer style="height: 100px;width: 450px;" src="@/assets/填写说明/桥梁/桥面平整度.png" alt="" >
        ...
        <el-dialog title="修改" :visible.sync="dialogVisible2" width="40%" >
          <el-form ref="dataForm" :model="modifyData"  label-width="150px" size="small" style="padding-right: 40px;" :rules="rules">
            ...
            <el-form-item label="桥名" prop="qm">
              <el-input v-model="modifyData.qm"></el-input>
            </el-form-item>
            ...
            <el-form-item label="实测值" prop="scz">
    ...
    <script>
    // 引入定义接口js文件
    import api from "@/api/project/fbgc/qlgc/qmpzd.js";
      ...
      methods: {
        ...
        exportqmpzd() {
          ...
          api.exportqmpzd().then((res) => {
            ...
            // 设置导出的文件名称
            link.download = `09桥面平整度三米直尺法实测数据` + ".xlsx";
