<template>
    <div class="app-container">
      ...
      <img v-viewer style="height: 100px;width: 450px;" src="@/assets/填写说明/桥梁/桥梁上部保护层厚度.png" alt="" >
      <div style="color: rgb(84, 151, 198);" align="middle">双击查看大图</div>
        ...
        <el-dialog title="修改" :visible.sync="dialogVisible2" width="40%" >
          <el-form ref="dataForm" :model="modifyData"  label-width="150px" size="small" style="padding-right: 40px;" :rules="rules">
            ...
            <el-form-item label="钢筋直径" prop="gjzj">
      ...
      methods: {
        ...
        exportsbbhchd() {
          ...
          api.exportsbbhchd().then((res) => {
            ...
            // 设置导出的文件名称
            link.download = `07桥梁上部保护层厚度实测数据` + ".xlsx";
