<template>
    <div class="app-container">
        ...
        <div class="search-div">
          <el-form :inline="true" class="demo-form-inline">
            ...
            <el-form-item label="梁板号:">
              <el-input v-model="searchObj.lbh" />
            </el-form-item>
        ...
        >
          ...
          <el-table-column label="序号" width="50px">
            ...
            <el-table-column prop="lbh" label="梁板号"/>
        ...
        <img v-viewer style="height: 100px;width: 450px;" src="@/assets/填写说明/桥梁/桥梁上部结构尺寸.png" alt="" >
        ...
        <el-dialog title="修改" :visible.sync="dialogVisible2" width="40%" >
          <el-form ref="dataForm" :model="modifyData"  label-width="150px" size="small" style="padding-right: 40px;" :rules="rules">
            ...
            <el-form-item label="梁板号" prop="lbh">
            <el-input v-model="modifyData.lbh"></el-input>
            </el-form-item>
    ...
    <script>
    // 引入定义接口js文件
    import api from "@/api/project/fbgc/qlgc/sbjgcc.js";
      ...
      methods: {
        ...
        exportsbjgcc() {
          ...
          api.exportsbjgcc().then((res) => {
            ...
            // 设置导出的文件名称
            link.download = `06桥梁上部结构尺寸实测数据` + ".xlsx";
