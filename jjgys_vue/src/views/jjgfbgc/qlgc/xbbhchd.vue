<template>
    <div class="app-container">
        ...
        <div class="search-div">
          <el-form :inline="true" class="demo-form-inline">
            ...
            <el-form-item label="构建编号及检测部位:">
              <el-input v-model="searchObj.gjbhjjcbw" />
            </el-form-item>
        ...
        <img v-viewer style="height: 100px;width: 450px;" src="@/assets/填写说明/桥梁/桥梁下部保护层厚度.png" alt="" >
        ...
        <el-dialog title="修改" :visible.sync="dialogVisible2" width="40%" >
          <el-form ref="dataForm" :model="modifyData"  label-width="150px" size="small" style="padding-right: 40px;" :rules="rules">
            ...
            <el-form-item label="构建编号及检测部位" prop="gjbhjjcbw">
            <el-input v-model="modifyData.gjbhjjcbw"></el-input>
            </el-form-item>
            <el-form-item label="钢筋直径(mm)" prop="gjzj">
            <el-input v-model="modifyData.gjzj"></el-input>
            </el-form-item>
            
            <el-form-item label="设计值(mm)" prop="sjz">
            <el-input v-model="modifyData.sjz"></el-input>
            </el-form-item>
            <el-form-item label="实测值1(mm)" prop="scz1">
            <el-input v-model="modifyData.scz1"></el-input>
            </el-form-item>
            <el-form-item label="实测值2(mm)" prop="scz2">
            <el-input v-model="modifyData.scz2"></el-input>
            </el-form-item>
            <el-form-item label="实测值3(mm)" prop="scz3">
            <el-input v-model="modifyData.scz3"></el-input>
            </el-form-item>
            <el-form-item label="实测值4(mm)" prop="scz4">
            <el-input v-model="modifyData.scz4"></el-input>
            </el-form-item>
            <el-form-item label="实测值5(mm)" prop="scz5">
            <el-input v-model="modifyData.scz5"></el-input>
            </el-form-item>
            <el-form-item label="实测值6(mm)" prop="scz6">
            <el-input v-model="modifyData.scz6"></el-input>
            </el-form-item>
            <el-form-item label="修正值" prop="xzz">
            <el-input v-model="modifyData.xzz"></el-input>
            </el-form-item>
    ...
    <script>
    // 引入定义接口js文件
    import api from "@/api/project/fbgc/qlgc/xbbhchd.js";
      ...
      methods: {
        ...
        exportxbbhchd() {
          ...
          api.exportxbbhchd().then((res) => {
            ...
            // 设置导出的文件名称
            link.download =  `03桥梁下部保护层厚度实测数据` + ".xlsx";
