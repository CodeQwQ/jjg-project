<template>
    <div class="app-container">
        ...
        >
          ...
          <el-table-column prop="jcsj" label="检测时间" width="100px" />
            ...
            <el-table-column prop="dth" label="墩台号"/>
        ...
        <img v-viewer style="height: 100px;width: 450px;" src="@/assets/填写说明/桥梁/桥梁下部结构尺寸.png" alt="" >
    ...
    <script>
    // 引入定义接口js文件
    import api from "@/api/project/fbgc/qlgc/xbjgcc.js";
      ...
      methods: {
        ...
        exportxbjgcc() {
          ...
          api.exportxbjgcc().then((res) => {
            ...
            // 设置导出的文件名称
            link.download = `02桥梁下部结构尺寸实测数据` + ".xlsx";
