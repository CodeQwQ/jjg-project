<template>
    <div class="app-container">
        ...
        <div class="search-div">
          <el-form :inline="true" class="demo-form-inline">
            ...
            <el-form-item label="墩台号:">
              <el-input v-model="searchObj.dth" />
            </el-form-item>
        ...
        >
          ...
          <el-table-column prop="jcsj" label="检测时间" width="200px" />
            ...
            <el-table-column prop="dth" label="墩台号" width="200px"/>
            
            <el-table-column prop="dzgd" label="墩柱高度" width="130px" />
            
            <el-table-column prop="hxscz" label="横向实测值" />
            <el-table-column prop="zxscz" label="纵向实测值(mm)" />
        ...
        <img v-viewer style="height: 100px;width: 450px;" src="@/assets/填写说明/桥梁/桥梁下部竖直度.png" alt="" >
        ...
        <el-dialog title="修改" :visible.sync="dialogVisible2" width="40%" >
          <el-form ref="dataForm" :model="modifyData"  label-width="150px" size="small" style="padding-right: 40px;" :rules="rules">
            ...
            <el-form-item label="墩台号" prop="dth">
            <el-input v-model="modifyData.dth"></el-input>
            </el-form-item>
            <el-form-item label="墩柱高度" prop="dzgd">
            <el-input v-model="modifyData.dzgd"></el-input>
            </el-form-item>
            
            <el-form-item label="横向实测值" prop="hxscz">
            <el-input v-model="modifyData.hxscz"></el-input>
            </el-form-item>
            <el-form-item label="纵向实测值(mm)" prop="zxscz">
            <el-input v-model="modifyData.zxscz"></el-input>
            </el-form-item>
    ...
    <script>
    // 引入定义接口js文件
    import api from "@/api/project/fbgc/qlgc/xbszd.js";
      ...
      methods: {
        ...
        exportxbszd() {
          ...
          api.exportxbszd().then((res) => {
            ...
            // 设置导出的文件名称
            link.download = `04桥梁下部竖直度实测数据` + ".xlsx";
