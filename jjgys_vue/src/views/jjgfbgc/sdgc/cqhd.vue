<template>
    <div class="app-container">
        ...
        <img v-viewer style="height: 100px;width: 450px;" src="@/assets/填写说明/隧道/隧道衬砌厚度.png" alt="" >
        ...
        <el-dialog title="修改" :visible.sync="dialogVisible2" width="40%" >
          <el-form ref="dataForm" :model="modifyData"  label-width="100px" size="small" style="padding-right: 40px;" :rules="rules">
            ...
            <el-form-item label="右拱腰3" prop="ygy3">
    ...
    <script>
    // 引入定义接口js文件
    import api from "@/api/project/fbgc/sdgc/cqhd.js";
      ...
      methods: {
        ...
        exportcqhd() {
          ...
          api.exportcqhd().then((res) => {
            ...
            // 设置导出的文件名称
            link.download = `02隧道衬砌厚度度实测数据` + ".xlsx";
