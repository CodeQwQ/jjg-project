<template>
    <div class="app-container">
        ...
        <img v-viewer style="height: 100px;width: 450px;" src="@/assets/填写说明/隧道/隧道衬砌砼强度.png" alt="" >
    ...
    <script>
    // 引入定义接口js文件
    import api from "@/api/project/fbgc/sdgc/cqtqd.js";
      ...
      methods: {
        ...
        exportcqtqd() {
          ...
          api.exportcqtqd().then((res) => {
            ...
            // 设置导出的文件名称
            link.download = `01隧道衬砌砼强度实测数据` + ".xlsx";
