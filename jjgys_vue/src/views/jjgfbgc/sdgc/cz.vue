<template>
    <div class="app-container">
        ...
        >
          ...
          <el-table-column label="序号" width="50px">
            ...
            <el-table-column prop="cz" label="车辙" />
        ...
        >
          ...
          <img v-viewer style="height: 100px;width: 450px;" src="@/assets/填写说明/路面/车辙.png" alt="" >
        ...
        <el-dialog title="修改" :visible.sync="dialogVisible2" width="40%" >
          <el-form ref="dataForm" :model="modifyData"  label-width="120px" size="small" style="padding-right: 40px;" :rules="rules">
            ...
            <el-form-item label="车辙" prop="cz">
            <el-input v-model="modifyData.cz"></el-input>
            </el-form-item>
        ...
        <el-dialog title="选择车道" :visible.sync="dialogVisible3" width="18%"  >
          ...
          <span slot="footer" class="dialog-footer">
            ...
            <el-button type="primary"  icon="el-icon-check" @click="exportcz()" size="small">确 定</el-button>
          </span>
        </el-dialog>
    ...
    <script>
    // 引入定义接口js文件
    import api from "@/api/project/fbgc/sdgc/cz";
