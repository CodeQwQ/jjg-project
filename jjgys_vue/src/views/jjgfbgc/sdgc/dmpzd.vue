<template>
    <div class="app-container">
        ...
        <img v-viewer style="height: 100px;width: 450px;" src="@/assets/填写说明/隧道/隧道大面平整度.png" alt="" >
        ...
        <el-dialog
         ...
         <el-descriptions :column="1"  border>
          <el-descriptions-item>
              <template slot="label" >不合格点数</template>
              {{descriptions["不合格点数"]}}
          </el-descriptions-item>
          <el-descriptions-item>
      ...
      methods: {
        ...
        ckjdb(){
            ...
            api.lookjdb(commonInfoVo).then((res)=>{
              ...
              this.descriptions['不合格点数']=res.data[0]["不合格点数"]
        ...
        exportdmpzd() {
          ...
          api.exportdmpzd().then((res) => {
            ...
            // 设置导出的文件名称
            link.download = `03隧道大面平整度实测数据` + ".xlsx";
