<template>
    <div class="app-container">
        ...
        <img v-viewer style="height: 100px;width: 450px;" src="@/assets/填写说明/隧道/隧道混凝土路面厚度钻芯法.png" alt="" >
    ...
    <script>
    // 引入定义接口js文件
    import api from "@/api/project/fbgc/sdgc/hntlmhdzx.js";
      ...
      methods: {
        ...
        exporthntlmhdzx() {
          ...
          api.exporthntlmhdzx().then((res) => {
            ...
            // 设置导出的文件名称
            link.download = `14隧道混凝土路面厚度钻芯法实测数据` + ".xlsx";
