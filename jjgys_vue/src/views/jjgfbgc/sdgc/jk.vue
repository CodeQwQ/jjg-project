<template>
    <div class="app-container">
        ...
        >
          ...
          <el-table-column label="序号" width="50px">
            ...
            <el-table-column prop="zh" label="桩号" width="150px"/>
            <el-table-column prop="dh" label="点号" width="100px" />
            <el-table-column prop="xz" label="X" width="100px"/>
            <el-table-column prop="zz" label="Z" width="100px"/>
            <el-table-column prop="pcz" label="偏差值" width="100px"/>
        ...
        <img v-viewer style="height: 100px;width: 450px;" src="@/assets/填写说明/隧道/净空.png" alt="" >
        ...
        >
          ...
          <el-table-column prop="sdname" label="隧道名称" width="250px"/>
          <el-table-column prop="总点数" label="总断面数" width="100px" />
          <el-table-column prop="合格点数" label="合格断面数" />
        ...
        <el-dialog title="修改" :visible.sync="dialogVisible2" width="40%" >
          <el-form ref="dataForm" :model="modifyData"  label-width="100px" size="small" style="padding-right: 40px;" :rules="rules">
            ...
            <el-form-item label="点号" prop="dh">
            <el-input v-model="modifyData.dh"></el-input>
            </el-form-item>
            <el-form-item label="X" prop="xz">
            <el-input v-model="modifyData.xz"></el-input>
            </el-form-item>
            <el-form-item label="Z" prop="zz">
            <el-input v-model="modifyData.zz"></el-input>
            </el-form-item>
            <el-form-item label="偏差值" prop="pcz">
            <el-input v-model="modifyData.pcz"></el-input>
            </el-form-item>
    ...
    <script>
    // 引入定义接口js文件
    import api from "@/api/project/fbgc/sdgc/jk.js";
    ...
    export default {
      ...
      methods: {
        ...
        exportjk() {
          ...
          api.exportjk(projectname,htd).then((response) => {
              var temp = response.headers["content-disposition"]
          ...
          // api.exportjk(projectname,htd).then((res) => {
