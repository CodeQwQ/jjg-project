<template>
    <div class="app-container">
        ...
        <div class="tools-div" v-show="!(username=='admin'&&type==1  )">
          <div class="anniu">
            <el-button
              class="btn-add"
              type="success"
              @click="exportlqlmhdzx()"
              style="margin-left: 0px"
              icon="el-icon-bottom"
              size="mini"
              >导出隧道沥青路面厚度钻芯法文件</el-button
            >
            <!-- :disabled="$hasBP('bnt.ql.export')  === true" -->
            <el-button
              class="btn-add"
              type="success"
              @click="importlqlmhdzx()"
              style="margin-left: 0px"
              icon="el-icon-top"
              size="mini"
              >导入隧道沥青路面厚度钻芯法数据文件</el-button
            >
            <el-button
              class="btn-add"
              type="success"
        ...
        >
          ...
          <el-table-column label="序号" width="50px">
            ...
            <el-table-column prop="lqszd" label="路、桥、隧、匝道"  width="150px" />
            <el-table-column prop="sdmc" label="隧道名称" width="220px" />
            <el-table-column prop="zh" label="桩号" />
            <el-table-column prop="bw" label="部位" />
            <el-table-column prop="smcz1" label="上面层测值1(mm)" width="100px"/>
            <el-table-column prop="smcz2" label="上面层测值2(mm)" width="100px"/>
            <el-table-column prop="smcz3" label="上面层测值3(mm)" width="100px"/>
            <el-table-column prop="smcz4" label="上面层测值4(mm)" width="100px"/>
            <el-table-column prop="smcsjz" label="上面层设计值(mm)" width="120px"/>
            <el-table-column prop="zhdz1" label="总厚度测值1(mm)" width="100px"/>
            <el-table-column prop="zhdz2" label="总厚度测值2(mm)" width="100px"/>
            <el-table-column prop="zhdz3" label="总厚度测值3(mm)" width="100px"/>
            <el-table-column prop="zhdz4" label="总厚度测值4(mm)" width="100px"/>
        ...
        <img v-viewer style="height: 100px;width: 450px;" src="@/assets/填写说明/隧道/隧道沥青路面厚度钻芯法.png" alt="" >
        ...
        <el-dialog title="修改" :visible.sync="dialogVisible2" width="40%" >
          <el-form ref="dataForm" :model="modifyData"  label-width="150px" size="small" style="padding-right: 40px;" :rules="rules">
            <el-form-item label="检测时间" prop="jcsj">
            <el-input v-model="modifyData.jcsj"></el-input>
            </el-form-item>
            <el-form-item label="路、桥、隧、匝道" prop="lqszd">
            <el-input v-model="modifyData.lqszd"></el-input>
            </el-form-item>
            ...
            <el-form-item label="上面层测值1" prop="smcz1">
            <el-input v-model="modifyData.smcz1"></el-input>
            </el-form-item>
            <el-form-item label="上面层测值2" prop="smcz2">
            <el-input v-model="modifyData.smcz2"></el-input>
            </el-form-item>
            <el-form-item label="上面层测值3" prop="smcz3">
            <el-input v-model="modifyData.smcz3"></el-input>
            </el-form-item>
            <el-form-item label="上面层测值4" prop="smcz4">
            <el-input v-model="modifyData.smcz4"></el-input>
            </el-form-item>
            <el-form-item label="上面层设计值" prop="smcsjz">
            <el-input v-model="modifyData.smcsjz"></el-input>
            </el-form-item>
            <el-form-item label="总厚度测值1" prop="zhdz1">
            <el-input v-model="modifyData.zhdz1"></el-input>
            </el-form-item>
            <el-form-item label="总厚度测值2" prop="zhdz2">
            <el-input v-model="modifyData.zhdz2"></el-input>
            </el-form-item>
            <el-form-item label="总厚度测值3" prop="zhdz3">
            <el-input v-model="modifyData.zhdz3"></el-input>
            </el-form-item>
            <el-form-item label="总厚度测值4" prop="zhdz4">
            <el-input v-model="modifyData.zhdz4"></el-input>
            </el-form-item>
    ...
    <script>
    // 引入定义接口js文件
    import api from "@/api/project/fbgc/sdgc/lqlmhdzx.js";
    ...
    export default {
      ...
      methods: {
        ...
        onUploadSuccess() {
          ...
          let load=Loading.service({fullscreen:true,text:'加载中,请稍后'})
          api.importlqlmhdzx(fd).then((res)=>{
            console.log('res',res)
            if(res.message=='成功'){
              this.fetchData();
              this.$message({
        ...
        exportlqlmhdzx() {
          ...
          api.exportlqlmhdzx().then((res) => {
            ...
            // 设置导出的文件名称
            link.download = `14高速隧道沥青路面厚度钻芯法实测数据` + ".xlsx";
