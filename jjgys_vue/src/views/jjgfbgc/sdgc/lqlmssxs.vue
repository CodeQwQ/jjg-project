    ...
    <div class="app-container">
        ...
        >
          ...
          <el-table-column label="序号" width="50px">
            ...
            <el-table-column prop="lzdsd" label="主线、匝道、隧" width="150px" />
        ...
        >
          <span style="white-space:pre-wrap;">{{ instruction }}
          </span>
          <img v-viewer style="height: 100px;width: 450px;" src="@/assets/填写说明/隧道/隧道沥青路面渗水系数.png" alt="" >
        ...
        >
          ...
          <el-table-column prop="路面类型" label="路面类型" width="120px" />
        ...
        <el-dialog title="修改" :visible.sync="dialogVisible2" width="40%" >
          <el-form ref="dataForm" :model="modifyData"  label-width="150px" size="small" style="padding-right: 40px;" :rules="rules">
            ...
            <el-form-item label="主线、匝道、隧道" prop="lzdsd">
            <el-input v-model="modifyData.lzdsd"></el-input>
            </el-form-item>
      ...
      methods: {
        ...
        exportlqlmssxs() {
          ...
          api.exportlqlmssxs().then((res) => {
            ...
            // 设置导出的文件名称
            link.download = `06隧道沥青路面渗水系数实测数据` + ".xlsx";
