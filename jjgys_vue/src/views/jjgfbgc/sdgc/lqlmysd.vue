<template>
    <div class="app-container">
        ...
        >
          ...
          <el-table-column label="序号" width="50px">
            ...
            <el-table-column prop="lqs" label="路、桥、隧" width="100px" />
            <el-table-column prop="sdmc" label="隧道名称" width="200px" />
            ...
            <el-table-column prop="gzsjzl" label="干燥试件质量(g)" width="120px" />
            <el-table-column prop="sjszzl" label="试件水中质量(g)" width="120px"/>
            <el-table-column prop="sjbgzl" label="时间表干质量(g)" width="120px"/>
        ...
        <img v-viewer style="height: 100px;width: 450px;" src="@/assets/填写说明/隧道/隧道沥青路面压实度.png" alt="" >
        ...
        >
          ...
          <el-table-column prop="路面类型" label="路面类型" width="250px"/>
        ...
        <el-dialog title="修改" :visible.sync="dialogVisible2" width="40%" >
          <el-form ref="dataForm" :model="modifyData"  label-width="160px" size="small" style="padding-right: 40px;" :rules="rules">
            ...
            <el-form-item label="时间表干质量" prop="sjbgzl">
    ...
    <script>
    // 引入定义接口js文件
    import api from "@/api/project/fbgc/sdgc/lqlmysd.js";
    ...
    export default {
      ...
      data() {
        ...
        return {
          ...
          fileList:[],
          modifyData:{},
          instruction:"1，日期格式：yyyy/MM/dd，例如：2021/05/23；\n2，路，桥，隧的数据就分别填写路、桥、隧即可；\n3，若没有下面层数据，也可不用填写上传，若要上传填写，按图片模板进行填写；\n4，填写模板如下：",
      ...
      methods: {
        ...
        exportlqlmysd() {
          ...
          api.exportlqlmysd().then((res) => {
            ...
            // 设置导出的文件名称
            link.download = `06隧道沥青路面压实度实测数据` + ".xlsx";
