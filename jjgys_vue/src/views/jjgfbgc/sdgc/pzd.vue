<template>
    <div class="app-container">
        ...
        >
          ...
          <el-table-column label="序号" width="50px">
            ...
            <!-- <el-table-column prop="yiri" label="右IRI" /> -->
        ...
        <el-dialog title="修改" :visible.sync="dialogVisible2" width="40%" >
          <el-form ref="dataForm" :model="modifyData"  label-width="120px" size="small" style="padding-right: 40px;" :rules="rules1">
            ...
            <!-- <el-form-item label="右IRI" prop="yiri">
            <el-input v-model="modifyData.yiri"></el-input>
            </el-form-item> -->
    ...
    <script>
    // 引入定义接口js文件
    import api from "@/api/project/fbgc/sdgc/pzd";
      ...
      methods: {
        ...
        exportpzd() {
          ...
          api.exportpzd(this.cd).then((res) => {
            ...
            // 设置导出的文件名称
            link.download = `隧道路面平整度实测数据` + ".xlsx";
