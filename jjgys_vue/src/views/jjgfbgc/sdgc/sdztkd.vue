<template>
    <div class="app-container">
        ...
        >
          ...
          <el-table-column prop="sdmc" label="隧道名称" width="250px" />
          
          <el-table-column prop="zh" label="桩号" />
          
          <el-table-column prop="zbk" label="左边宽(mm)" width="140px"/>
          <el-table-column prop="ybk" label="右边宽(mm)" width="140px"/>
          
          <el-table-column prop="sjz" label="设计值(mm)" width="140px"/>
        ...
        <img v-viewer style="height: 100px;width: 450px;" src="@/assets/填写说明/隧道/隧道总体宽度.png" alt="" >
        ...
        <el-dialog title="修改" :visible.sync="dialogVisible2" width="40%" >
          <el-form ref="dataForm" :model="modifyData"  label-width="150px" size="small" style="padding-right: 40px;" :rules="rules">
            ...
            <el-form-item label="左边宽(mm)" prop="zbk">
              <el-input v-model="modifyData.zbk"></el-input>
            </el-form-item>
            <el-form-item label="右边宽(mm)" prop="ybk">
              <el-input v-model="modifyData.ybk"></el-input>
            </el-form-item>
    ...
    <script>
    // 引入定义接口js文件
    import api from "@/api/project/fbgc/sdgc/sdztkd.js";
      ...
      methods: {
        ...
        exportsdztkd() {
          ...
          api.exportsdztkd().then((res) => {
            ...
            // 设置导出的文件名称
            link.download = `04隧道总体宽度实测数据` + ".xlsx";
