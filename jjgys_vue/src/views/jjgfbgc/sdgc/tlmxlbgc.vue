<template>
    <div class="app-container">
        ...
        >
          ...
          <el-table-column label="序号" width="50px">
            ...
            <el-table-column prop="qyfwz" label="取样缝位置" />
        ...
        <img v-viewer style="height: 100px;width: 450px;" src="@/assets/填写说明/隧道/隧道砼路面相邻板高差.png" alt="" >
        ...
        <el-dialog title="修改" :visible.sync="dialogVisible2" width="40%" >
          <el-form ref="dataForm" :model="modifyData"  label-width="100px" size="small" style="padding-right: 40px;" :rules="rules">
            ...
            <el-form-item label="取样缝位置" prop="qyfwz">
            <el-input v-model="modifyData.qyfwz"></el-input>
            </el-form-item>
    ...
    <script>
    // 引入定义接口js文件
    import api from "@/api/project/fbgc/sdgc/tlmxlbgc.js";
      ...
      methods: {
        ...
        exporttlmxlbgc() {
          ...
          api.exporttlmxlbgc().then((res) => {
            ...
            // 设置导出的文件名称
            link.download = `11隧道砼路面相邻板高差实测数据` + ".xlsx";
