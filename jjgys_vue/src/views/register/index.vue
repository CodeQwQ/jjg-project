<template>
  <div class="register-container">
    <div class='logo1' style="width:150px;height:150px;;border-radius:50%;overflow:hidden;">
          <img src="@/assets/login/logo.png" style="clear: both;display: block;margin: auto; width: 150px;height: 150px">
        </div>
        
        <h3 class="title-name1">陕西交控工程技术有限公司</h3>
    <el-form
      ref="registerForm"
      :model="registerForm"
      :rules="registerRules"
    ...
    >
      ...
      <el-row style="text-align: right; margin-top: -10px">
        <el-link type="primary" @click="toDenglu">已有账号？立即登录</el-link>
      </el-row>
    </el-form>
  </div>
</template>
      ...
      this.$refs['registerForm'].validate((valid) => {
        if (valid) {
          const user = {
            ...
            cpwd: this.registerForm.cpwd,
            realname: this.registerForm.realname,
            mail: this.registerForm.mail,
            phone: this.registerForm.phone,
            deptId: this.departList.id
          }
          register(user)
            .then((res) => {
              console.log(res)
