  ...
  <div class="app-container">
    ...
    <div class="search-div">
      <el-form :inline="true" class="demo-form-inline">
        <el-form-item label="复合路面名称:">
          <el-input v-model="searchObj.fhlmname" />
        </el-form-item>
        <el-button
          type="primary"
          icon="el-icon-search"
    ...
    >
      ...
      <el-table-column prop="fhlmname" label="复合路面名称" />
...
<script>
// 引入定义接口js文件
import api from "@/api/project/lqs/fhlm.js";
  ...
  methods: {
    ...
    exportFhlm() {
      ...
      api.export().then((res) => {
        ...
        // 设置导出的文件名称
        link.download = projectname + `复合路面清单` + ".xlsx";
