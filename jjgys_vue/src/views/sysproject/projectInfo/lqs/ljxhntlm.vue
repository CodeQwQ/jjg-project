  ...
  <div class="app-container">
    ...
    <div class="search-div">
      <el-form :inline="true" class="demo-form-inline">
        <el-form-item label="连接线混凝土路面名称:">
          <el-input v-model="searchObj.ljxhntlmname" />
        </el-form-item>
        <el-button
          type="primary"
          icon="el-icon-search"
    ...
    <div class="tools-div" v-show="!(username=='admin'&&type==1)  ">
      <div class="anniu">
        <el-button
          class="btn-add"
          type="success"
          @click="exportLjxhntlm()"
          style="margin-left: 0px"
          icon="el-icon-bottom"
          size="mini"
          >导出连接线混凝土路面清单模板文件</el-button
        >
        <!-- :disabled="$hasBP('bnt.ql.export')  === true" -->
        <el-button
          class="btn-add"
          type="success"
          @click="importLjxhntlm()"
          style="margin-left: 0px"
          icon="el-icon-top"
          size="mini"
          >导入连接线混凝土路面清单数据</el-button
        >
    ...
    >
      ...
      <el-table-column prop="ljxhntlmname" label="连接线混凝土路面名称" />
...
<script>
// 引入定义接口js文件
import api from "@/api/project/lqs/ljxhntlm.js";
  ...
  methods: {
    ...
    exportLjxhntlm() {
      ...
      api.export().then((res) => {
        ...
        // 设置导出的文件名称
        link.download = projectname + `连接线混凝土路面清单` + ".xlsx";
