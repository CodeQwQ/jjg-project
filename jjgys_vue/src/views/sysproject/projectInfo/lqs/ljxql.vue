  ...
  <div class="app-container">
    ...
    <div class="search-div">
      <el-form :inline="true" class="demo-form-inline">
        <el-form-item label="连接线桥梁名称:">
          <el-input v-model="searchObj.ljxqlname" />
        </el-form-item>
        <el-button
          type="primary"
          icon="el-icon-search"
    ...
    >
      ...
      <el-table-column prop="ljxqlname" label="连接线桥梁名称" />
      ...
      <el-table-column prop="ssljxmc" label="所属连接线名称" />
...
<script>
// 引入定义接口js文件
import api from "@/api/project/lqs/ljxql.js";
  ...
  methods: {
    ...
    exportljxql() {
      ...
      api.exportljxql().then((res) => {
        ...
        // 设置导出的文件名称
        link.download = projectname + `连接线桥梁清单` + ".xlsx";
