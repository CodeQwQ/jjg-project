  ...
  <div class="app-container">
    ...
    <div class="search-div">
      <el-form :inline="true" class="demo-form-inline">
        <el-form-item label="连接线隧道名称:">
          <el-input v-model="searchObj.ljxsdname" />
        </el-form-item>
        <el-button
          type="primary"
          icon="el-icon-search"
    ...
    >
      ...
      <el-table-column prop="ljxsdname" label="连接线隧道名称" />
...
<script>
// 引入定义接口js文件
import api from "@/api/project/lqs/ljxsd.js";
  ...
  methods: {
    ...
    exportljxsd() {
      ...
      api.export().then((res) => {
        ...
        // 设置导出的文件名称
        link.download = projectname + `连接线隧道清单` + ".xlsx";
