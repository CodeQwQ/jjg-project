<template>
    <div class="app-container">
        ...
        >
          ...
          <el-table-column prop="proname" label="项目名称" width="220px" />
        ...
        <el-dialog title="修改" :visible.sync="dialogVisible1" width="40%" >
          <el-form ref="dataForm" :model="modifyData"  label-width="150px" size="small" style="padding-right: 40px;">
            ...
            <el-form-item label="总数" prop="num">
              <el-input v-model="modifyData.num"></el-input>
            </el-form-item>
    ...
    export default {
      ...
      methods: {
        ...
        exportxmjd() {
          ...
          api.exportxmjd(projectname).then((res) => {
            ...
            // 设置导出的文件名称
            link.download = projectname + `项目进度` + ".xlsx";
