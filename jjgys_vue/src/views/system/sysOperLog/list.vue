<template>
  <div class="app-container">
    ...
    <div class="search-div">
      <el-form label-width="70px" size="small">
        <el-row>
          <el-col :span="24">
            <el-input style="width: 20%" v-model="searchObj.title" placeholder="操作模块"></el-input>
            <el-input style="width: 20%" v-model="searchObj.operName" placeholder="操作人员"></el-input>
  ...
  <div class="tools-div">
    ...
    <el-table
      ...
      <el-table-column prop="fbgc" label="分布工程" />
